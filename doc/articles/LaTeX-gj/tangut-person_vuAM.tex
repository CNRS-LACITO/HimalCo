...
\citet{lapolla92} argues that, in Tangut, (i) there is a one-to-one relationship between pronouns and suffixes, (2) person agreement is optional, and hence (iii) person indexation suffixes have been recently grammaticalized from pronouns.  

These three points are re-examined here on the basis of a corpus that includes major narrative texts (see \citealt[8-9]{jacques14esquisse}), in particular the collection of short stories called  \textit{The Grove of Categories}, from which most examples in this section are drawn.
