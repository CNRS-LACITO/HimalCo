...
In this Sino-Tibetan,  direct / inverse agreement systems are widely distributed, and have been described best in Rgyalrong and Kiranti languages.\footnote{Languages without agreement systems like Chinese or Tibetan can safely be assumed to have lost it, on which see \citet{delancey10agreement} and  \citet{jacques10zos}. } The present paper only focuses on these two branches.
...
There is an almost complete symmetry between direct and inverse forms in the Zbu paradigms: only local forms (where the portmanteau \ipa{tɐ--} in 1$\rightarrow$2 is distinct from what is found in 2$\rightarrow$1) and the presence of stem alternation in some direct forms have no equivalent in corresponding inverse forms.
...
This section focuses on the prefixal prefixes; although most personal suffixes in Rgyalrong and Kiranti appear to be cognate, their similarity to pronouns, especially in Rgyalrong, raises the suspicion that they might have been at least in part recently  grammaticalized from pronouns.   For ease of exposition, only data from Zbu and Bantawa are presented in this section. A more detailed study of comparative Rgyalrong / Kiranti verbal morphology goes beyond the scope of this paper.
...
\begin{table}
\caption{Comparison of non-local forms in Zbu and Bantawa}\label{tab:non.loc}
...
\textsc{3d} &\grise{} &\grise{} &\grise{} &\ro{}-\ipa{ndʑi} & \ipa{ɨ}-\ro{}-\ipa{cu} & \multicolumn{2}{c}{\ipa{ɨ}-\ro{}-\ipa{cuci}} \\ 
\textsc{3p} &\grise{} &\grise{} &\grise{} &\ro{}-\ipa{nɯ} & \ipa{ɨ}-\ro{} & \multicolumn{2}{c}{\ipa{mɨ}-\ro{}-\ipa{uci}} \\ 
3' & \ipa{wɣɯ}-\ro{} & \ipa{wɣɯ}-\ro{}-\ipa{ndʑi}  & \ipa{wɣɯ}-\ro{}-\ipa{nɯ} &\grise{} &\grise{} &\grise{} &\grise{} \\
\hline
