...
Before nasal vowels, *\ipa{r} and *\ipa{R} merge as \ipa{n} in Dakotan and Dhegiha languages in nearly all contexts (see  \citealt{michaud-jacques12nasalite}), but this topic will not be discussed in the present paper, as it has no relevance to the issue at hand.
