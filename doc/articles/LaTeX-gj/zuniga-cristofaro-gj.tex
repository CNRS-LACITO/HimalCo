...
1pe & 	\ipa{--ni'} & 	\ipa{--ni'} & 		???*\ipa{--yânke}	\\	
1pi & 	\ipa{--no'} & 	\ipa{--no'} & 		*\ipa{--yankwe} & 	\\	
\midrule
2s & 	\ipa{--n} & 	\ipa{--n} & 		*\ipa{--yani} & 	\\	
2p & 	\ipa{--nee} & 	\ipa{--nee} & 		*\ipa{--yêkwe} & 	\\	
\midrule
3s & 	\ipa{--t} & 	\ipa{--'} & 		*\ipa{--ta} / \ipa{--ka}& 	\\	
3's & 	\ipa{--níθ} & 	\ipa{--níθ} & 		*\ipa{--riciri} & 	\\	
3p & 	\ipa{--θi'} & 	\ipa{--'i} & 		*\ipa{--ciki} 	\\	
3'p & 	\ipa{--níθi} & 	\ipa{--níθi} & 		*\ipa{--ricihi} 	\\	
\bottomrule
\end{tabular}
\end{table}
