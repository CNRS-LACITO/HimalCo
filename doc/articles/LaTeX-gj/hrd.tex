...
La seule explication claire proposée dans la littérature, d'après \citet[420]{wodtko08NIL}, est celle de \citet{szemerenyi70heart} qui propose une contamination avec la racine nominale \ipa{*ĝʰerH} qui se retrouve dans le grec \grec{χορδή} `entrailles' et le sanskrit \ipa{hirā́-} f. `veine'. Si cette hypothèse est raisonable, il me semble utile d'explorer les possibilités alternatives qui s'offrent pour rendre compte de l'initiale irrégulière indo-iranienne. 
