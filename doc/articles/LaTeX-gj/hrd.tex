...
On trouve en indo-iranien trois racines ayant pu apparaître dans des collocations faisant intervenir le nom `cœur' ou l'influencer par proximité sémantique. Il s'agit de verbes décrivant un état psychologique comportant la séquence \ipa{*j́ʰr} en proto-indo-iranien, correspondant au sanskrit \ipa{háryati} `se réjouir de', \ipa{hṛṣyáti} `se réjouir, frissonner, se hérisser' et \ipa{hṛṇīté} `être fâché'.
...
\glt Promeus tes deux parents (Ciel et Terre), comme l'amant (promeut) le bonheur! (Agni, ce dieu) désirable, cherche à obtenir (un bien pour l'Homme), il suscite (l'inspiration) du fond du cœur. (RV 10.11.06, \citealt[8]{renou65evp})
\end{exe}
...
% ghṛ́ṣum pāvakáṃ vanínaṃ vícarṣaṇiṃ rudrásya sūnúṃ havásā gṛṇīmasi
%RV.1.64.12
%Бодрых, очищающих, победоносных, очень подвижных Сыновей Рудры мы воспеваем, призывая. p82
