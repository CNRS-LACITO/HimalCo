...
Endopathic sensations relating to other referents than the speaker are expressed with the factual combined with an auxiliary such as \ipa{ŋgrɤl}  `be usually the case', to express an inference based on the general knowledge of the speaker, as in \ref{ex:rAZa}.
...
However, unlike in Lhasa Tibetan where the sensory \ipa{ɴdug} is not possible to express non-personal endopathic feelings, this possibility is available in Japhug in several cases. 

First, as in \ref{ex:tWCGa.YWmNAm}, it is used in the case of generic sentences, when the speaker has experienced himself the feeling and recounts his experience while presenting it as a generic fact. 
...
Second, as in \ref{ex:YWNWGAtChom}, it be used in the case of reports of second-hand knowledge that the speaker has not reverified, as in \ref{ex:YWNWGAtChom}.
