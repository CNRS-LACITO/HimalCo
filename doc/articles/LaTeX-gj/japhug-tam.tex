...
(Vine, 20) \\
\textsc{3sg.poss}-head \textsc{nmlz}:S/A-be.soft \textsc{dem} ipfv-inv-pluck \textsc{lnk} cow \textsc{pl} \textsc{erg} eat:\textsc{fact-pl} pig \textsc{erg} \textsc{neg}-eat:\textsc{fact} \\
...
Second, with dynamic verbs, the factual expresses an assertion or an intention in the first person in assertive sentence (example \ref{ex:kWsAthu.Cea}) or in the second in interrogatives (\ref{ex:tWGi}).
...
It is also used for future events, when the speaker has reasonable reasons for assuming that they will take place

\ipa{nɯ} 	\ipa{ɯ-fso} 	\ipa{tɕe,} 	\ipa{tha} 	\ipa{ɣi} 	\ipa{ɕti} 	\ipa{tɕe,} 	\ipa{sɲikuku} 	\ipa{ʑo} 	\ipa{ju-ɣi} 	\ipa{tɕe} 	\ipa{nɯ} 	\ipa{ntsɯ} 	\ipa{tu-ti} 	\ipa{ɲɯ-ɕti} 	
185-186

 \ipa{a-mu} 	\ipa{tɕi-scawa} 	\ipa{ma} 	\ipa{jɯɣmɯr} 	\ipa{tɕe} 	\ipa{iɕqha} 	\ipa{khu} 	\ipa{ɣi} 	\ipa{thaŋ} 	\ipa{nɤ} 	
...
The factual would not be appropriate in these contexts because
...
The sensory is also used concerning information that is somehow part of common knowledge, but that the speaker has not had the opportunity to personally confirm. For instance, it is commonly used instead of the factual for describing facts about animals that do not live in Rgyalrong areas and that the speaker only knows through indirect channels.

\ipa{sɯŋgi}  	\ipa{nɯ}  	\ipa{ɲɯ-sɤɣmu.}  


vs
\ipa{ŋgoŋpu}  	\ipa{ɴɢoɕna}  	\ipa{kɤ-ti}  	\ipa{ci}  	\ipa{tu}  	\ipa{tɕe,}  	\ipa{nɯnɯ}  	\ipa{wxti}  	\ipa{nɯ}  	\ipa{stoʁ}  	\ipa{jamar}  	\ipa{tu.}  	\ipa{kú-wɣ-rtoʁ}  	\ipa{tɕe}  	\ipa{sɤɣmu.}  
...
endopathic ( \citealt{tournadre14evidentiality}):
...
Facts about oneself construed as part of common knowledge:
...
girl \textsc{dem} \textsc{erg} really \textsc{emph} \textsc{egoph}-be.happy-\textsc{1pl}  roi also \textsc{1sg}-on really \textsc{egoph}-be.kind servant \textsc{pl} also really \textsc{emph} \textsc{emph} \textsc{egoph}-be.good \\
