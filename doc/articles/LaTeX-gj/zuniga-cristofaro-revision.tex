...
\toprule
 \backslashbox{A}{P}  & 	1\sg  & 1\pli & 1\pe &  2\sg & 2\pl  &  3\sg & 3\pl &	3'   \\ 
\midrule
1\sg   & 	\grise{}   & 	\grise{} &  \grise{} &	\ipa{-inaan}  & \ipa{-ininagog}	& \ipa{-ag}   & 	\ipa{-agwaa}    \\ 
...
3\sg   & 	 \ipa{-Id}   & \ipa{-ininang} & \ipa{-Iyangid}  & \ipa{-ik}  & 	\ipa{-inineg} & 	\grise{}  & \grise{}	 & 	\ipa{-aad}     \\ 
3\pl   & 	 \ipa{-Iwaad}&  \ipa{-ininangwaa} & \ipa{-Iyangidwaa} & 	\ipa{-ikwaa}   & 	\ipa{-ininegwaa} & 	\grise{} &	\grise{}  & \ipa{-aawaad}  \\ 
...
&paradigm & paradigm&\\
\midrule
3$\rightarrow$1\sg &\ipa{--igo-yaan} \grise{}& 	\ipa{--id} & \ipa{--itʃ} &	 *\ipa{--ici} & 		\\
3$\rightarrow$1\pli & 	\ipa{--igo-yang} \grise{}& 	\ipa{--ininang}  \grise{} &  	\ipa{--inang}  	 &*\ipa{--eθankwe} & 		\\
3$\rightarrow$1\pe & 	\ipa{--igo-yaang} \grise{}& 	\ipa{--iyangid} \grise{}&	\ipa{--iyamintʃ}  &  *\ipa{--iyamenci} & 		\\
\midrule
3$\rightarrow$2\sg & 	\ipa{--igo-yan} \grise{}& 	\ipa{--ik} &	\ipa{--ik} &  *\ipa{--eθki} & 		\\
3$\rightarrow$2\pl & \ipa{--igo-yeg} \grise{}& 	\ipa{--inineg}  \grise{} & \ipa{--inaak}  & *\ipa{--eθâkwe} & 		\\
\midrule
3'$\rightarrow$3\sg & \ipa{--igod} & 	\ipa{--igod} &		\ipa{--igotʃ} &*\ipa{--ekweci} & 		\\
3'$\rightarrow$3\pl & \ipa{--igodwaa}   & 	\ipa{--igodwaa}  \grise{}&\ipa{--igowaatʃ} &*\ipa{--ekowaaci} & 		\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
1\sg& 	\ipa{--noo} &  	*\ipa{--yâni} & 	\\	
1\pe & 	\ipa{--ni'} /  	\ipa{--'} \grise{} & 		 *\ipa{--yânke}	 \\	
1\pli & 	\ipa{--no'} & 	 		*\ipa{--yankwe} & 	\\	
\midrule
2\sg& 	\ipa{--n} & 	 	*\ipa{--yani} & 	\\	
2\pl& 	\ipa{--nee} & 	  		*\ipa{--yêkwe} & 	\\	
\midrule
3\sg & 	\ipa{--t} /	\ipa{--'} & 		*\ipa{--ta} / \ipa{--ki}& 	\\	
3'\sg & 	\ipa{--níθ} &  		*\ipa{--riciri} & 	\\	
3\pl& 	\ipa{--θi'} &  		*\ipa{--ciki} 	\\	
3'\pl& 	\ipa{--níθi} & 	 		*\ipa{--ricihi} 	\\	
\bottomrule
\end{tabular}
\end{table}
...
1\sg& \grise{} & 	\grise{} & 	\grise{} & 	\ipa{--éθen} & 	\ipa{--eθénee} & 	\ipa{--o'} & 	 & 	 & 	\\
1\pli & 	\grise{} & 	\grise{} & 	\grise{} & 	\grise{} & 	\grise{} & 	\ipa{--óóno'} & 	 & 	 & 	\\
1\pe & 	\grise{} & 	\grise{} & 	\grise{} & 	\ipa{--een} & 	\ipa{--eenee} & 	\ipa{--éét} & 	 & 	 & 	\\
2\sg& 	\ipa{--ín} / \ipa{--ún}& 	\grise{} & \ipa{--ínee} /	\ipa{--únee} & 	\grise{} & 	\grise{} & 	\ipa{--ót} & 	 & 	 & 	\\
...
\midrule
 1\sg$\rightarrow$3 & 	\ipa{--o'} & 	*\ipa{--aka} & 		\\		
1\pe$\rightarrow$3 & 	\ipa{--éét}\grise{} & 	 *\ipa{--akenta} & 		\\		
1\pli$\rightarrow$3 & 	\ipa{--óó-no'}\grise{} & *\ipa{--ankwe} & 		\\		
\midrule
2\sg$\rightarrow$3 & 	\ipa{--ót} & 	*\ipa{--ata} & 		\\		
2\pl$\rightarrow$3 & 	\ipa{--óó-nee} \grise{}& *\ipa{--êkwe} & 		\\		
\midrule
3\sg$\rightarrow$3' & 	\ipa{--oot} & 	*\ipa{--âta} & 		\\		
3\pl$\rightarrow$3' & 	\ipa{--óóθi'} & 	*\ipa{--âciki} & 		\\		
\bottomrule
\end{tabular}
\end{table}

By contrast with the direct paradigm, the inverse VTA paradigm is almost entirely remade, as in Parry Island Nishnaabemwin: only the third person forms are inherited, as can be seen in Table \ref{tab:arapaho.vta.2}. As in the direct paradigm, the third person ending \ipa{--éít} was reanalyzed as \ipa{--ei--} + the VAI ending \ipa{--t} and all other forms were rebuilt on that model, replacing the inherited forms.\footnote{Arapaho \ipa{--ei--} regularly derives from *\ipa{--ekwe--}; *\ipa{k} $\rightarrow \emptyset $ and *\ipa{we} $\rightarrow $ *\ipa{o} $\rightarrow $ \ipa{i}. } All inverse forms follow this pattern, except the 3$\rightarrow$1\pe suffix, where *\ipa{--éi'} would have been expected. The attested 3$\rightarrow$1\pe form \ipa{--éi-'-éét} combines the expected form with the direct ending \ipa{--éét}.
...
\begin{tabular}{lllll}
\toprule
3$\rightarrow$1\sg & 	\ipa{--éí-noo}\grise{} & 	*\ipa{--iti} & 		\\
3$\rightarrow$1\pe & 	\ipa{--éi-'-éét} \grise{}& *\ipa{--iyamenti} & 		\\
3$\rightarrow$1\pli & 	\ipa{--éí-no'} \grise{}& 	*\ipa{--eθankwe} & 		\\
\midrule
3$\rightarrow$2\sg & 	\ipa{--éí-n} \grise{}& *\ipa{--eθki} & 		\\
3$\rightarrow$2\pl & 	\ipa{--éí-nee} \grise{}& *\ipa{--eθâkwe} & 		\\
\midrule
3'$\rightarrow$3\sg & 	\ipa{--éít} & 	*\ipa{--ekweti} & 		\\
3'$\rightarrow$3\pl & 	\ipa{--éíθi'} & 	*\ipa{--ekociki} & 		\\
\bottomrule
\end{tabular}
\end{table}

Just as the inverse paradigm, the local paradigm has also undergone considerable analogical reshaping whith only the 2\sg$\rightarrow$1\sg\ and 2\pl$\rightarrow$1\sg\ being inherited. 
...
\midrule 
1\sg$\rightarrow$2\sg & \ipa{--éθen} \grise{}& *\ipa{--eθâni}   \\
1\sg$\rightarrow$2\pl &\ipa{--eθénee} \grise{}& *\ipa{--eθakokwe} & \\
1\pe$\rightarrow$2\sg &\ipa{--één} \grise{}& *\ipa{--eθânke} &   \\
1\pe$\rightarrow$2\pl &\ipa{--eenee} \grise{}& *\ipa{--eθânke} &   \\
\midrule 
2\sg$\rightarrow$1\sg &\ipa{--ún} / \ipa{--ín} &   *\ipa{--iyani}     \\
2\sg$\rightarrow$1\pe & \ipa{--éi'één}\grise{}& *\ipa{--iyânkwe} &  \\
2\pl$\rightarrow$1\sg &\ipa{--únee} / \ipa{--ínee} &  *\ipa{--iyêkwe} &   \\
2\pl$\rightarrow$1\pe &\ipa{--éi'eenee}\grise{} & *\ipa{--iyânkwe} &   \\
\bottomrule
\end{tabular}
\end{table}
...
From there, the 1\sg$\rightarrow$2\sg\  \ipa{--éθen} (instead of expected *\ipa{eθoo}) is likely to have originated from the independent order 1\sg$\rightarrow$2\sg\ ending \ipa{--éθ} $\leftarrow$ *\ipa{--eθe} to which the second person suffix \ipa{--n} from the VAI paradigm was added. 
