...
\ipa{sthə}
%08	ŋi xtse əʑi stʰə?" tə-jə-sə ŋə-rə.
%\b	"Où est ma soupe?"

\ipa{xi}

%08	akəstɔmbej zgɔrɟu qʰi nə-xi-sə ŋərə
%\b	Le grand noyer de son voisin se trouvait près de la fenêtre d'Akustomba.

\ipa{tə/də}
%ɲi tə-pʰa stɔrmə le ndɔ ə́-də As-tu envie de te marier avec lui?

%22	kʰakʰa kʰarma rdʑi ɕatsa tə-rə ʑəgu, 
%\b	Même s'il y avait beaucoup de traces de bétail,
%23	ŋaɲɟi xi rdʑi de, rdʑi de, ŋaɲɟi aʑow taˠtaˠ χa kɔ-rə
%\b	les traces de notre mdzo, il les reconnaissait.
