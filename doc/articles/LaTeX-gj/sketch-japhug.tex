...
There are two causative prefixes in Japhug, \ipa{sɯ--} and \ipa{ɣɤ--} (\citealt{jacques15causative}).
...
Japhug comparative constructions are illustrated by example \refb{ex:comp1}: the standard is marked by the comparative postpositions \ipa{sɤz} or \ipa{staʁ}, while the comparee can optionally be followed by a marker \ipa{kɯ} homophonous with the ergative / instrumental (\citealt{jacques15comparative}).
