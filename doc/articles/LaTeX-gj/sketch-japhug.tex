...
Noun modifying other noun normally appear before them as in \ipa{rŋɯl rɟɤskɤt} `silver stairs', but there
there is a  restricted subclass of possessed nouns referring to old or ragged objects such as \ipa{ɯ-do} `old (of animals)', \ipa{ɯ-mbe} `old (of clothes)', \ipa{ɯ-ɴqra} `shabby' which are strictly postnominal.
...
\ex \label{ex:ChWtWt}
\gll
 \ipa{cʰɯ-tɯt} 	\ipa{ɕɯŋgɯ} 	\ipa{nɯ} 	\ipa{ɲɯ-tɕur} \\
 \textsc{ipfv}-ripe before \textsc{dem} \textsc{testim}-be.sour \\
 \glt Its is sour before it becomes ripe.
\end{exe}
