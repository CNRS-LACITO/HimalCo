...
\linenumbers
Abstract: This paper presents a comprehensive description of the reflexive conjugation in Khaling, including the affixal paradigms, the stem alternations and  the semantic values of   reflexive derivation. It also provides a historical perspective with comparative data from other Kiranti languages.
...
This paradigm presents overabundance, as two competing variants are attested for all first person past forms: \ro{}\ipa{--tʌsu} and \ro{}\ipa{--siŋʌtʌ}.
 ...
 The personal suffixes and prefixes of reflexive verbs are essentially the same as those of  intransitive verbs with a vowel-final root, as a comparison with Table (\ref{tab:pi}) shows. All non-past forms are fully predictable once the reflexive suffix \ipa{--si} is taken into account. In the rest of the paradigm,  only three suffixes   differ  from those for non-reflexive verbs, and they are indicated in bold in Table (\ref{tab:nyamsi}).
   ...
   The   suffix \ipa{--tʌsu} for \textsc{1sg} past  is   non-predictable, unlike its variant \ipa{--siŋʌtʌ}. This   suggests that  \ipa{--tʌsu} is the inherited from, while  \ipa{--siŋʌtʌ} is analogically renewed from the rest of the paradigm.
...
\midrule
\textsc{2s}  &  \ipa{ʔi-pi}  &  \ipa{ʔi-puː-tɛ}  &  \ipa{puː-je}   \\
...
\textsc{2sg} &	\ipa{a-sir-\textbf{s}-ti} &	\ipa{ʔi-sʌ̄r-tɛ-\textbf{si}} &	\\
\textsc{2pl} &	\ipa{a-sir-\textbf{s}-ti-ni} &	\ipa{ʔi-sʌ̄r-tɛ\textbf{n}nu} &	\\
\textsc{3sg} &	\ipa{sir-\textbf{s}-ti} &	\ipa{sʌ̄r-tɛ-\textbf{si}} &	\\
\bottomrule
\end{tabular}
\end{table}
...
There are six main subtypes of \ipa{--si} derivation. The reflexive and autobenefactive are the two productive interpretations, while the four remaining ones (reciprocal, antipassive, anticausative and passive) are each restricted to a few verbs. In addition, there is one \ipa{--si} verb derived from an intransitive based verb.
...
Example \ref{ex:sursi} illustrates three reflexive verbs derived from the transitive |\ipa{sent}| `look at', |\ipa{sur}| `wash' and |\ipa{ɦur}| `wash hair'. The emphatic pronoun \ipa{--tap} is optional and its presence does not preclude or imply a reflexive interpretation. The transitive use of the base verb |\ipa{ɦur}| `wash hair'  is shown in \ref{ex:sur}, with the A marked in the ergative.

\begin{exe}
\ex \label{ex:sursi}
\gll \ipa{gʰole}  	\ipa{kɛ̄mʔɛ}  	\ipa{ʔu-tap}  	\ipa{sēi-si-nɛ,}  	\ipa{sʌ̄r-si-nɛ,}  	\ipa{ɦʌ̄r-si-nɛ}  	\ipa{mu-jʌt-w-ɛ}  \\
all work-\textsc{erg} \textsc{3sg}-self  look.at\textsc{-refl-inf} wash\textsc{-refl-inf} wash.hair\textsc{-refl-inf} \textsc{neg}-have.time-\textsc{irr-2/3} \\
...
The semantics of reflexive verbs may undergo restrictions; for instance, the reflexive of  |\ipa{sent}| `look at' is usually interpreted as `look after oneself' rather than `look at oneself', but for most verbs, the semantics are  generally  predictable.
...
For verbs whose semantics render impossible an interpretation where $A=P$, as defines reflexive verbs, the \ipa{--si} derivation is interpreted as an autobenefactive, whereby the A of the base verb is converted to S, with  P remaining as an unmarked adjunct.   It corresponds to  `indirect reflexive' in \citet{kemmer93middle}'s terminology.
...
An example of reciprocal \ipa{--si} is |\ipa{gʰɛm-si}| `get along' (example \ref{ex:ghyamsi}) derived from the transitive |\ipa{gʰɛm}| `put tighly together' (\ref{ex:ghyam}).

 \begin{exe}
\ex \label{ex:ghyamsi} 
\gll
\ipa{ʔʌ̄msu}  	\ipa{tuju}  	\ipa{gʰɛ̄m-sî-j-t-i.}   \\
\textsc{3du} together put.together-\textsc{refl-du-pst-du} \\
\glt They got along together.
\end{exe}
...
\ex \label{ex:ghyam} 
\gll
 \ipa{ʔʌ̄m-ʔɛ}  	\ipa{sakpu}  	\ipa{ʦʰēlmɛ}  	\ipa{gʰɛ̂m-t-ɛ-nʌ}  	\ipa{kʰoɔ̄r}  	\ipa{mʉ-t-ɛ.}  \\
 \textsc{3sg-erg} two mat put.together-\textsc{pst-2/3-}and fence make-\textsc{pst-2/3} \\
 \glt He made a fence by joining two mats together.
\end{exe}
...
Reciprocal interpretation is attested with verb whose semantics belong to \citet{kemmer93middle}'s categories of `naturally reciprocal events' and `naturally collective actions', such as |\ipa{pʰak-si}|  `to separate' |\ipa{ŋol-si}| `to come together' or |\ipa{kʰop-si}| `to gather' from the transitive verbs |\ipa{pʰak}| `to separate (someone)', |\ipa{ŋol}| `to mix' and |\ipa{kʰop}| `to gather (something)'.

\subsubsection{Antipassive}
In the antipassive  interpretation of the \ipa{--si} derivation, the A of the transitive base verb becomes S of the  \ipa{--si} verb, while the P is deleted, but remains semantically recoverable.
...
Example \ref{ex:khaktsi} illustrates this type of interpretation, in comparison with the base verb |\ipa{kʰakt}| `be shy in presence of' in \ref{ex:khakt}.

 \begin{exe}
\ex \label{ex:khaktsi} 
\gll \ipa{khân-si-ŋʌ-t-ʌ}\\
 be.shy-\textsc{refl-1sg:S/P-pst-1sg} \\
\glt  I felt shy.
\end{exe}
\begin{exe}
\ex \label{ex:khakt} 
\gll 
  \ipa{ʔuŋʌ}  	\ipa{ɦêlpɵ}  	\ipa{kʰakt-t-ʌ.}  \\
\textsc{1sg:erg} in-law be.shy-\textsc{pst-1sg} \\
 \glt  I felt shy in front of my in-law.
\end{exe}
 
The  examples with such an interpretation  group semantically around cognition and emotion verbs. The A of the transitive base verb and the S of the \ipa{--si} verb correspond to the experiencer, and the P of the base verb to the stimulus. Other examples are |\ipa{jʌ ʦʰipt-si}| , ‘to be worried about (the future)’ or |\ipa{mimt-si}| `to think'  (see also section \ref{sec:aktionsart} below).

\subsubsection{Anticausative}

The anticausative interpretation implies a spontaneous, actor-less event affecting a referent.  The A of the base verb is deleted during derivation, and the P becomes the S of the derived verb. Verbs with this interpretation refer to concrete actions involving translational or non-translational motion.
 \begin{exe}
\ex \label{ex:anticaus}
\glt $A  \rightarrow \varnothing $  
\glt $P \rightarrow S $  
\end{exe}
Example \ref{ex:lentsi}  shows the verb |\ipa{lent-si}| `slide down' derived from |\ipa{lent}| `to push down'.

\begin{exe}
\ex \label{ex:lentsi} 
\gll 
\ipa{ʔʌ̄m}  	\ipa{jôː}  	\ipa{mu-lēi-w-ɛ-si.}  \\
\textsc{3sg} river neg-push.down-\textsc{irr-2/3-refl} \\
\glt He did not slide into the river.
\end{exe}

Other examples include |\ipa{kʰunt-si}| `go into the ground', |\ipa{dom-si}| `to accumulate' or |\ipa{kʰɛt-si}| `be blocked'.  
 
 \subsubsection{Agentless passive}
With a passive interpretation, the A of the base verb is deleted and the P is converted to S. Passive differs however from anticausative in that the agent is only deleted syntactically: it is still recoverable semantically. In particular, it can be used to refer to a generic actor.
...
The verb |\ipa{ʦir-si}| `to be poured' from |\ipa{ʦir}| `pour' in example \ref{ex:tsirsi}  illustrates this usage. 
 \begin{exe}
\ex \label{ex:tsirsi} 
\gll 
 \ipa{lup-bî-m}  	\ipa{ʦi}  	\ipa{ʦʌ̄r-t-ɛ-si.}  \\
 jar-\textsc{loc-nmlz} alcohol pour-\textsc{pst-2/3-refl} \\
 \glt The alcohol in the jar has been poured. 
 \end{exe}
 Another common example is the reflexive of |\ipa{ʔɛt}| `say', the only transitive verb with intransitive conjugation in the language. Here the S corresponds to the complement clause containing the reported speech, which can be overt or not. The speaker and the addressee are generic.
  \begin{exe}
\ex \label{ex:7yatsi} 
\gll 
 \ipa{ʔɵdi}  	\ipa{mʉ-to}  	\ipa{ʔɛ̂n-si.}  \\
thought make-\textsc{conv}  say-\textsc{refl} \\
 \glt One (has to) be careful of what one says.
 \end{exe}
 
\subsubsection{Intransitive} 
One \ipa{--si} verb, \ipa{ʦɛʔi-si} `to be embarrassed', is derived from an intransitive verb  \ipa{ʦɛʔi} `to taste bad, to be unpleasant'.  Here, the derivation has changed the stimulus into an experiencer, without influencing the valency of the verb.
 ...
 \ipa{--si} derivation, while very productive and regular, presents semantic ideosyncrasies involving lexical aspect or general meaning restricted to a few lexical items.
  ...
  \subsubsection{Aktionsart} \label{sec:aktionsart}
The influence of detransitive derivation on lexical aspect has been noticed by many authors (see for instance \citealt{cooreman94antipassive}), and a few such examples are found in Khaling.

Two telic  transitive cognition verbs, |\ipa{ʦʰent}| `recognize' and |\ipa{mimt}| `remember' (example \ref{ex:mimt}) form atelic detransitive verbs  |\ipa{ʦʰent-si}| `be acquainted with' and |\ipa{mimt}| `think that' (\ref{ex:mimtsi}).


\begin{exe}
\ex \label{ex:mimtsi}
\gll \ipa{ʦɵʦʦɵ}  	\ipa{mu-ŋʌ-t-ʌ-lo}  	\ipa{bʰʌ̄ŋte}  	\ipa{ʦēi-w-ʌsu-kʰo}  	\ipa{nōː-w-ɛ}  	\ipa{rʌ̄iʦʰʌ}  	\ipa{mʌ̄m-si-ŋʌ.}  \\
child be-\textsc{1sg:S/P-pst-1sg} well teach-\textsc{irr-refl:1sg}-if good-\textsc{irr-2/3} \textsc{mir} remember-\textsc{refl-1sg} \\
\glt  I think that it would have been good to learn well while I was a child.
\end{exe}
...
\begin{exe}
\ex \label{ex:mimt}
\gll \ipa{ʔʌ̄m-ʔɛ}  	\ipa{ʦɛ̂mɦɵː-t-ɛ̂-m}  	\ipa{brâː}  	\ipa{mʌ̂m-kʰʌ-t-ɛ.}  \\
\textsc{3sg-erg} forget-\textsc{pst-2/3-nmlz} word remember-completely-\textsc{pst-2/3} \\
\glt He remembered the things he had forgotten.
\end{exe}


The change to an atelic verb is thus restricted to reciprocal and antipassive interpretations of the \ipa{--si} derivation.
