...
The blocking of Disyllable Reduction Rule in Khaling verbs is not due to stress placement (since both unstressed and stressed ending were unaffected. However, there is evidence that this rule did apply in pre-Khaling trisyllabic verb forms, affecting the second syllable, in particular with the dual and plural \ipa{--su} and \ipa{--nu} suffixes.
...
\midrule
*lóbu-nu  & \ipa{lɵ̂ːpnu} & they catch him \\ 
 %\ipa{*set-u}   &   \ipa{sɛr-u} & \ipa{sidɨ} & *sédu & \ipa{sēːdʉ} & he kills him \\ 
 % \ipa{*kok-u}   &    & \ipa{kukhɨ} & *kógu  & \ipa{kɵ̄ːgʉ} & he is able to do it \\
%    \ipa{*lom-u}   &     & \ipa{lumɨ} &*lómu  & \ipa{lɵ̄ːmʉ} & he looks for him \\
\bottomrule
...
expliquer aussi ps > p vs VpV > VbV, ks > k vs VkV > VgV
