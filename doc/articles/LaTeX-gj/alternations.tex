...
Yet, there remain a residue of forms with falling tones that cannot be accounted for by either scenario, in the past tense of the intransitive paradigm and of the  inverse transitive paradigm.

As presented in Table \ref{tab:intrans.paradigm}, singular and plural second and third person past and imperative forms have a falling tone in paradigms of verb with roots in sonorant codas.
...
However, there is no evidence the Syllable Reduction Rule can be invoked here to explain these falling tones. First, no high vowel is found in corresponding forms in Dumi or other Kiranti languages. Second, for the Syllable Reduction Rule to apply in verb forms, the stress in pre-Khaling would have to be placed on the stem, not on the suffix. Yet, if it were the case, the vowels should have been lengthened.... 
