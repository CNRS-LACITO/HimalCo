...
\toprule
 & \multicolumn{3}{l}{\ipab{w}-C clusters} & \multicolumn{3}{l}{\ipab{s}-C clusters} & \multicolumn{3}{l}{\ipab{z}-C clusters}  \\
\midrule
...
\toprule
 & \multicolumn{3}{l}{\ipab{l}-C clusters} & \multicolumn{3}{l}{\ipab{r}-C clusters} & \multicolumn{3}{l}{\ipab{ʂ}-C clusters}  \\
\midrule
...
\end{landscape}
 \resetcounters{2lrC}{3lrC} %deux groupes:\arabic{2lrC}  trois groupes:\arabic{3lrC}
   ...
   \begin{table}
 \caption{List of consonant clusters with \ipa{j}, \ipa{ɕ} or \ipa{ʑ}  as a first element (29+1)} \label{prein.j.Z}  \centering
   \resizebox{\columnwidth}{!}{
\begin{tabular}{llllllll}
\toprule
...
\end{table}
 ...
 \begin{table}
 \caption{List of consonant clusters with  \ipa{x}, \ipa{ɣ}, \ipa{χ} or \ipa{ʁ} as a first element (49)} \label{prein.G.R}  \centering
   \resizebox{\columnwidth}{!}{
\begin{tabular}{lllllllllll}
\toprule
...
\toprule
 & \multicolumn{3}{l}{homorganic nasal-C clusters} & \multicolumn{3}{l}{\ipab{n}-C clusters} & \multicolumn{3}{l}{\ipab{m}-C clusters}  \\
\midrule
