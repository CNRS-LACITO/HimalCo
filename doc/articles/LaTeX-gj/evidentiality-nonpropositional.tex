...
\begin{table}[H]
\caption{Nivacle determiner system (\citealt{gutierrez11evidentiality}) } \label{tab:nivakle}
...
\end{exe}
 ...
 %`encoding whether or not the speaker has the best possible grounds to believe in the existence of the individual' 
