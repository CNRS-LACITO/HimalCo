...
\citet[282]{lowe99nambiquara} 
 ...
 \begin{table}
 \caption{Nambiquara nominal evidential markers}
...
\ipa{-nu^1tã} & inferential, definite, unmarked \\
\ipa{-nu^1tai^2na^2} & inferential, current \\
\ipa{-au^3teʔ^1tã^2} & quotative, mid-past, given \\
\end{tabular}
\end{table}
...
\glt ‘this manioc root that both you and I saw recently’ (\citealt[282, ex 32.]{lowe99nambiquara} )
 ...
 \begin{exe}
\ex
\gll   \ipa{wa^3lin^3-su^3-nũ^1tã^2} \\
