...
Mi'kmaq (or Mi'gmaq in Listuguj orthography) is an Eastern Algonquian language. This section will focus on the dialect spoken in Quebec, called Restigouche (or Listuguj), as it shows a number of interesting innovations in its verbal system. %which make it the most divergent variety of the language. 
...
\begin{tabular}{lllllllll}
\toprule
 \backslashbox{A}{P}  & 	1\sg & 1\pe & 1\pli&  2\sg & 2\pl  &  3\sg & 3\pl & 4\sg\\ 
\midrule
...
4\sg &   \multicolumn{5}{c}{\grise{}} & \ipa{–t'l}  &  \multicolumn{2}{c}{\grise{}}\\
\bottomrule
\end{tabular}
}
\end{table}

One such innovation concerns the transitive animate paradigm. While all Mi'gmaq dialects have replaced the PA independent order forms by the conjunct order ones (which make them directly relevant to the topic of this paper), Listuguj has departed from the other dialects' more direct PA reflexes based on local person theme signs, and has innovated the TA morphology for the mixed 3$\rightarrow$1/2\pl\ scenario using a combination of the inverse suffix (\ipa{--ug--} < PA *\ipa{--ekw--}) and the reflexive one (\ipa{--si--} < PA *\ipa{--esi--}). 


\begin{table}[htbp]
\caption{Mi'gmaq (Hewson) VTA present indicative independent order paradigm of \ipa{nemi-} `to see'}
\resizebox{\textwidth}{!}{
\begin{tabular}{llllllllll}
\toprule
\backslashbox{A}{P} & 1\sg & 1\pe & 1\pli & 2\sg & 2\pl & 3\sg & 3\pl & 4\sg & 4\pl \\ 
\midrule
...
4\sg &   \multicolumn{5}{c}{\grise{}} & \ipa{nemii–a–li–jl}  & \ipa{nemii–a–li–ji}  &  \multicolumn{2}{c}{\grise{}}\\ 
4\pl &  \multicolumn{5}{c}{\grise{}} & \ipa{nemii–a–ti–li–jl}  & \ipa{nemii–a–ti–li–ji}  &   \multicolumn{2}{c}{\grise{}}\\  \bottomrule
\end{tabular}}
\label{migmaq_vta_hewson}
\end{table}

This development is comparable though only partially cognate to dialectal Nishnaabemwin (cf. section \ref{subsec:ojibwe}) and Wampanoag (Goddard and Bragdon 1988:556).
