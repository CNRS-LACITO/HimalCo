...
Previous scholarship on these AM and MCV in Manchu (\citealt{hayata95yuku}, \citealt{kubo97come}) focuses on their motional component (physical orientation, speaker’s and listener’s relative position, etc.) and some even concede that they are not synonymous, though no clear account of the differences between the two structures has ever been proposed.
