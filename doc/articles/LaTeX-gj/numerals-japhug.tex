...
As shown by Table \ref{tab:status}, although codas are generally preserved in compounds, there is a residue of forms where the final consonant drops in some very lexicalized compounds, mainly, but not exclusively, where the second element has a complex cluster.


\begin{table}[H]
\caption{Loss of final consonants in status constructus forms in Japhug.}  \label{tab:status} \centering
\resizebox{\columnwidth}{!}{
\begin{tabular}{lllll}
\toprule
