...
The semantics aspect of comparison, not fully explicited

\dhatu{riŋ}{praise} \dhatu{iŋ}{become famous} \dhatu{jɨŋ}{say, tell}

 \dhatu{glwam}{lie down}
\dhatu{glumt}{brood} \dhatu{kupt}{sleep with}, cf \ipa{ɕɯm}
\dhatu{ha kupt}{brood}


 \dhatu{kʰlwamt}{put to sleep} \dhatu{kʰlum}{bury}   \dhatu{kʰumt}{bury}   \dhatu{hum}{sink}? also khaling  \dhatu{ɦum}{fall}

 
 Bantawa \dhatu{kʰumt}{bury}  also drown
 
\dhatu{ri}{become dizzy} \dhatu{iːr}{turn, go around} 

\ipa{ku-niŋwa} \ipa{iːrɛ} he is dizzy

\ipa{ʔu-nûː} \ipa{rūː-tɛ} He got dizzy
...
XXXXXXXXXXXXXXXX
%haŋ/hakt "send" ɦoŋ
%\dhatu{juŋ}{sit}, \dhatu{jukt}{to sit on, to ride (e.g. a horse)} = Bantawa \dhatu{juŋ}{sit}, \dhatu{juŋs}{to put; to cause to sit}, +other lgs
%thaŋ, thakt "bring (from below"
%tʰomma (tʰoma) vi to dance. 
%tʰomma (tʰomsu) vt to make dance, to make someone else dance.
%tʰopma (tʰoptu) vt to dance for some one.
...
\item Wambule \dhatu{sja}{bear a fruit}, Bantawa  \dhatu{si}{bear fruit} and Khaling \dhatu{sit}{bear fruits} derive from the noun `fruit' (Khaling \ipa{si},  Bantawa \ipa{si}, Limbu \ipa{se}). Here Khaling differs from the other languages in having a denominal \ipa{-t}.
 ...
 \item Limbu \dhatu{sokt}{to aim, to point}, Khaling \dhatu{tsukt}{point (with a finger)}, Limbu \ipa{cok} `toe, finger'. xxxxx voicing
...
%yiKma vt to tell. cf yhKma alternations;  \dhatu{jɨŋ}{say, tell}
...
XXX+evidence from synchronic alternations within Bantawa:
%konma (kola) vi to walk, to move about, to walk around, wander. 
%kotma (kottu) vt to accompany, to make walk.

%cʰotma (cʰottu) vt to pay for someone else; to pay.
