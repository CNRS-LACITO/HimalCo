...
\newfontfamily\phon[Mapping=tex-text,Scale=MatchLowercase,FakeSlant=0.3]{Charis SIL} 
...
First,  many rhyme distinctions are neutralized in nouns, unlike verb roots, due to the lack of alternation. For instance, proto-Kiranti final *\ipa{-l} is preserved in Khaling and Wambule, but merges with *\ipa{-n} as \ipa{-n} in Bantawa and Limbu, as shown by the cognate set *\ipa{dɛl} `village' (Khaling \ipa{dēl}, Wambule \ipa{djal}, Bantawa \ipa{ten}, Limbu \ipa{tɛn} `place'). However, in verb roots, final *\ipa{-l} is clearly distinct from *\ipa{-n} in both Limbu and Bantawa, as is demonstrated in section \ref{sec:codas}.
...
In order to explain the \ipa{ɓ} : \ipa{k} : \ipa{kʰ} : \ipa{kʰ} correspondence, I suggest that  *\ipa{ʔw} first changed to *\ipa{kʷ}, and then merged with *\ipa{k} in languages other than Wambule.
 ...
 This correspondence is otherwise well attested in monosyllabic nouns, in particular *\ipa{ʔwi} `yam, potato' (Khaling \ipa{ki}, Limbu \ipa{kʰe}).\footnote{The verb `cover' shows that the Bantawa reflex of *\ipa{ʔw} is \ipa{kʰ}; thus, nouns such as \ipa{saki} `potato, yam' and \ipa{ogi} `sweet potato' must be borrowings.}
...
In open syllables, the alternations between \ipa{u} and \ipa{o} on the one hand and \ipa{i} and \ipa{e/ɛ} on the other hand may be remnants of former apophony. Note in particular that the Limbu verb \dhatu{kʰe}{to quarrel} presents an irregular stem form \ipa{kʰe} instead of expected \ipa{kʰejɛ}. A possible explanation is that \ipa{kʰe} is the regular outcome of *\ipa{kʰi-ɛ}, and that this fused form was reanalyzed as the root form, removing by analogy expected alternations between \ipa{i} and \ipa{e}.
...
As for the puzzling correspondences between where Wambule, Bantawa or Khaling have \ipa{a} corresponding to \ipa{e} in other languages, no good explanation is available, and it cannot be excluded that some of these comparisons have to be eventually discarded.
...
\bibitem[{van~der Auwera \& Vossen(2017)}]{auwera17copula}
van~der Auwera, Johan \& Frens Vossen. 2017.
\newblock {K}iranti double negation: a copula conjecture.
\newblock \emph{Linguistics of the Tibeto Burman Area} 40(1).

\bibitem[{Baxter \& Sagart(2014)}]{bs14oc}
Baxter, William~H. \& Laurent Sagart. 2014.
\newblock \emph{{O}ld {C}hinese: a new reconstruction}.
\newblock Oxford: Oxford University Press.

\bibitem[{Bickel et~al.(2007{\natexlab{a}})Bickel, Banjade, Gaenszle, Lieven,
  Paudyal, Rai, Rai, Rai \& Stoll}]{bickel07chintang}
Bickel, Balthasar, Goma Banjade, Martin Gaenszle, Elena Lieven, Netra Paudyal,
  Ichchha~Purna Rai, Manoj Rai, Novel~Kishore Rai \& Sabine Stoll.
  2007{\natexlab{a}}.
\newblock {F}ree prefix ordering in {C}hintang.
\newblock \emph{Language} 83(1). 1--31.

\bibitem[{Bickel \& Gaenszle(2015)}]{bickel15antipassive}
Bickel, Balthasar \& Martin Gaenszle. 2015.
\newblock {F}irst person objects, antipassives, and the political history of
  the {S}outhern {K}irant.
\newblock \emph{Journal of South Asian Languages and Linguistics} 2(1). 63--86.

\bibitem[{Bickel et~al.(2007{\natexlab{b}})Bickel, Gaenzle, Rai, Rai, Rai, Rai
  \& Sharma}]{bickel07puma}
Bickel, Balthasar, Martin Gaenzle, Arjun Rai, Prem~Shoj Rai, Shree~Kumar Rai,
  Vishnu Rai \& Narayan~P. Sharma. 2007{\natexlab{b}}.
\newblock {T}wo {W}ays of {S}uspending {O}bject {A}greement in {P}uma:
  {B}etween {I}ncorporation, {A}ntipassivization, and {O}ptional {A}greement.
\newblock \emph{Himalayan Linguistics Journal} 7. 1--19.

\bibitem[{Bloomfield(1925)}]{bloomfield25central}
Bloomfield, Leonard. 1925.
\newblock {O}n the sound-system of {C}entral {A}lgonquian.
\newblock \emph{Language} 1(4). 130–156.

\bibitem[{DeLancey(2010)}]{delancey10agreement}
DeLancey, Scott. 2010.
\newblock {T}owards a history of verb agreement in {T}ibeto-{B}urman.
\newblock \emph{Himalayan Linguistics} 9(1). 1--39.

\bibitem[{DeLancey(2014)}]{delancey14second}
DeLancey, Scott. 2014.
\newblock {S}econd person verb forms in {T}ibeto-{B}urman.
\newblock \emph{Linguistics of the Tibeto-Burman Area} 37(1). 3 – 33.

\bibitem[{DeLancey(2015)}]{delancey15complexity}
DeLancey, Scott. 2015.
\newblock {T}he {H}istorical {D}ynamics of {M}orphological {C}omplexity in
  {T}rans-{H}imalayan.
\newblock \emph{Linguistic Discovery} 13(2). 37--56.

\bibitem[{Dempwolff(1934)}]{dempwolff34induktiver}
Dempwolff, Otto. 1934.
...
\bibitem[{Doornenbal(2009)}]{doornenbal09}
...
\bibitem[{Hill(2007)}]{hill07ausgleich}
Hill, Eugen. 2007.
\newblock {P}roportionale {A}nalogie, paradigmatischer {A}usgleich und
  {F}ormerweiterung: ein {B}eitrag zur {T}ypologie des morphologischen
  {W}andels.
\newblock \emph{Diachronica} 24(1). 81–118.

\bibitem[{Hill(2010)}]{hill10synchronic}
Hill, Nathan~W. 2010.
\newblock {A}n overview of {O}ld {T}ibetan synchronic phonology.
\newblock \emph{Transactions of the Philological Society} 108(2). 110--125.

\bibitem[{Hill(2014{\natexlab{a}})}]{hill14voicing}
Hill, Nathan~W. 2014{\natexlab{a}}.
\newblock {A} note on voicing alternation in the {T}ibetan verbal system.
\newblock \emph{Transactions of the Philological Society} 112(1). 1--4.

\bibitem[{Hill(2014{\natexlab{b}})}]{hill14conditioned}
Hill, Nathan~W. 2014{\natexlab{b}}.
\newblock {G}rammatically conditioned sound change.
\newblock \emph{Language and Linguistics Compass} 8(6). 211--229.

\bibitem[{Hill(2014{\natexlab{c}})}]{hill14derivational}
Hill, Nathan~W. 2014{\natexlab{c}}.
\newblock {T}ibetan.
...
\bibitem[{Huysmans(2011)}]{huysmans2011sampang}
Huysmans, René. 2011.
\newblock {T}he {S}ampang verbal agreement system.
...
\bibitem[{Jacques(2004)}]{jacques04these}
...
\bibitem[{Jacques(2012{\natexlab{a}})}]{jacques12agreement}
Jacques, Guillaume. 2012{\natexlab{a}}.
\newblock {A}greement morphology: the case of {R}gyalrongic and {K}iranti.
\newblock \emph{Language and Linguistics} 13(1). 83--116.

\bibitem[{Jacques(2012{\natexlab{b}})}]{jacques12internal}
Jacques, Guillaume. 2012{\natexlab{b}}.
\newblock {A}n {I}nternal {R}econstruction of {T}ibetan {S}tem {A}lternations.
\newblock \emph{Transactions of the Philological Society} 110(2). 212–224.

\bibitem[{Jacques(2013)}]{jacques13tropative}
...
\bibitem[{Jacques(2014{\natexlab{a}})}]{jacques14antipassive}
...
\bibitem[{Jacques(2014{\natexlab{b}})}]{jacques14snom}
Jacques, Guillaume. 2014{\natexlab{b}}.
\newblock {O}n {C}oblin's law.
...
\bibitem[{Jacques(2015{\natexlab{a}})}]{jacques15derivational.khaling}
Jacques, Guillaume. 2015{\natexlab{a}}.
\newblock {D}erivational morphology in {K}haling.
...
\bibitem[{Jacques(2015-2016)}]{jacques16japhug}
...
\bibitem[{Jacques(2016{\natexlab{a}})}]{jacques16ebde}
Jacques, Guillaume. 2016{\natexlab{a}}.
\newblock {O}n the directionality of analogy in a {D}hegiha paradigm.
\newblock \emph{International Journal of American Linguistics} 8(2). 239--248.

\bibitem[{Jacques(2016{\natexlab{b}})}]{jacques16tonogenesis}
Jacques, Guillaume. 2016{\natexlab{b}}.
\newblock {T}onogenesis and tonal alternations in {K}haling.
\newblock In Enrique~L. Palancar \& Jean~Léo Léonard (eds.), \emph{{T}one and
  {I}nflection}, 41--66. Berlin: Mouton De Gruyter.

\bibitem[{Jacques et~al.(2012)Jacques, Lahaussois, Michailovsky \&
  Rai}]{jacques12khaling}
Jacques, Guillaume, Aimée Lahaussois, Boyd Michailovsky \& Dhan~Bahadur Rai.
  2012.
\newblock {A}n overview of {K}haling verbal morphology.
\newblock \emph{Language and Linguistics} 13(6). 1095--1170.

\bibitem[{Jacques et~al.(2016)Jacques, Lahaussois \& Rai}]{jacques16si}
Jacques, Guillaume, Aimée Lahaussois \& Dhan~Bahadur Rai. 2016.
\newblock {R}eflexive paradigms in {K}haling.
\newblock \emph{Linguistics of the Tibeto-Burman Area} 39(1). 33--48.

\bibitem[{Jacques et~al.(2015)Jacques, Lahaussois, Rai \&
  Kumar}]{jacques15khaling}
...
\bibitem[{Lahaussois(2009)}]{lahaussois09}
Lahaussois, Aimée. 2009.
\newblock {K}oyi {R}ai: {A}n initial grammatical sketch.
\newblock \emph{Himalayan Linguistics Archive} 4. 1--33.

\bibitem[{Lahaussois(2011)}]{lahaussois11thulung}
Lahaussois, Aimée. 2011.
\newblock {T}he {T}hulung {R}ai verbal system: an account of verb stem
  alternation.
\newblock \emph{Cahiers de Linguistique Asie Orientale} 40(2). 189--224.

\bibitem[{Michailovsky(1985)}]{michailovsky85dental}
Michailovsky, Boyd. 1985.
\newblock {T}ibeto-burman dental suffixes: {E}vidence from {L}imbu ({N}epal).
...
\bibitem[{Michailovsky(1988)}]{michailovsky88}
Michailovsky, Boyd. 1988.
\newblock \emph{{L}a langue hayu}.
\newblock Paris: Editions du CNRS.

\bibitem[{Michailovsky(1994)}]{michailovsky94stops}
Michailovsky, Boyd. 1994.
\newblock {M}anner vs place of articulation in the {K}iranti initial stops.
...
\bibitem[{Michailovsky(1997)}]{michailovsky97deponent}
Michailovsky, Boyd. 1997.
\newblock {C}atégories verbales et intransitivité duale en limbu.
\newblock \emph{Studi italiani di linguistica teorica e applicata} 26(2).
  307--325.

\bibitem[{Michailovsky(2002)}]{michailovsky02dico}
Michailovsky, Boyd. 2002.
\newblock \emph{{L}imbu-{E}nglish {D}ictionary}.
\newblock Kathmandu: Mandala Book Point.

\bibitem[{Michailovsky(2010)}]{michailovsky10kiranti}
Michailovsky, Boyd. 2010.
\newblock {P}reliminaries to the comparative study of the {K}iranti subgroup of
  {T}ibeto-{B}urman.
\newblock In \emph{{S}ino-{T}ibetan {C}omparative {S}tudies in the 21st
  {C}entury {I}nternational {S}ymposium}, 145--170. Taipei.

\bibitem[{Michailovsky(2012)}]{michailovsky12dumi}
Michailovsky, Boyd. 2012.
\newblock {I}nternal reconstruction of the {D}umi verb : {L}exical bases and
  stem formation.
\newblock \emph{Linguistics of the Tibeto-Burman Area} 35(2). 49--87.

\bibitem[{Michaud(2008)}]{michaud08na}
Michaud, Alexis. 2008.
\newblock {P}honemic and tonal analysis of {Y}ongning {N}a.
\newblock \emph{Cahiers de Linguistique - Asie Orientale} 37(2). 159--196.

\bibitem[{Michaud(2017)}]{michaud17yongning}
Michaud, Alexis. 2017.
...
\bibitem[{Opgenort(2004{\natexlab{a}})}]{opgenort04wambule}
Opgenort, Jean-Robert. 2004{\natexlab{a}}.
\newblock \emph{{A} {G}rammar of {W}ambule}.
\newblock Leiden: Brill.

\bibitem[{Opgenort(2004{\natexlab{b}})}]{opgenort04implosives}
Opgenort, Jean-Robert. 2004{\natexlab{b}}.
\newblock {I}mplosive and preglottalized stops in {K}iranti.
\newblock \emph{Linguistics of the Tibeto–Burman Area} 27(1). 1–27.

\bibitem[{Opgenort(2005)}]{opgenort05jero}
Opgenort, Jean-Robert. 2005.
\newblock \emph{{A} grammar of {J}ero, with a historical comparative study of
  the {K}iranti languages}.
\newblock Leiden: Brill.

\bibitem[{Rai(2011)}]{rai11dumi}
Rai, Netramani. 2011.
\newblock \emph{{D}umi-{N}epali-{E}nglish dictionary}.
\newblock Baksila: Dumi Kirat Rai Phansikim.

\bibitem[{Rai et~al.(2011)Rai, Rai, Paudyal, Schikowski, Bickel, Stoll,
  Gaenszle, Banjade, Rai, Bhatta, Sauppe, Rai, Rai, Rai, Rai, Rai, Rai, Rai,
  Rai, Rai, Rai, Rai, Pettigrew \& Dirksmeyer}]{rai11chintang}
