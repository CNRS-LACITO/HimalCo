...
\item 
Wambule \dhatu{gu}{pick up from the ground} vs Bantawa \dhatu{kup}{pick up from the ground}
XXXX \ipa{kuu} \textsc{3sg}$\rightarrow$3, cf \ipa{cɨma} \ipa{cuwu} `do'
\end{itemize}
...
XXXXX -st $\rightarrow$ -tt
%kɨma (kɨsa) ; kitma (kittu) vt (middle)	to be afraid
