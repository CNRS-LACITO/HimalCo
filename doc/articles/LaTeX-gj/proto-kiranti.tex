...
In the Sino-Tibetan family, Kiranti languages preserve best the applicative \ipa{-t} and causative \ipa{-s} suffixes, which can be exemplified by the triplet from Limbu (\citealt{michailovsky85dental}):
...
A system of nine simple codas, similar to Old Tibetan, is reconstructed for proto-Kiranti, as indicated in Table \ref{tab:codas}. There does not appear to be evidence for reconstructing glottal stop verb stems to proto-Kiranti, though there exist in Limbu.
...
The correspondences of Table \ref{tab:codas} are relatively robust; most exceptions involve correspondences between simple codas and complex codas, and are treated in section \ref{sec:Ct}. 
