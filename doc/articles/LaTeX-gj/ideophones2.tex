...
Acknowledgements will be added after editorial decision.  %Mark Dingemanse Aimée Lahaussois
} }
\author{Guillaume Jacques}
\maketitle
\linenumbers
%\citet{gerner04expressives1}
%\citet{gerner05expressives2}
...
%\gll 
  %	\ipa{rŋgɯ}  	\ipa{nɯ}  	\ipa{li}  	\ipa{ɲo-kɤtɯɣ-cɯ,}  	\ipa{tɕe}  	\ipa{zjɤɣnɤzjɤɣ}  	\ipa{pjɤ-ʑɣɤ-stu}  	\ipa{ɕti}  	\ipa{tɕe,}  \\
  	%boulder \textsc{top} gain \textsc{evd}-meet-\textsc{evd} \textsc{lnk} \textsc{ideo:dyn}:tall \textsc{evd.ipfv-refl}-do.like \textsc{n.pst:be}:\textsc{const} \textsc{lnk}   	\\
...
\gll 
 	...
 	\textsc{nmlz:S/A}-be.thick \textsc{indef} \textsc{ideo:stat}:thick.and.round \textsc{emph} \textsc{const}-be    \\
