...
\newcommand{\ipa}[1]{{\phon \scriptsize \textbf{#1}}} %API tjs en italique
\newcommand{\ipapl}[1]{{\phondroit #1}} 

\newcommand{\gros}[1]{{\Large #1}}
\newcommand{\racine}[1]{\begin{math}\sqrt{\ipapl{#1}}\end{math}} 
%\newcommand{\racine}[1]{\textbf{#1}} 
 \makeindex
