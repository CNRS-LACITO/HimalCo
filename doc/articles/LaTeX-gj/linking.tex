...
%ɣɯjpa kɯ-fse nɯreri tɕe ɯ-mɯntoʁ ɲɯ-lɤt, fsaqʰe tɕe tɕe ɯ-mat ɲɯ-βze ŋu, ʁmɯrtsɯ nɯ sɤre ma.
...
%tɕɤthi kʰɯɣɲɟɯ zɯ, nɯ... nɤki, ʁmɯrcɯ ʁnɯz ɲɯ-ɤnɯɣro-ndʑi tɕɤn, nɯ ɲɯ-nɤre-a ɕti wo" to-ti t is because
...
%tɕeri tɤpɤtso nɯ kɯ si nɯ ku-tɯ-ndo ʑo tɕe tɕendɤre iɕqʰa, 
%tɯrme kɯ-wxtɯ-wxti nɯ kɯ ɕlaʁ ʑo ɯ-jaʁ ɲɤ-ɣɤɴɢu tɕe


%tɤ-ʑi nɯnɯ kɯ, tɕendɤre, ɯ-tɯ-ɕpaʁ pjɤ-tɕʰom qʰe, 
...
\textsc{1sg} before \textsc{1sg.poss}-elder.sibling \textsc{pl} up.there stay:\textsc{fact}-\textsc{pl} \textsc{lnk} \textsc{dem} \textsc{pl} \textsc{gen} \textsc{imp-caus}-be.first[III] \textsc{lnk} \\
...
\glt There are (fir mushrooms) among big firs, but there none among little ones. (\ipa{tɯrgi grɯβgrɯβ}, 63)
\end{exe}
 ...
 &Precedence& SC with the postposition  \ipa{ɕɯŋgɯ} `before'\\
  ...
  &Immediate  & SC with the \textbf{perfective converb} \ipa{tɯ--}\\
   ...
   &&and \ipa{kóʁmɯz} `just after'\\
     &Immediate  & SC with the linker \ipa{tɤkʰa} `about to'\\
...
\glt The handle of the earth clod breaker, when there is no oak wood, people can also make it using the \ipa{xɕɤj} wood (\ipa{xɕɤj}, 44).
\end{exe}
...
\textsc{ipfv-inv}-thrush need:\textsc{fact} \\
\glt After one has woven it, when the weaving is finished, one has to wash it and thrush it again. (gunny bag, 10)
\end{exe}
...
Pleiades \textsc{dem} \textsc{pfv}-come.out \textsc{3sg.poss}-after a.little \textsc{loc} \textsc{lnk} \textsc{lnk} earthworm \textsc{ipfv}-come.out be:\textsc{fact} \\
...
\gll  [\ipa{tɯmɯ}   	\ipa{ka-lɤt}   	\textbf{\ipa{ɯ-mpʰru}}  	\ipa{nɯ}   	\ipa{tu.}     \\
 sky \textsc{pfv}:3$\rightarrow$3-auxiliary 3\textsc{sg.poss}-after \textsc{dem} exist:\textsc{fact} \\
\glt  It is found after it has rained. (\ipa{zdɯmqe}, 73)
\end{exe}
...
already \textsc{ipfv}-die before \textsc{emph} \textsc{3sg.poss}-flesh \textsc{3sg}-\textsc{bare.inf}:eat \textsc{ipfv}-start-\textsc{pl} be:\textsc{assertive}:\textsc{fact} \\
\glt They start eating its flesh before it dies. (Lion, 44)
\end{exe}
...
Lobzang \textsc{ipfv}-come.home before marriage make:\textsc{fact}-\textsc{1pl} need:\textsc{fact} \\
...
\textsc{genr.poss-nmlz.S/A}-hurt \textsc{ipfv}-start[III] before while \textsc{ipfv-inv-caus}-treat have.to:\textsc{fact} \\
\glt It is necessary to have someone treat it before one's disease starts. (elicited)
\end{exe} 
...
mouse \textsc{dem} \textsc{erg} \textsc{irr-neg-pfv-genr}:S/P-bite need:\textsc{fact} \textsc{lnk} where \textsc{pfv}:3$\rightarrow$3-grab \textsc{lnk} \textsc{neg:pfv}-be.torn.apart until \textsc{ipfv}:put[III] \textsc{neg}:be.usually.the.case\textsc{:fact} \\
...
\textsc{3sg.poss}-fruit \textsc{nmlz:action}-throw \textsc{pfv:3$\rightarrow$3}-begin until \textsc{neg}-recognize:\textsc{fact}-\textsc{pl} \\
...
people \textsc{pl} \textsc{erg} \textsc{ipfv-conv:imm}-see \textsc{emph} kill:\textsc{fact}-\textsc{pl} be.\textsc{assertive}:\textsc{fact} \\
...
\glt When one breaks (its stalk), as it is very brittle, it breaks at once into two pieces. (\ipa{mɤdɤmɲɤm}, 37)
 \end{exe}
...
\gll 
[\ipa{tʰamakʰa}   	\textbf{\ipa{pjɯ-tɯ-sko}}]   	\ipa{tɕe}   	\ipa{tu-oɕqʰe-a}   	\ipa{ŋu}   	\\
tobacco \textsc{ipfv-conv:imm}-smoke \textsc{lnk} \textsc{ipfv}-cough-\textsc{1sg} be:\textsc{fact} \\
...
squirrel \textsc{dem} \textsc{pfv}-be.born immediately.after \textsc{dem} piglet \textsc{ipfv-conv:imm}-be.born \textsc{lnk} \textsc{lnk} \textsc{lnk} \textsc{dem} \textsc{dem} \textsc{nmlz}:S/A-be.black completely exist:\textsc{fact} \textsc{nmlz}:S/A-be.white completely exist:\textsc{fact} \\
\glt When a squirrel has just been born... when piglets have just been born, some are completely black, others are completely white. (Black and white fur, 216-7)
\end{exe}
...
\textsc{lnk} \textsc{inv}-gore:\textsc{fact} \textsc{pst.ipfv}-be \textsc{lnk} \textsc{indef} \textsc{dem} \textsc{neg-inv-caus}-can  \textsc{pst.ipfv}-be about \textsc{emph} deer \textsc{dem} \textsc{pfv-auto}-come.out \textsc{lnk} \\
...
three-turn almost three-turn \textsc{conative-evd}-go \textsc{emph} \textsc{lnk} \textsc{dem} a.part.from \textsc{neg-evd:perm}-can \textsc{lnk} \\
...
%\gll
%\ipa{tɕetʰa}  	\ipa{ʑatsa}  	\ipa{tɕe}  	\ipa{ɯ-kʰa}  	\ipa{ndzu}  	\ipa{tɕe}  	\ipa{pa}  	\ipa{ɣi}  \\
%later soon \textsc{lnk} \textsc{3sg.poss}-house be.almost.ready:\textsc{fact} \textsc{lnk} down come:\textsc{fact} \\ 
...
\gll
\ipa{mɤ-nɯɣɯ-mto}  	\ipa{tɕe}  	[\ipa{wuma}  	\ipa{ʑo}  	\textbf{\ipa{mɯ\textasciitilde{}mɤ-pɯ-kɯ-tso}}]  	\ipa{nɤ}  	\ipa{mɤ́-wɣ-mto}  \\
 \textsc{neg}-\textsc{facilitative}-see:\textsc{fact} \textsc{lnk} very \textsc{emph} \textsc{cond\textasciitilde{}neg-pst.ipfv-genr:S/P}-understand \textsc{lnk} \textsc{neg-inv}-see:\textsc{fact}  \\
...
\textsc{interrog-ipfv}-2-be.in.a.hurry \textsc{lnk} \textsc{ipfv}-2$\rightarrow$1-step.over-\textsc{1sg} \\
\glt If you are in a hurry, (you may) step over me. (The three sisters, 14)
\end{exe}
...
\textsc{cond\textasciitilde{}neg}-2$\rightarrow$1-take.away:\textsc{fact}-\textsc{1sg-pl} \textsc{lnk} \textsc{neg}-give[III]:\textsc{fact}-\textsc{1sg} \\
...
\textsc{transloc-inf}-bring \textsc{cond\textasciitilde{}neg-pst.ipfv}-2-can be:\textsc{fact} \textsc{lnk} \textsc{2sg.poss}-root \textsc{2sg.poss}-life throw:\textsc{fact}-\textsc{1pl} \\
\glt If you are not able to bring (the treasure) here, we will kill you. (Slobdpon1, 9)
\end{exe}
...
\textsc{dem} be.like:\textsc{fact} \textsc{ipfv-nmlz:}S/A-hurt \textsc{pst.ipfv-auto}-be
...
cow be:\textsc{fact} \textsc{intrrg} horse  be:\textsc{fact} \textsc{lnk} \textsc{ipfv}-be.poisoned \textsc{testim}-be.usually.the.case \\
...
\glt (this way), even when there was a lot of water, even when the bucket was very heavy, it would not hurt one's waist. (\ipa{zgri}, 188)
\end{exe}
...
\textsc{ipfv-inv}-burn also \textsc{ipfv}-be.ignited \textsc{contrast:foc} be:\textsc{fact} \textsc{lnk}
\textsc{3sg.poss}-charcoal \textsc{dem}  be.black:\textsc{fact} \textsc{emph} \textsc{lnk} at.all \textsc{ipfv-caus}-be.warm[III] \textsc{neg}-can:\textsc{fact} \\
\glt Even when one burns it, although it does ignite, its charcoal is black and it does not warm anything. (\ipa{tʰɤwum}, 8-10)
\end{exe}
...
\textsc{nmlz}:S/A-be.sick \textsc{dem} doctor \textsc{erg} \textsc{cond\textasciitilde{}neg-transloc-pfv}:3$\rightarrow$3'-treat \textsc{lnk} die:\textsc{fact} be.\textsc{affirmative}:\textsc{fact} \\
...
%yesterday.evening \textsc{nmlz:S/A-emph}-\textasciitilde{}be.good \textsc{emph} \textsc{pfv}-sleep-\textsc{1sg} \textsc{irr-pst.ipfv}-not.be \textsc{lnk} today \textsc{lnk} be.sleepy:\textsc{fact}-\textsc{1sg} \textsc{evd.ipfv}-be \\
...
\glt People should not touch it, otherwise they would get poisoned. (\ipa{grɯβgrɯβftsa}, 26)
 \end{exe}
...
\textsc{imp}-be.careful \textsc{lnk} 2-fall.down:\textsc{fact} \\
...
what \textsc{ipfv:downstream}-2-walk.around be:\textsc{fact} \textsc{lnk} in.a.moment demon \textsc{erg} 2-\textsc{inv}-eat:\textsc{fact} \\
...
\textsc{dem}  lie \textsc{neg-imp}-make[III]-\textsc{1sg} have.to:\textsc{fact} \textsc{lnk} \textsc{lnk}   history record \textsc{ipfv}-2-make[III] be:\textsc{affirmative}:\textsc{fact} later generations \textsc{erg}  \textsc{inv}-scold:\textsc{fact}-\textsc{1sg-pl} \\
\glt I cannot tell lies, as   you are making a historical record, and previous and future generations would scold me.  (\ipa{kikakɕi}, 217)
 \end{exe}
...
you \textsc{pfv:down}-come.out \textsc{lnk} \textsc{neg}-be.possible:\textsc{fact} \textsc{2sg.poss}-house \textsc{neg:imp}-2-stay \textsc{lnk} \textsc{neg}-be.possible:\textsc{fact} \\
...
really \textsc{emph} \textsc{indef.poss}-hand \textsc{indef.poss}-strength a.little \textsc{inv}-throw:\textsc{fact} have.to:\textsc{fact} \textsc{lnk} \textsc{dem} until \textsc{inf}-take.out \textsc{neg-deexperiencer}-can:\textsc{fact} \\
\glt  One has to exert all of one's strength with one's hand, otherwise it is not possible to pull it out. (\ipa{stoʁtsa}, 150)
 \end{exe}
 \begin{exe}
\ex \label{ex:nWmaRnA}
\gll 
 ...
 house \textsc{lnk} cat \textsc{erg} \textsc{ipfv}-eat[II] be:\textsc{fact} \textsc{lnk} \textsc{dem} \textsc{erg} \textsc{ipfv}-destroy be.\textsc{affirmative}:\textsc{fact} \textsc{lnk} \textsc{dem} not.be:\textsc{fact} \textsc{lnk} mouse \textsc{top:emph} people \textsc{3sg}-on more be.harmful:\textsc{fact}  \\
...
\gll 
 \ipa{kɤ-rɤrɟɯt}  	\ipa{ʑatsa}  	\ipa{mda}  	\ipa{tɤ-ŋu}  	\ipa{tɕe,}  	\ipa{tɕʰeme}  	\ipa{nɯ}  	\ipa{kʰro}  	\ipa{tu-kɯ-rɤrma}  	\ipa{tɕe}  	[<huodong>  	\ipa{tú-wɣ-βzu}  	\ipa{ra}]  	\ipa{\textbf{ma}}  	\ipa{\textbf{nɯ}}  	\ipa{\textbf{maʁ}}  	\ipa{\textbf{nɤ}}  	\ipa{\textbf{tɕetʰa}}  	\ipa{tɤpɤtso}  	\ipa{kɤ-sci}  	\ipa{ɴqa}  	\ipa{tu-ti-nɯ}  	\ipa{ŋgrɤl.} \\
...
girl \textsc{dem} \textsc{lnk} platform \textsc{dem} \textsc{lnk} \textsc{ipfv:east}-go \textsc{lnk} \textsc{ipfv:west}-come \textsc{lnk} \textsc{ipfv}-look.around because \textsc{dem} a.part;from work:\textsc{fact} \textsc{neg-evd:ipfv}-have.to \\ 
...
\textsc{nmlz:S/A}-be.smooth not.be:\textsc{fact} \textsc{erg}   {pfv-nmlz:S/A}-be.rough extsc{nmlz:S/A}-be.like \textsc{ideo}:II:coarse.and.irregular be:\textsc{fact}  \textsc{lnk} \\
...
cow \textsc{pl} \textsc{3pl}-on \textsc{ipfv}-be.many \textsc{ipfv}-be.in.excess \textsc{neg:testim}-be.good \textsc{lnk} \\
