...
\textsc{dem} \textsc{pfv}-be.white \textsc{top} one-day two-day about \textsc{pfv}-pass \textsc{lnk} ... \textsc{lnk} \textsc{dem} \textsc{ipfv}-be.ripe \textsc{const}-be \\
...
\textsc{ipfv-inv}-thrush \textsc{n.pst}:need \\
...
Pleiades \textsc{dem} \textsc{pfv}-come.out \textsc{3sg.poss}-after a.little \textsc{loc} \textsc{lnk} \textsc{lnk} earthworm \textsc{ipfv}-come.out \textsc{n.pst}:be \\
...
\gll  [\ipa{tɯmɯ}   	\ipa{ka-lɤt}   	\textbf{\ipa{ɯ-mpʰru}}]   	\ipa{nɯ}   	\ipa{tu.}     \\
 sky \textsc{pfv}:3>3-auxiliary 3\textsc{sg.poss}-after \textsc{dem} \textsc{n.pst}:exist \\
...
mouse \textsc{top} \textsc{erg} \textsc{irr-neg-pfv-genr}:S/P-bite \textsc{n.pst}:need \textsc{lnk} where \textsc{pfv}:3>3-grab \textsc{lnk} \textsc{neg:pfv}-be.torn.apart until \textsc{ipfv}:put[III] \textsc{neg:n.pst}:be.usually.the.case \\
...
people \textsc{pl} \textsc{erg} \textsc{ipfv-conv:imm}-see \textsc{emph} \textsc{n.pst}:kill-\textsc{pl} \textsc{n.pst}:be:\textsc{assertive} \\
...
\textsc{3sg.poss}-child \textsc{ipfv-conv:imm}-hatch.out \textsc{lnk} sparrow about apart.from \textsc{n.pst}:not.exist \\
...
\textsc{ipfv-conv:imm}-be.clear \textsc{emph} \textsc{lnk} \textsc{nmlz:action}-work \textsc{ipfv}-begin[III] \textsc{const}-be \\
...
%later soon \textsc{lnk} \textsc{3sg.poss}-house \textsc{n.pst}:be.almost.ready \textsc{lnk} down \textsc{n.pst}:come \\ 
...
\ipa{mɤ-nɯɣɯmto}  	\ipa{tɕe}  	[\ipa{wuma}  	\ipa{ʑo}  	\textbf{\ipa{mɯ-mɤ-pɯ-kɯ-tso}}]  	\ipa{nɤ}  	\ipa{mɤ́-wɣ-mto}  \\
 \textsc{neg}-\textsc{n.pst}:easy.to.see \textsc{lnk} very \textsc{emph} \textsc{cond-neg-pst.ipfv-genr:S/P}-understand \textsc{lnk} \textsc{neg-inv-n.pst}:see  \\
...
\textsc{cond-neg}-2$\rightarrow$1-\textsc{n.pst}:take.away-\textsc{1sg-pl} \textsc{lnk} neg-n.pst:give[III]-\textsc{1sg} \\
...
\textsc{transloc-inf}-bring \textsc{cond-neg-pst.ipfv}-2-can \textsc{n.pst}:be \textsc{lnk} \textsc{2sg.poss}-root \textsc{2sg.poss}-life \textsc{n.pst}:throw-\textsc{1pl} \\
...
\gll
 ...
 \textsc{dem} \textsc{n.pst}:not.be \textsc{lnk} { } what  \textsc{n.pst}:not.be \textsc{lnk}  \\
\end{exe}
...
\gll
 ...
 \textsc{pst.ipfv}:3$\rightarrow$3-\textsc{auto}-agree \textsc{lnk} \textsc{ipfv}:go-\textsc{1sg}
  \textsc{neg-pst.ipfv}:3$\rightarrow$3-\textsc{auto}-agree \textsc{lnk} \textsc{ipfv}:go-\textsc{1sg} \textsc{n.pst}:have.to \\
...
\textsc{pfv}:3$\rightarrow$3-agree \textsc{pst.ipfv-auto}-be \textsc{pst.ipfv-auto}-not.be \textsc{ipfv}:go-\textsc{1sg} \textsc{n.pst}:have.to \\
\glt I will go whether he agrees or not. (elicited)
\end{exe}
...
\textsc{dem} \textsc{n.pst}:be.like \textsc{ipfv-nmlz:}S/A-hurt \textsc{pst.ipfv-auto}-be
\textsc{dem} \textsc{erg} very \textsc{emph} \textsc{n.pst}:heal \\
...
%yesterday.evening \textsc{nmlz:S/A-redp}-be.good \textsc{emph} \textsc{pfv}-sleep-\textsc{1sg} \textsc{irr-pst.ipfv}-not.be \textsc{lnk} today \textsc{lnk} \textsc{n.pst}:be.sleepy-\textsc{1sg} \textsc{evd.ipfv}-be \\
...
pig \textsc{gen} \textsc{3sg.poss}-manure \textsc{n.pst}:be.many because \textsc{neg-n.pst}:eat[III] \textsc{emph} \textsc{n.pst}:not.exist \textsc{lnk} \textsc{3sg.poss}-manure  \textsc{n.pst}:be.many \\
...
\textsc{imp}-be.careful \textsc{lnk} 2-\textsc{n.pst}:fall.down \\
...
what \textsc{ipfv:downstream}-2-walk.around \textsc{n.pst}:be \textsc{lnk} in.a.moment demon \textsc{erg} 2-\textsc{inv-n.pst}:eat \\
...
really \textsc{emph} \textsc{indef.poss}-hand \textsc{indef.poss}-strength a.little \textsc{inv-n.pst}:throw \textsc{n.pst}:have.to \textsc{lnk} \textsc{dem} until \textsc{inf}-take.out \textsc{neg-n.pst:deexperiencer}-can \\
...
\gll 
 ...
 house \textsc{lnk} cat \textsc{erg} \textsc{ipfv}-eat[II] \textsc{n.pst}:be \textsc{lnk} \textsc{dem} \textsc{erg} \textsc{ipfv}-destroy \textsc{n.pst}:be:\textsc{affirm} \textsc{lnk} \textsc{dem} \textsc{n.pst}:not.be \textsc{lnk} mouse \textsc{top:emph} people \textsc{3sg}-on more \textsc{n.pst}:be.harmful  \\
...
\gll 
 ...
 \textsc{inf}-have.a.child soon \textsc{n.pst}:be.the.time  \textsc{pfv}-be \textsc{lnk} woman \textsc{top} a.lot \textsc{ipfv-genr}:S/P-work \textsc{lnk} activity \textsc{ipfv-inv}-make \textsc{n.pst:}have.to \textsc{lnk} textsc{dem} \textsc{n.pst}:not.be \textsc{lnk}  later
 child \textsc{inf}-be.born  \textsc{n.pst}:difficult \textsc{ipfv}-say-\textsc{pl} \textsc{n.pst}:be.usually.the.case  \\
