...
\glt When bears_i root out ant_jhills, they_j go inside their_i eyes_k and urinate in them_k.
(bear, 26)
\end{exe}
...
cow be:\textsc{fact} \textsc{intrg} horse  be:\textsc{fact} \textsc{lnk} \textsc{ipfv}-be.poisoned \textsc{testim}-be.usually.the.case \\
