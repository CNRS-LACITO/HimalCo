...
\textsc{indef.poss}-water \textsc{pst.ipfv-auto}-be.many bucket  \textsc{pst.ipfv-auto}-heavy also \textsc{indef.poss}-waist \textsc{neg-ps.ipfv:3$\rightarrow$3-caus}-hurt\\
