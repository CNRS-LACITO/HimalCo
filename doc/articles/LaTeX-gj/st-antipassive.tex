...
\title{Antipassive derivations in Sino-Tibetan/Trans-Himalayan and their sources\footnote{The Japhug examples are taken from a corpus that is progressively being made available on the Pangloss archive (\citealt{michailovsky14pangloss},  
 \url{http://lacito.vjf.cnrs.fr/pangloss/corpus/list\textunderscore rsc.php?lg=Japhug}). This research was funded by the HimalCo project (ANR-12-CORP-0006) and  the Labex Empirical Foundations of Linguistics (ANR/CGI). I would like to thank Linda Konnerth, Randy LaPolla, Mark W. Post and Willem de Reuse for comments on this paper.}}
...
Note that apart from the marginal example of Old Chinese, all languages with antipassive derivations in Sino-Tibetan also have ergative or agentive case marking.
