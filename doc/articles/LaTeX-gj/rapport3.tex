...
\newcommand{\ipapl}[1]{{\phondroit\textbf{#1}}} 
...
\section{Philologie tangoute}
	...
	Par ailleurs, j’ai  étudié les suffixes d’accord personnel du tangoute: j’ai découvert que ceux-ci pouvaient être utilisés directement sur un nom sans que la copule ne soit obligatoire (\citealt{jacques08weiyu}). Ce phénomène est insolite, car aucune langue moderne du groupe macro-rgyalronguique ne semble présenter d’exemples similaires. Il peut être d’une importance conséquente pour la reconstruction de la morphologie du proto-macro-rgyalronguique.
	
	J'ai  écrit en outre un article sur la morphologie verbale,	\citet{jacques11tangut.verb}, dans lequel je décris le fonctionnement de plusieurs préfixes exprimant la modalité et démontre l'existence d'incorporation en tangoute.  
...
\epigraph{\textit{Gaawiin giwanitoosiimin gidinwewininaan.}}
