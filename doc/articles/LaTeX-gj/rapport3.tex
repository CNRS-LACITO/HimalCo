...
J'espère pouvoir à l'avenir guider les étudiants en linguistique et philologie tangoute. J'ai de nombreux travaux sur cette langues non-achevés, en particulier une transcription et traduction de la \textit{Forêt des catégories}, le plus long des textes narratifs non-bouddhiques en tangoute. Ces travaux inachevés pourront être poursuivi par des étudiants; j'ai de nombreux sujets potentiels de mémoire de M2 clairement circonscrits, faisables en une année et pouvant mener à des publications à proposer aux étudiants intéressés.
...
Mon intérêt pour la typologie m'a conduit à m'intéresser aux langues d'Amérique du Nord, que l'on ne peut soupçonner d'avoir connu un contact ou d'être démontrablement apparentées aux langues de l'Eurasie.

J'ai étudié un peu de lakhota je suis en train de rédiger un article portant sur la reconstruction des formes verbales irrégulières. J'y propose l'existence d'une nouvelle loi phonétique *pk- > *hp-, et montre que les correspondances apparemment irrégulières entre les marques affixales des langues sioux peuvent s'expliquer par différents processus analogiques et n'est en aucun cas le résultat de lois phonétiques irrégulières.  
...
Un autre sujet d'intérêt est le destin des groupes de consonnes, en particulier des groupes d'occlusives resultatnt de la monosyllabicisation de dissyllabes (\citet{ferlus82spirantisation}, \citet{michaud12mono}). 
