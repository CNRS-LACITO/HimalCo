...
In this section, we discuss two issues regarding the status of finite relative clauses. First, we show that unlike in Tshobdun, inverse marking is possible in finite relative clauses in Japhug. Second, we discuss some minute  morphosyntactic differences between finite relative clauses and independent clauses.

 \subsection{Inverse forms in relative clauses}
 
Direct/inverse marking is neutralized in non-finite relative clauses, as the inverse prefix \ipa{-wɣ--}, stem 3 and the past transitive direct \ipa{--t} suffix cannot appear in nominalized verb forms.

However,  finite relative clauses are attested with inverse marking in Japhug as in example \ref{ex:nWwGmbi}, a fact that distinguishes Japhug from Tshobdun, where such sentences are reportedly ungrammatical  (\citealt{jacksonlin07}).
