...
\glt 
What I say is, in English, when you speak, is it similar to the written language? (conversation 2014, Tshering Sgrolma)
\end{exe}


\ipa{tɕe}  	\ipa{iʑo}  	\ipa{kɯrɯ}  	\ipa{ra}  	\ipa{tɕe}  	\ipa{tʂhɤlu}  	\ipa{nɯ}  	\ipa{stu}  	\ipa{ji-kɤ-rga}  	\ipa{ɕti}  
...
\ex
\gll 
\ipa{tɕeri}  	\ipa{nɯnɯ}  	\ipa{ɯ-kɯ-sɯ-mphɯl}  	\ipa{nɯ}  	\ipa{li}  	\ipa{ɯ-zrɤm}  	\ipa{ɲɯ-ɕti}  	\ipa{ma}  	\ipa{ɯ-rɣi}  	\ipa{ɲɯ-maʁ}  \\
...
\glt It is its root that causes it to multiply, not its seeds. (\ipa{razɴɢu} 106)
\end{exe}
...
\ex
\gll 
\ipa{tɕeri}  	\ipa{mɤ-kɯ-naχtɕɯɣ}  	\ipa{tɕe,}  	\ipa{ɯ-ndzrɯ}  	\ipa{ɣɤʑu}  \\
but neg-nmlz:S/A-be.different \textsc{lnk} \textsc{3sg.poss}-claw exist:\textsc{sensory} \\
