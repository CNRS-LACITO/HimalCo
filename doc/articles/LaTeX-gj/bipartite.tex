...
people \textsc{neg}-be.innocent(1):\textsc{fact-pl} \textsc{neg}-be.innocent(2):\textsc{fact-pl} \textsc{nmlz}:S/A-not.exist \textsc{dem} a.lot \textsc{ifr-caus}-kill \textsc{ifr.ipfv}-have.to \textsc{unexpected} man \textsc{pl} \textsc{erg} really \textsc{emph} \textsc{ifr}-hate-\textsc{pl} \\
 \glt `As he had many innocent people killed, people hated him.' (hist140514 xiee de shewang, 82)
\end{exe} 
...
\ipa{mtsɯrɕpaʁ}   (vi)&	be hungry and thursty &	\ipa{mtsɯr} (vi)&	be hungry &	\ipa{ɕpaʁ} (vi)&	be thursty &	\\	
\bottomrule
\end{tabular}}
\end{table}
...
Within the Trans-Himalayan, bipartite verbs are not restricted to Gyalrongic and Kiranti, but data is still lacking for a full overview of the extent of this phenomenon in the family.
