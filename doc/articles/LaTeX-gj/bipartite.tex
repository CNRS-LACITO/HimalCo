...
%Scott DeLancey, Olivier Bonami, Nathan W. Hill, Randy LaPolla, Willem de Reuse, Alexey Vinyar

%\textbf{Abstract}: This paper presents an overview of bipartite verbs in Japhug and describes related constructions (compound verbs and serial verb construction) in that language. Then, by comparing Japhug data with complex predicates, it proposes several hypotheses
