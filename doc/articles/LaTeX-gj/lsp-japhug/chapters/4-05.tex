...
\subsubsection{The origin of the antipassive prefix} \label{sec:antipassive.history}
%rɤnŋa, tɯ-nŋa (§\ref{sec:bare.action.nominals})
\begin{exe}
\ex \label{ex:sqWmpCar.kANata}
\gll sqɯ-mpɕar kɤ-ŋa-t-a \\
\textsc{ten}-money.unit \textsc{pfv}-owe-\textsc{pst}:\textsc{tr}-\textsc{1sg} \\
