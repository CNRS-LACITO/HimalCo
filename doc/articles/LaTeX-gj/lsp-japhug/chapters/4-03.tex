...
Example (\ref{ex:mWjsWntsGe}) from a conversation illustrates this property of the MVC, with the abilitative prefix \forme{sɯ-} in the second clause.
...
In complement clauses, verbs with AM prefixes are attested, and complement taking verbs generally have scope over the action of the verb, rather than the motion event.
...
XXXX ʁmaʁ χsɯ-tɤkʰar kɯ ɲɯ-ɤz-nɤkhar-nɯ ɕti tɕe, ɕɯ-kɤ-mɯrkɯ mɤ-tɯ-cʰa  (2003qachga, 55)
  
  Note that in the case of XXXX, it would be clumsy to render the Japhug AM marker by a MVC in English -- `You won't be able to go to steal it' would mean that only the motion event is part of the condition, not the act of stealing.
  
  The same phenomenon constraint also applies to verbs with AM in complement clauses selected by a verb in the protasis, as in (\ref{ex:CWkAru}) and (\ref{ex:CWkAmWrkW}): the realization of the verbal action belongs to the condition, while the motion event is secondary.
