...
pig \textsc{foc}:\textsc{unexp} one-household each \textsc{erg} \textsc{emph} \textsc{ipfv}-raise-\textsc{pl} have.to:\textsc{fact} \\
...
\ex \label{ex:tAre.tAJaR}
 ...
 dem:loc \textsc{foc}:\textsc{unexp} completely \textsc{indef}.\textsc{poss}-laugh \textsc{indef}.\textsc{poss}-laugh \textsc{indef}.\textsc{poss}-chatting.and.laughing \textsc{ifr}.\textsc{ipfv}-be.extremely \\
