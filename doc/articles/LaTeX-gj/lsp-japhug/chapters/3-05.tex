...
Japhug lacks a dedicated noun coordinator. Nouns can be either coordinated by using the position \forme{cʰo} (§ \ref{sec:coordinator}), or by  juxtaposition without any linking element (§ \ref{sec:bare.coordination}). 

\subsection{Coordination or embedded phrase} \label{sec:coordinator}
