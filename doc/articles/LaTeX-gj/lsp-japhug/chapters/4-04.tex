...
The most common use of subject participles is to build participial clause whose head noun is the subject; it is the only way to relativize the subject in Japhug (§ XXX). It is most commonly used with headless relatives, but also occurs with prenominal, post-nominal and head-internal relatives (as in \ref{ex:qala.kW.WkWmWrRWz} where the head of the relative \japhug{qala}{rabbit} takes the ergative postposition \forme{kɯ} selected by the transitive verb \japhug{mɯrʁɯz}{scratch}).
