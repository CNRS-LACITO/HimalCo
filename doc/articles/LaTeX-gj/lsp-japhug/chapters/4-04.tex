...
\ex \label{mWpjWkAlhoR.ftCaka}
 ...
 indef.\textsc{poss}-blood \textsc{neg}-\textsc{ipfv}-\textsc{inf}-come.out manner \textsc{ipfv}-make[III]-\textsc{1sg} \textsc{ipfv}-avoid-\textsc{1sg} \textsc{pst}.\textsc{ipfv}-be \textsc{lnk} \\
...
In the topical position, the infinitive of stative verbs can be neutralized to the \forme{kɤ-} form, as in (\ref{ex:kArZi}).
...
Velar infinitives occur with a great variety of auxiliaries, lexical verbs, and also a few nouns. Some complement-taking verbs
