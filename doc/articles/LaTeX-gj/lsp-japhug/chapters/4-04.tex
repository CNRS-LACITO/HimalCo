...
The most common use of subject participles is to build participial clause whose head noun is the subject; it is the only what to relativize the subject in Japhug (§ XXX).
