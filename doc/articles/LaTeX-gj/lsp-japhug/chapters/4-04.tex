...
The object participle of the perception verbs \japhug{mto}{see} and \japhug{mtsʰɤm}{hear} can be used to build a locative relative clause meaning `a place where $X$ can see/hear $Y$ when occurring as the goal of a motion verb as in (\ref{ex:tCirna.mAkAmtshAm}) or (\ref{ex:WmAkAmto}). Not the optionality of the ergative on the nouns \japhug{tɕi-rna}{our ears} and \japhug{tɕi-mɲaʁ}{our eyes} in (\ref{ex:tCirna.mAkAmtshAm}).
...
\glt `She went to (a place) where the frog would not see her.' (150818 muzhi guniang-zh, 149)
\end{exe}
