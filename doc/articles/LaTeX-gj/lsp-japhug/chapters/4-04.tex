...
With the causative verb \japhug{sɯpa}{cause to do}, two bare infinitives as in (\ref{ex:Wti.cho.WnAma}) or a combination of a bare infinitive with a dental infinitive as in (\ref{ex:Wti.cho.tWCe}), connected by the comitative \forme{cʰo} can be used to express simultaneity between two actions.
...
\begin{exe} 
\ex \label{ex:Wti.cho.tWCe}
\gll  nɯɕɯmɯma ɯ-ti cʰondɤre tɯ-ɕe ci to-sɯ-pa tɕe \\
immediately \textsc{3sg}.\textsc{poss}-\textsc{bare}.\textsc{inf}:say \textsc{comit} \textsc{inf:II}-go  one \textsc{emph} \textsc{ifr}-\textsc{caus}-do \textsc{lnk} \\
