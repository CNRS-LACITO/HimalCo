...
There are however no constraints on the number of prefixes following the participle prefix  \forme{kɯ-}.

Two of the four series of orientation prefixes are possible with the subject participle (§ XXX), series A  (perfective \forme{tɤ-} `up', \forme{pɯ-} `down' etc) and B (imperfective\forme{tu-} `up', \forme{pjɯ-} `down' etc, § XXX). XXXXX

As in the case of finite verb forms, participles of stative verbs with series A and B orientation prefixes have an inchoative meaning.  In (\ref{ex:YWkWjpum}), the imperfective participle \forme{ɲɯ-kɯ-jpum} from \japhug{jpum}{be thick} means `the one which becomes thicker', as opposed to the basic participle \forme{kɯ-jpum} `the thick one'.
...
The past imperfective of stative verbs XXXXXXXXX
