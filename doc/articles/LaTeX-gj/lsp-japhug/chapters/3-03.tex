...
The postposition \japhug{ɕɯŋgɯ}{before} (§ XXX) occurs after time CNs in examples such as (\ref{ex:sqamNusNi.CWNgW}); the relator noun \japhug{ɯ-qʰu}{after} (§ XXX) is not used in this way except in texts translated from Chinese, where it is likely calqued as in (\ref{ex:kWBdexpa.Wqhu}).

\begin{exe}
\ex \label{ex:sqamNusNi.CWNgW}
\gll tɤte sqamŋu-sŋi ɕɯŋgɯ nɯtɕu tɕe, nɯ-rlaʁ tɕe nɯ-me pɯ-ŋu ɲɯ-ŋu, tɕʰeme nɯ, \\
that.is fifteen-day before dem:loc lnk pfv-disappear lnk pfv-not.exist pst.ipfv-be sens-be girl dem \\
\glt `Fifteen days before, she had disappeared, that girl.' (2003tWxtsa, 31)
\end{exe} 
