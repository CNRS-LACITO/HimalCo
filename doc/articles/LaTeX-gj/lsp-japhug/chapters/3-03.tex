...
This morphological derivation is not productive, and cannot be used with any other time CN, even \japhug{tɯ-sla}{one month} -- the distributive modifiers \japhug{raŋri}{each, every} or \japhug{rɯri}{each, every}are used instead (§ XXX).
