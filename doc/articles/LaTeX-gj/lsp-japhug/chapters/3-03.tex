...
The $D^{0}$ to $D^{-1}$ ordinals have a prefix of probably demonstrative origin \forme{ji-/jɯ-}, which also occurs under other forms in some frozen adverbs, such as \japhug{jɤxtsʰi}{this time}, and is found in other time ordinals elsewhere in Gyalrongic. 

 The expressions \japhug{jɯfɕɯndʐi}{the other day}  and \japhug{japandʐi}{a few years ago} can be analyzed as time ordinals ($D^{-2}$ and $Y^{-2}$ respectively), as in (\ref{ex:japandzxi}).
...
However, in many cases, they have less specific meanings `a few days ago' or `a few years ago' ,  as shown by (\ref{ex:jWfCWndzxi}), referring to an event that occurred more than one week before, and XXXXXX 
...
\ex \label{ex:tWtshot.tWrdoR}
 ...
 \textsc{lnk} \textsc{dem} one \textsc{pfv}:3\fl3'-caus-hurt \textsc{dem} hour one-piece about until \textsc{neg}-calm \\
