...
%tɯ-fkur, tɯ-mpʰɯr tɯ-rmbɯ tɯ-tshoz


An example of  verb to CN derivation shared by all four Gyalrong languages is the CN \japhug{tɯ-xpa}{one year}, which originates from the verb \japhug{pa}{pass X years}  illustrated in (\ref{ex:12.topa}) (see also example \ref{ex:40.topa}  in 
