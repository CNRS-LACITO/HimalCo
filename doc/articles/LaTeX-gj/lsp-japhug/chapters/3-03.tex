...
These numerals can take lower numerals between one and ten as modifiers to express several (tens, hundreds of) thousands. These modifiers strictly follow the higher numeral 
as in (\ref{ex:stoNtsu.kWtsxAG}), where \japhug{kɯtʂɤɣ}{six} follows  \japhug{stoŋtsu}{thousand} to express `six thousands'. 
...
In addition to the numerals mentioned above, some nouns can appear as prefixes of counted nouns.

The numerals above 99 (§ \ref{sec.hundred.plus}) occur as numeral prefixes without vowel alternation: χsɯ-ri-xpa 

ɣurʑa-xpa
stoŋtsu-xpa

the participle of the stative verb \japhug{antɕʰɯ}{be many}. XXXXX  \ref{sec:thAstWG} \forme{tʰɤstɯ-} \japhug{tʰɤstɯɣ}{how many} 
...
The partitive form of CNs is built by reduplicating the numeral `one' prefix \forme{tɯ-}, as in example (\ref{ex:tWtWxpa}) with \japhug{tɯ-tɯ-xpa}{some years} from \japhug{tɯ-xpa}{one year}.
...
one-one-year  \textsc{lnk} \textsc{irr}-\textsc{ipfv}-be.good \textsc{lnk} ten.thousand \textsc{3sg}.\textsc{poss}-excess about \textsc{ipfv}-earn \textsc{sens}-can \\ 
 \glt `Some years if it is good, he can earn more than ten thousands.' (14-tApitaRi, 180)
 \end{exe}
 
 %ʑɯrɯʑɤri qhe, tɕe tɯ-tɯ-rdoʁ nɯ ɲɯ-ʑɣɤqɤr-nɯ qhe 
% tɕeri tɯ-tɯ-rdoʁ tɯ-tɯ-rdoʁ ɲɯ-ŋu ma
%kɯ-ɤndʑɯrɣa kɯ-fse kɯ-ɤrɤkhɯmkhɤl kɯ-fse maŋe. 
