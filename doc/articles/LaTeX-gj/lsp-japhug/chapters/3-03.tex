...
\ex \label{ex:XsWmba}
 ...
 \glt `It bears young once in March.' (21-lWLU
\end{exe}
\begin{table}[H]
...
& Japhug & Tibetan  \\
\midrule
1	&	\forme{toŋbu} & \tibet{དང་པོ་}{daŋ.po}{first} \\
...
The ordinals can be used with the Tibetan word \japhug{zlawa}{month} (from \tibet{ཟླ་བ་}{zla.ba}{moon, month}) as in (\ref{ex:XsWmba}), or without it as in XXXXXX

%χsɯm-rɟa-tʂɯɣ-ftɕɯ kɯ pɣɤmbri ɲcɣɤ-nɤ-ɲcɣɤt ʑo to-lɤt-nɯ, 2003smanmi
...
Addition is expressed by the construction in (\ref{ex:tWrdoR.pjWwGta}) adn (\ref{ex:kWrCat.pjWwGta}), with the verb \japhug{ta}{put} (or alternatively, \japhug{ɣɤjɯ}{add}, in the case below \forme{pjɯ́-wɣ-ɣɤjɯ}) and the locative noun \japhug{ɯ-taʁ}{on top of}, literally  `If one puts Y on the top of X, it makes Z' corresponding to $X+Y=Z$.  
...
For multiplications, the CN \japhug{tɯ-zloʁ}{one time} 
\begin{exe}
