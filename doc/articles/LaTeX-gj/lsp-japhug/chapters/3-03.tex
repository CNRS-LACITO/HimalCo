...
\subsubsection{Other numeral prefixes}
...
Another unrelated irregularity concerns the CN \japhug{tɯ-ɣjɤn}{one time}, which presents two numeral `three' forms; while the regular form \japhug{χsɯ-ɣjɤn}{three times} is common, some speaker also use the monosyllabic reduced form \japhug{χsjɤn}{three times}.
