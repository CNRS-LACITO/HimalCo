...
\glt `As for cows, they (have) their young only one by one, and can only bear young once a year.' (05-qaZo, 135)
\end{exe}
...
\glt `It is always I alone who goes to fetch water.' (150830 san ge heshang-zh, 44)
\end{exe}
...
\glt `We had three twigs.'  (2003kunbzang, 204)
\end{exe}
...
\glt  `There were four bottles of alcohol.' (140510 sanpian sheye-zh, 51)
\end{exe}
 %tɯ-tɯkro tɯ-tɯrpa
