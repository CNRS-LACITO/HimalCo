...
Deideophonic CNs are quite common, and belong to all major CN categories.

The collective CNs \japhug{tɯ-boʁ}{one group} and \japhug{tɯ-ɟɯɣ}{one pack} respectively originate from the ideophonic roots found in \japhug{boʁboʁ}{in group, in order} and \japhug{ɟɯɣɟɯɣ}{in great number (of long objects)}.  XXXXX
