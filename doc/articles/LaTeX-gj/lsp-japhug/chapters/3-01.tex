...
The religious name given to Buddhist or Bonpo monks is called in Japhug \forme{χpɯn ɯ-rmi}. Note that in (\ref{ex:XpWn.Wrmi}), the third person prefix \forme{ɯ-} is not replaced by a first person possessive prefix even to mean `my religious name'.
