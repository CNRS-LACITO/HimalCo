...
\begin{exe}
\ex \label{ex:iZo.amu}
\gll iʑo a-mu nɯ thamtham kɯrcɤsqaptɯɣ thɯ-azɣɯt ŋu. \\
...
\subsection{Property nouns} \label{sec:property.nouns}
%a-pɯ-ŋu tɕe, penzi ɯ-pɯ, sɤlaŋphɤn ɯ-pɯ jamar ɲɯ-wxti cha 
...
Suffixation with \forme{-pɯ} is the fused variant of the property noun construction with \japhug{ɯ-pɯ}{small X} described in section \ref{sec:property.nouns}.
