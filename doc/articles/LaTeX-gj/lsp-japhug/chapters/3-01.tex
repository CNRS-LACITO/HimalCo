...
A small class of IPN in Japhug can be used as exclamative verbless nominal predicates (§ \ref{sec:nominal.predicates}), sometimes with the sentence final particle \forme{nɯ} (§ XXX). This exclamative use of IPNs is found with degree nominals (see § XXX), and also with a few non-derived nouns, \japhug{tɯ-scawa}{poor of X} and \japhug{tɯ-kʰi}{how lucky of X}.
...
The IPN \japhug{tɯ-kʰi}{how lucky of X} is also used in the exclamative construction, as in (\ref{ex:nWkhi.Ge}), with the possessive prefix coreferent with the person experiencing good luck. XXXXXX
