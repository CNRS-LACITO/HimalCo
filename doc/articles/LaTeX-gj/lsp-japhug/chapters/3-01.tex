...
When the head noun is not a participant of the clause, the modifying clause is a complement clause (§ XXX, see \citealt[267]{post08nmlz.galo}, \citealt[239-241]{jacques16complementation}). Adnominal complement clauses in Japhug generally occur with IPNs related to language such as \japhug{ɯ-tɕʰa}{information, news} and \japhug{ɯ-skɤt}{its language, its noise}, in particular with reported speech complements (§ XXX). 
