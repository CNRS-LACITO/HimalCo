...
\textit{Tatpurusha} or determinative compounds are the most common type of compounds in Japhug. Modifier-Head order is most common when the first noun refers to places, species, or people  following the same order as in the noun phrase (\ref{sec:modifier.nouns}). 
