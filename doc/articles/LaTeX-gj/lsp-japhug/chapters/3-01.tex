...
Compounds with oblique participles as first, rather than second, element, are also attested, for instance the obsolete noun \japhug{sɤqrɤcʰa}{alcohol to treat the guests}, from the oblique participle \forme{ɯ-sɤ-qru} of the verb \japhug{qru}{greet, welcome, receive} and the noun \japhug{cʰa}{alcohol}.
