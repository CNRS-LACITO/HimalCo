...
In participial relatives with subject participle (in \forme{kɯ-}, see section XXX), \japhug{ŋotɕu}{where} can occur to express relativization of locative adjuncts, as in  (\ref{ex:NotCu.kWtu}); see XXX for a discussion of the other available constructions.
