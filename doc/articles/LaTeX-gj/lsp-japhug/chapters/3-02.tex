...
\section{Universal quantifiers} \label{sec:quantifiers.pronouns} \label{sec:aRandWndAt}
Several quantifiers meanings `all' exist in Japhug (§ \ref{sec:universal.quant} and XXX). Among them, \japhug{kɤsɯfse}{all} can be used in the meaning `everybody', as in example (\ref{ex:kAsWfse.kW}).
