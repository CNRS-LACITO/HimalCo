...
The phrase \forme{tɤ-rʑaʁ tʰɤstɯɣ} (or alternatively \forme{tɯtsʰot tʰɤstɯɣ}) in collocation with the verb \japhug{zɣɯt}{reach}, is also employed for asking about clock time, as in (\ref{ex:thAstWG.kozGWt}) (see § \ref{sec:hours}) or dates. The nouns \japhug{tɤ-rʑaʁ}{time} and \japhug{tɯtsʰot}{time, hour, clock} are not even obligatory, as shown by (\ref{ex:thAstWG.jamar.tWGi})
...
\ex \label{ex:thAstWG.kozGWt}
 ...
 \begin{exe}
\ex \label{ex:thAstWG.jamar.tWGi}
 \gll   nɤʑo 	tʰɤstɯɣ jamar tɯ-ɣi \\
 \textsc{2sg} how.many about 2-come:\textsc{fact} \\
  \glt `On about what date will you come?' (conversation, 2012)
  \end{exe}   
