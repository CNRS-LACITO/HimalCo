...
Locative adverbs, such as those based on the approximate locative \forme{-cʰu} (§ \ref{sec:approximate.locative}) can be combined with the locative pronouns in 

\begin{exe}
\ex \label{ex:ndWchu.kWre.ri}
 \gll
tɕe kukutɕu, <zhuanmen>, nɤkinɯ, tɯ-ɕɣa ɯ-kɯ-nɯsmɤn, tɕɤtʰi, ndɯcʰu kɯre ri rɤʑi ma,
