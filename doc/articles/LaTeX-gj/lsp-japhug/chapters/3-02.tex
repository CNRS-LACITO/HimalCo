...
The pronoun \forme{tʰɤstɯɣ} has a conjunct form \forme{tʰɤstɯ-} when used with counted nouns (in \ref{ex:thAstWmaR}, with the classifier \ipa{-maʁ} `size of shoes' from Chinese \zh{码} \forme{mǎ}, see § \ref{sec:other.numeral.prefixes}).
