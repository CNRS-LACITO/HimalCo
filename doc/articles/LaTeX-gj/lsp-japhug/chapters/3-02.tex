...
The locative pronouns in \forme{-re} can express static location as in (\ref{ex:kWre}) and (\ref{ex:ndWchu.kWre.ri}) above, or motion from or towards a place as in (\ref{ex:kWre.nWnWGea}).

\begin{exe}
\ex \label{ex:kWre.nWnWGea}
 \gll aʑo akɯ kɤntɕhaʁ ri kɤ-ari-a tɕe, nɯ kóʁmɯz kɯre nɯ-nɯ-ɣe-a \\
...
Apart from its locative uses, \forme{nɯtɕu}{there} has a temporal meaning `at that time' as in (\ref{ex:nWtCu.temporal}).

\begin{exe}
\ex \label{ex:nWtCu.temporal}
\gll <qidian> tɕe tɤ-mŋɤm ta-ʑa a-pɯ-ŋu tɕe, tɕe nɯnɯ tɯ-sŋi nɯ tu-mŋɤm, tɯ-rʑaʁ nɯ tu-mŋɤm tɕe,
ɯ-fso <qidian> mɤɕtʂa nɯ mɯ́j-ʑi tɕe nɯtɕu tɕe kɯ-xtɕɯ\redp{}xtɕi tɯ-ʑi ɲɯ-ʑe ɲɯ-ŋu tɕe \\
...
\glt `(For instance), if (the headache) starts at seven o'clock, it hurts for one day and one night, and subsides only in the next day at seven, at that time it starts to subside a little.' (24-pGArtsAG, 93-96)
\end{exe}

In addition, it can conveys in some contexts an abstract meaning `in those circumstances', as in (\ref{ex:nWtCu.kWnA}).
...
%nɯnɯtɕu mɤɕtʂa mtshalu pjɤ-me qhe, c'est seulement là que
%140520_ye_tiane 319
