...
The genitive also occurs between relatives and their head noun. This can be observed with postnominal participial relatives as in (\ref{ex:stu.WkAnWmga}) and (\ref{ex:slama.ra.GW}).
...
\subsubsection{Attributive postnominal modifiers}
