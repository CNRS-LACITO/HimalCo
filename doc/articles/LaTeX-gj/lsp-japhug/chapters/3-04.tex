...
\item RNR: \forme{kɯki} N \forme{kɯki}, \forme{nɯnɯ} N \forme{nɯnɯ} (\ref{ex:kWki.qingjiao.ki})
\end{itemize}  
...
The medial demonstrative \forme{nɤki}, used to designate referents closer to the addressee than the speaker, also occurs as a prenominal determiner, with or without postnominal demonstrative, as in (\ref{ex:nAki.nAtAYi}).

\begin{exe}
\ex \label{ex:nAki.nAtAYi}
 \gll nɤki nɤ-tɤɲi ɯ-taʁ kɤ-rɤt nɯ ɯβrɤ-kɯ-z-nɤmɲo-a-nɯ \\
 \textsc{dem}:C \textsc{2sg}.\textsc{poss}-staff \textsc{3sg}.\textsc{poss}-on \textsc{nmlz}:P-write \textsc{dem} \textsc{pot}-2\fl{}1-\textsc{caus}-watch-\textsc{1sg}-\textsc{pl} \\
...
\ex \label{ex:aZo.ki.aku.ki}
 ...
 \glt `Please behead me!' (140507 jinniao, 292)
\end{exe}
