...
The only argument of morphologically intransitive and syntactically monoactantial verbs, the intransitive subject (S), is in absolutive form and is indexed on the verb, as \forme{tɕʰemɤ nɯra} `the women' with plural indexation in (\ref{ex:tCheme.nWra.thWstanW}).
