...
\subsection{Independent words vs clitics}  \label{ex:postpositions}
...
The locative \forme{tɕu}  is most often used in combination with a demonstrative \forme{nɯ} as in (\ref{ex:co.nWtCu}), a forme identical to the locative of the demonstrative pronoun (\japhug{kutɕu}{here} and \japhug{nɯtɕu}{there}, see § XXX). Without demonstrative, \forme{tɕu} is also found as in (\ref{ex:tsxu.tCu}) and (\ref{ex:khAxtAndo.tCu}).
...
The same diversity of uses is found with the locative \forme{zɯ}; example (\ref{ex:nAmkha.zW.pjAnWlhoRnW}) shows \forme{zɯ} expressing static location (`in their hands') and motion from a place (`from the sky').
...
The same interchangeability and optionality of the locative postpositions is observed when these are combined with relator nouns (§ \ref{sec:relator.postposition.location}).
