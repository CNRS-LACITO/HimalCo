...
The linker \forme{tɕe} occurs in examples like (\ref{ex:kutɕu.zgo.tCe}), expressing either motion from or towards a place, or location.

\begin{exe}
\ex \label{ex:kutɕu.zgo.tCe}
\gll kutɕu zgo tɕe tɕɤkɯ zgo ku-nɯtsɯm ɲɯ-ŋgrɤl ma \\
\textsc{dem}.\textsc{prox}:\textsc{loc} mountain \textsc{lnk} east mountain \textsc{ipfv}:\textsc{east}-\textsc{auto}-take.away \textsc{sens}-be.usually.the.case \textsc{lnk} \\
...
It is also found in the expression \forme{ɯ-sɯm tɕe} `in his opinion, in his mind' as in (\ref{ex:asWm.tCe}) and (\ref{ex:WsWm.tCe}), where the \forme{tɕe} is neither a linker nor a topic marker (it cannot be replaced here by \forme{nɯ} § \ref{sec:nW.topic}, for instance). 
