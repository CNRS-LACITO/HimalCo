...
Causees also present commonalities with objects: when the causee is first or second person, it is obligatorily indexed (§ XXX), and the causee is also relativized with the object participle (§ XXX).
