...
\ex \label{ex:rJAlpu.kW.nWnW.kW}
 ...
 king \textsc{erg} \textsc{dem} \textsc{erg} \textsc{3sg}.\textsc{poss}-body \textsc{irr}-\textsc{pfv}-\textsc{caus}-wash \textsc{lnk} even \textsc{trop}-\textsc{deexp}-be.happy:\textsc{fact} \textsc{hypoth} \textsc{sfp} \\
...
\ex \label{ex:nW.kW.ndZixtu}
 ...
 \glt `The son went every day to fell trees, them sold (the wood), and they fed their bellies this way.' (2003tWxtsa, 2-3)
\end{exe}
