...
The IPN \japhug{ɯ-tʰɯrʑi}{mercy} (borrowed from \tibet{XXXX}{tʰugs.rdʑe}{compassion}), occurs in a semi-grammaticalized construction meaning `thanks to', in combination with the ergative \forme{kɯ} as an intrumental adjunct (\ref{ex:nAthWrZi.kW}), or in absolutive form as a nominal predicate (\ref{ex:smAn.WthWrZi}).
