...
A few of these relator nouns are borrowed from Tibetan, as indicated in Table \ref{tab:relator.location}), but most of them are native Gyalrong words. In particular \japhug{ɯ-ʁɤri}{before, in front of} is one of the very rare cases of a disyllabic words that has a cognate in Tangut sharing both syllables (\tangut{𘁞𗙷}{5416-567}{ɣwə-rjir}{2.25-2.74} `before').\footnote{The syllable \forme{ʁɤ-} = \tangut{𘁞}{5416}{ɣwə}{2.25} may be a fossilized allomorph of \japhug{tɯ-ku}{head} with a uvular as in the Stau cognate \stau{ʁə}{head}.} The relator noun \japhug{ɯ-ku}{top of} is transparently grammaticalized from the body part \japhug{tɯ-ku}{head}.
...
In the case of clothes, \forme{ɯ-ndo} refers to the lower opening (towards the feet), and \forme{ɯ-mŋu}  to the side of the collar.
%cɯŋglɯɣ nɯ rɟɤskɤt ɯ-mŋu zɯ ɲɤ-ta ɲɯ-ŋu
