...
There is in addition a suffix \forme{-cʰɯ} used to indicate direction, attested only with a handful of nouns, \japhug{mɤpɕoʁ-cʰɯ}{towards the opposite side} and \japhug{tɯ-mɯ-cʰɯ}{towards the sky}, the latter mainly used with the verb \japhug{ru}{look at} to mean `lying on one's back face up (towards the sky)' as in (\ref{ex:tWmWchW}).
