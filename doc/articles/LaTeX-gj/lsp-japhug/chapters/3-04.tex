...
Ergative marking on the subject of reflexive verbs (which are morphologically intransitive, §XXX) is also attested for marking emphasis, with the same pronoun preceding and following the ergative (for instance \forme{tɯʑo kɯ tɯʑo} in example \ref{ex:tWZo.kW.tWZo}, §\ref{sec:genr.pro}).
