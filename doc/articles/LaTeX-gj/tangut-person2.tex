...
Published ahead of print in \textit{Linguistic Vanguard}:

\url{http://www.degruyter.com/view/j/lingvan.ahead-of-print/lingvan-2015-0033/lingvan-2015-0033.xml}
...
It is however with the honorific pronoun \mo{4028} \ipa{nji²} and the SAP plural suffix \mo{4884} \ipa{nji²} that the difference is most telling. \mo{4028} \ipa{nji²} is singular; when serving as core argument, the verb takes the \textsc{2sg} \mo{4601} \ipa{-nja²} suffix, as in \ref{ex:tg:toi}. No example of  \mo{4028} \ipa{nji²} used with \mo{4884} \ipa{nji²} has been found in the corpus under study.
 
\begin{exe}
\ex \label{ex:tg:toi}  
\glll   \tgf{4028} 	\tgf{0582} 	\tgf{3211} 	\tgf{2699} 	\tgf{4601} \\
\ipa{nji²}	\ipa{thjij²sjo²}	\ipa{nwə¹-nja²} \\
\textsc{2sg:hon} how know-\textsc{2sg} \\
\glt `How do you know?' (The Grove of Categories, 04.04A.6)
\end{exe}%汝何以知之
...
The hypothesis that the suffix \mo{4884} \ipa{nji²} is historically derived from the ancestor of the pronoun \mo{4028} \ipa{nji²} further suggests that the singular honorific \textsc{2sg} originates from a \textsc{2pl} (a reasonable assumption), and that in verbal indexation the first vs second person plural distinction became neutralized at the expense of the first person, a rare phenomenon, but not altogether unthinkable.\footnote{For a discussion concerning the directionality of analogy in person indexation paradigms, see \citet{jacques16ebde}.} The exact mechanism for this neutralization is an interesting question; in an initial stage, the neutralization may have occurred for the first plural inclusive, before affecting the first plural exclusive.
...
Example \ref{ex:hongnong} is a typical example of absence of person indexation on some verbs in Tangut. Although the S/A of all verbs in this paragraph is \textsc{2sg}, the verbs \mo{5113} \ipa{.wji¹},  \mo{749} \ipa{phji¹} and \mo{4039} (pronunciation unknown) have neither the suffix \mo{4601} \ipa{nja²} nor stem B as would be expected (these are indicated in red below). Only the last verbal form  \mo{4342}\mo{2511}\mo{4601}\mo{3916} \ipa{dja²}-\ipa{rjɨr²}-\ipa{nja²}-\ipa{sji²} has person indexation (in blue).
...
Returning to example \ref{ex:hongnong}, we see that of the four verb forms without person marking, one takes a directional prefix, one is followed by the instrumental suffix \mo{5880} \ipa{ŋwu²} (actually, a probable cognate of the ergative \ipa{-w} in Stau), and one is followed by the relator noun \mo{4861} \ipa{zjọ²} `time; when'. 
