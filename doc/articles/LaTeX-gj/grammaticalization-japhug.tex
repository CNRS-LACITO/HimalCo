...
\begin{document} 
 ...
 %Alexis Michaud, Amos Teo, Mark W. Post, Alec Coupe
...
\textsc{lnk} \textsc{dem} wood \textsc{foc:unexpected} \textsc{nmlz}:S/A-\textsc{emph}\textasciitilde{}-be.a.lot \textsc{emph} \textsc{ifr-caus}-chop-\textsc{pl}\\
