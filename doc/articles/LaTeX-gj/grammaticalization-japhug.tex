...
The mark \ipa{kɯ} on the comparee is etymologically related to the ergative. (\citealt{jacques15comparative}). 
...
\subsubsection{Voice and denominal derivations}
...
\begin{table}[H] \caption{Voice markers and corresponding denominal derivations} \label{tab:denom}
...
This homophony was first explained in the case of the Antipassive prefix \ipa{rɤ--} (\citealt{jacques14antipassive}).
...
and \citet{jacques15causative})

\textsc{action nominalization} of intransitive verb + \textsc{transitive denominal derivation} $\Rightarrow$ \textsc{applicative} / \textsc{causative}
...
\citet[249]{heine-kuteva02}
\citet{jacques14linking}
\textsc{interrogative} $\rightarrow$ \textsc{conditional}
