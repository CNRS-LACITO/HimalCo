...
There are thus three clear cases of grammaticalization: 

\begin{exe}
\ex 
\glt \textsc{east} $\rightarrow $ sensory imperfective
\ex 
\glt \textsc{west} $\rightarrow $ present egophoric imperfective
\ex \label{ex:ipfv}
\glt \textsc{down} $\rightarrow $ past imperfective 
\end{exe}
Pathway (\ref{ex:ipfv}) has been discussed in detail in \citet{lin11direction}.XXX
