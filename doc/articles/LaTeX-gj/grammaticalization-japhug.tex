...
The causative \ipa{sɯ(ɣ)--} can thus be explained as the result of renalysis from the denominal derivation `cause to X' from a possessed action nominal deriving from the base verb. 
...
There are examples of a denominal prefix \ipa{sɤ--} expressing a property related to the base noun, in examples such as \ipa{--ndɤɣ} `poison' $\rightarrow$ \ipa{sɤ-ndɤɣ} `be poisonous' or \ipa{--mbrɯ} `anger'  $\rightarrow$ `be angry'. 

Thus, the deexperiencer \ipa{sɤ--}
