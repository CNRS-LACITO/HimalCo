...
\textsc{2sg} first Jiangling.Ling \rouge{make[A]} time wind-\textsc{instr} fire extinguish-\rouge{cause[A]} after Hongnong city-lord \textsc{pfv}-\rouge{make[A]} tiger \rouge{ride} \textsc{instr} \bleu{\textsc{pfv}-go-\textsc{2sg-ifr}} \textsc{top} what be.like \\
