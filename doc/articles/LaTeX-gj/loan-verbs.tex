...
Although there is no person or number indexation in any Tibetic language, the second person plural pronoun \ipa{kʰʲed} becomes used as a second person singular honorific after the Old Tibetan period (see \citealt{hill10pronouns}:563-4). It cannot therefore be excluded that the honorific use of the plural in Japhug arose under the influence of Tibetic languages, first with the pronouns and then on verbal indexation.
