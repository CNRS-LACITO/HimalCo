...
\midrule
 \textsc{abs+loc} &  \ipa{bʲol} & &trans, \textsc{erg.A-agr+abs.P-agr}& \ipa{pjɤl} & go around \\
vol, \textsc{erg+abs} & \ipa{dga} & like & semi-trans, \textsc{abs.S-agr+abs}, \textsc{abs.S-agr+inf}& \ipa{rga} & id. \\
...
vol, \textsc{erg+dat} & \ipa{btɕad} & cut & trans, \textsc{erg.A-agr+abs.P-agr}, \textsc{erg.A-agr+inf} & \ipa{ftɕɤt} & abandon (bad habit) \\
\bottomrule
