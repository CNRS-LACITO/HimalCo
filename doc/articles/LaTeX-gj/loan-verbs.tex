...
adjective & \ipa{brtan.po} &stable& stative & \ipa{frtɤn} &be reliable& \\
 ...
 \textsc{abs} &  \ipa{bzi} & become drunk &intransitive & \ipa{βzi} & id. \\
 \textsc{abs+dat} &  \ipa{rgʲug} &run &intransitive+goal  & \ipa{rɟɯɣ} & id. \\
\textsc{dat+abs} & \ipa{dga} & like & semi-transitive& \ipa{rga} & id. \\
\midrule
 \textsc{abs+dat/abl} &  \ipa{bʲol} & go around &transitive& \ipa{pjɤl} & go around \\
\textsc{erg+abs} & \ipa{ɴdon} & read & transitive & \ipa{ndɯn} & id. \\

\textsc{erg+dat} & \ipa{mpʰʲa} & blame & transitive& \ipa{mpɕa} & id. \\
\textsc{erg+abs} & \ipa{btɕad} & cut & transitive+complement & \ipa{ftɕɤt} & abandon (bad habit) \\
\bottomrule
\textsc{erg+dat+abs} & \ipa{bɕad} & tell & transitive+dative& \ipa{fɕɤt} & id. \\
\bottomrule
\end{tabular}}
\end{table}  
...
In Japhug, we only find three honorific verbs, all of which are of Tibetan origin (see Table \ref{tab:hon}). These verbs are rarely used in normal speech, and appear to be restricted to religious contexts.
...
Some voice derivations, such as the causative, the antipassive, the passive, the tropative, facilitative, reciprocal and deexperiencer are very productive, and can be applied to most of the verbs that are not morphosyntactically or semantically incompatible with such a derivation. 
...
%\begin{enumerate}
%\item stative adjectival verbs
%\item copulas, existential verbs and some modal and auxiliary
%%\item stative with postpositional phrase in \ipa{cho} (\ipa{naχtɕɯɣ})
%\item dynamic intransitive
%%\item dynamic intransitive with postpositional phrase in \ipa{cho}(\ipa{atɯɣ})
%\item motion verbs
%\item semi-transitive
%\item transitive
%\item monotransitive
%%\item monotransitive with second ergative 
%\item monotransitive with infinitival complement (three subtypes)
%\item monotransitive with finite complement 
%\item secundative ditransitive
%\item indirective ditransitive
%\end{enumerate}
