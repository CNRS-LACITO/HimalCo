...
\citet{andrews07relatives}

A relative clause (\textsc{rc}) is a subordinate clause which delimits the reference of an \textsc{np} by specifying the role of the referent of that \textsc{np} in the situation described by the \textsc{rc}
