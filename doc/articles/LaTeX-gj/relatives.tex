...
%
%si kɯqar ɣɤʑu tɕe si nɯ́wɣphɯt tɕe tɕe
%tɕe lúwɣphɯt tɕe tɕe li nɯnɯ 
%ɯsɤphɯt nɯ ɯsŋi nɯ amɤpɯpe tɕe tɕe tu-kɯ-ɕɯ-ngo ɲɯ-ŋgrɤl
%砍树的那个日子如果是不吉利的话
...
Acknowledgements will be added after editorial decision. %Wu Tong
} }
...
\gll [\ipa{pɯ-kɤ-sat}]  	\ipa{nɯ}  	\ipa{kɤ-mto}  	\ipa{nɯ}  	\ipa{pɯ-rɲo-t-a.}  \\
\textsc{pfv-nmlz:P}-kill \textsc{top} \textsc{inf}-see \textsc{top} \textsc{pfv}-experience-\textsc{pst:tr-1sg} \\
\glt I have already seen the ones that have been killed. (of owls). (Owls, 20)
  \end{exe}
\begin{exe}
\ex \label{ex:pjWsAlAt}
\gll
[\ipa{mɯzi}  	\ipa{pjɯ-sɤ-lɤt}]  	\ipa{nɯ}  	\ipa{ɕɤmɯɣdɯ}  	\ipa{ɯ-rna}  	\ipa{tu-ti-nɯ}  	\ipa{ŋu} \\ 
gunpowder \textsc{ipfv-nmlz:oblique}-throw \textsc{top} gun \textsc{3sg.poss}-ear \textsc{ipfv}-say-\textsc{pl} \textsc{n.pst}:be \\
...
\gll
[\ipa{tɯ-ndʐi}  	\ipa{kɯ}  	\textbf{\ipa{tɯ-ŋga}}  	\ipa{thɯ-kɤ-βzu}]  	\ipa{ŋu}  \\
\textsc{indef.poss}-skin \textsc{erg} \textsc{indef.poss}-clothes \textsc{pfv-nmlz:P}-make \textsc{n.pst}:be \\
\glt It is a kind of clothes that is made of skin. (mboʁ, 43)
  \end{exe}
%ki tɯ-ŋga ki tɯ-ndʐi kɯ chɯ́-wɣ-sɯβzu ŋu
...
%	Line 5: aʑo grɯβgrɯβ ɯ-ftsa nɯ tɤ-kɯ-qawɤr ma nɯ ma χploʁploʁ kɯ-pa mɯ-pɯ-mto-t-a. (016)
\begin{exe}
...
\ex \label{ex:pWkWBRa}
\gll
\ipa{tɕe}  	[\ipa{stɤβtshɤt}  	\textbf{\ipa{ɕu}}  	\ipa{pɯ-kɯ-βʁa}]  	\ipa{ɣɯ}  	\ipa{nɯ},  	\ipa{ɯ-jaʁ}  	\ipa{kham-a}  	\ipa{ŋu}  \\
\textsc{coord}  competition who \textsc{pfv-nmlz:}S-prevail \textsc{gen} \textsc{dem} \textsc{3sg.poss}-hand \textsc{n.pst}:give[III]-\textsc{1sg} \textsc{n.pst}:be \\
...
\gll
[\textbf{\ipa{ɕu}}  	\ipa{ɣɯ}  	\ipa{ɕ-thɯ-kɤ-ta}]  	\ipa{nɯ}  	\ipa{ɣɯ}  	\ipa{nɯ,}  	\ipa{tɕe}  	\ipa{ɯ-ɕki}  	\ipa{ɕɯ-kɯ-mɤrʑaβ}  	\ipa{kɯ-ra}  	\ipa{pjɤ-ɕti}  	\ipa{tɕe,}  \\
who \textsc{gen} \textsc{cisloc-pfv-nmlz:P}-put \textsc{top} \textsc{gen} \textsc{top} \textsc{coord}
\textsc{3sg}-\textsc{dat} \textsc{cisloc-genr:S/P}-marry \textsc{genr:S/P-n.pst}:need \textsc{pst.ipfv}-be:\textsc{assert} \textsc{coord} \\
...
where \textsc{pfv-nmlz:S}-go[II] \textsc{3sg.poss}-place \textsc{top} \textsc{loc} \textsc{nmlz:S}-marry \textsc{genr:S/P}-go \textsc{n.pst}:need \textsc{ipfv}-say-\textsc{pl} \textsc{n.pst}:be.usually.the.case \\
...
\textsc{coord} \textsc{dem} what \textsc{pfv-nmlz:P}-give \textsc{emph} \textsc{ipfv}-eat[III] \textsc{const}-be:\textsc{emph} \\
\glt It eats whatever one has given it. (Cat, 71)
\end{exe}


\subsection{The topic marker \ipa{nɯ}}
Japhug has a topic/definite marker \ipa{nɯ} homophonous (and probably grammaticalized from) the distal demonstrative \ipa{nɯ}.

It is often used at the end of relative clauses, as in example \ref{ex:pWkABRum}.

     \begin{exe}
   \ex \label{ex:pWkABRum}
 \gll
[\ipa{tɤlɤtshaʁ}  	\ipa{pɯ-kɤ-βʁum}]  	\ipa{nɯ}  	\ipa{ɲɯ-fse}  \\
milk.sieve \textsc{pfv-nmlz:P}-turn.upside.down \textsc{top} \textsc{const}-be.like \\
...
russula very \textsc{emph} \textsc{n.pst}:be.like but \textsc{3sg.poss}-middle \textsc{ipfv-nmlz}:S-sink \textsc{top} \textsc{n.pst}:deep a.little \\
...
The topicalizer is however not obligatory, even with non-nominalized relative clauses, as in \ref{ex:tanwndota}.

     \begin{exe}
   \ex \label{ex:tanwndota}
 \gll [\ipa{ɯʑo}	\ipa{kɯ}  	\ipa{ta-nɯrdoʁ}]  	\ipa{tɤ-nɯ-ndo-t-a}  	\ipa{me}  \\
he \textsc{erg} \textsc{pfv:3$\rightarrow$3'}-pick.up  \textsc{pfv-auto}-take-\textsc{pst:tr-1sg} \textsc{n.pst}:not.exist \\
\glt I did not take (the fruits) that he picked up. (Sparrow and Mouse 55)
\end{exe}

It could superficially appear to be analyzable as a subordinator. However, in prenominal relatives such as \ref{ex:akAsWz}, \ipa{nɯ} is located \textit{after} the head noun. If it were a subordinator, one would expect it to occur between the head noun and the relative.

\begin{exe}
   \ex \label{ex:akAsWz}
 \gll
\ipa{tɕe}  	[\ipa{aʑo}  	\ipa{a-kɤ-sɯz}]  	\ipa{ɕku}  	\ipa{nɯ}  	\ipa{nɯ} \ipa{ra}  	\ipa{ŋu}  \\
\textsc{coord} I \textsc{1sg-nmlz:P}-know onion \textsc{top} \textsc{dem} \textsc{pl} \textsc{n.pst}:be \\
...
Some prenominal relatives have a semantically bleached generic head noun which acts as a quasi-subordinator: \ipa{ɯ-spa} for arguments, \ipa{ɯ-raŋ} for time adjuncts and \ipa{ɯ-stu} or \ipa{ɯ-sta} for place adjuncts. These generic nouns are not compatible with head-internal relatives. These nouns differ from regular head nouns in that they are obligatorily possessed by a third person possessive prefix \ipa{ɯ}--.
...
male.yak \textsc{pl} \textsc{pl}-on \textsc{nmlz:P}-put \textsc{3sg.poss}-material \textsc{nmlz:P}-say \textsc{const}-be \\
...
\textsc{coord} \textsc{3sg-nmlz:A}-spare  \textsc{3sg.poss}-material \textsc{n.pst}-be\\
...
man \textsc{pfv-nmlz:S}-sit \textsc{gen} \textsc{indef.poss}-head \textsc{3sg.poss}-as about \textsc{n.pst}:need \\
...
\textsc{dem} again medicine not.only \textsc{nmlz:S}-good \textsc{const}-be \\
 ...
 musc \textsc{coord} very \textsc{emph}  medicine \textsc{nmlz:S}-good \textsc{n.pst}:be  \\
 \glt    Musc is a very good medicine. (Musc, 59)
   \end{exe}  
...
\glt He caused a snowfall that was nine flight of stairs thick. (Gesar, 149)
   \end{exe} 
...
Other adjuncts can be extracted from the relative. Thus, the group \ipa{ki jamar} ``like this", while it normally appears within the relative (as in \ref{ex:kWzri}), can also be extraposited to its right (example \ref{ex:ki.jamar1}).

\begin{exe}
   \ex  \label{ex:kWzri}
   \gll
\ipa{ɯ-ndzɣi}   	\ipa{rcanɯ}   	[\ipa{ki}   	\ipa{jamar}   	\ipa{kɯ-rɲɟi}]   	\ipa{ɲɯ-ɕti}    \\
\textsc{3sg.poss}-tusk \textsc{top}   \textsc{dem.prox} about \textsc{nmlz:S}-long \textsc{const}-be:\textsc{assert} \\
...
In the case of semi-transitive verbs (see section \ref{sec:trans}), both the S and the unmarked adjunct can be relativized with \ipa{kɯ}-- (the latter is discussed in section \ref{sec:other}). We find relative clauses with overt S (example \ref{ex:kWrga}) or overt adjunct (as \ref{ex:paR} )  in pre-verbal position, but no example with both overt nouns.

 \begin{exe}
   \ex   \label{ex:kWrga}
 \gll  [\textbf{\ipa{tɯrme}}  	\ipa{kɯ-rga,}]  	\ipa{wuma}  	\ipa{ʑo}  	\ipa{kɤ-ndza}  	\ipa{kɯ-rga}  	\ipa{ɣɤʑu.} \\
person \textsc{nmlz:S}-like very \textsc{emph} \textsc{inf}-eat  \textsc{nmlz:S}-like exist \\
 \glt  There are person who like it, who like to eat it. (βlamajmɤɣ, 60)
   \end{exe} 

 \begin{exe}
   \ex   \label{ex:paR}  
\gll  [\ipa{paʁ}  	\ipa{mɤ-kɯ-ɤro}]  	\ipa{maka}  	\ipa{me}  	\\
pig \textsc{neg-nmlz:P}-own  at.all \textsc{n.pst}:not.exist\\
...
the.whole.county \textsc{coord}  \textsc{redp-pfv-nmlz:S}-have.leprosy \textsc{top} \textsc{evd}-destroy \\
...
\gll \ipa{mɤŋi}  	\ipa{kɤ-kɯ-ɣe}  	\ipa{χpɯn}  	\ipa{thɯ-kɯ-rgɤz}  	\ipa{ci}  	\ipa{pjɤ-tu}  	\ipa{tɕe,}    	\\
Mangi \textsc{pfv:east-nmlz:S}-come[II] monk \textsc{pfv-nmlz:S}-old \textsc{indef} \textsc{evd.ipfv}-exist   \textsc{coord} \\
...
tree \textsc{3sg.poss}-on \textsc{pfv-nmlz:S}-climb person \textsc{top} \textsc{evd:down-auto}-come.out \\
\glt The man who had climbed the tree came down.
\end{exe}

Thus, there no absolute correlation between prenominal S-relativization  and non-restrictive interpretation of a relative. 
...
We do find in our corpus examples like \ref{ex:spjaNkw}  that could allow an interpretation as non-nominalized relativization of S argument.

%Analysis:
%ri tu-mbri nɯ sɤmtshɤm.	\ipa{sɯŋgɯ}  	\ipa{ku-rɤʑi}  	\ipa{ɕti}  	\ipa{tɤɣa}  	\ipa{kɤ-mto}  	\ipa{me.}  	\ipa{ri}  	\ipa{tu-mbri}  	\ipa{nɯ}  	\ipa{sɤmtshɤm.}  
%scuz 113

\begin{exe}
   \ex  \label{ex:spjaNkw}
\gll [\ipa{nɯ}  	\ipa{tu-ɣɤwu}]  	\ipa{nɯ}  	\ipa{ɯ-mtshɤm}  	\ipa{pɯ-rɲo-t-a}  \\
\textsc{dem} \textsc{ipfv}-cry \textsc{top} \textsc{3sg-bare.inf}:hear \textsc{pfv}-experience-\textsc{pst:tr-1sg} \\
\glt (Wolf, 22)
\end{exe}

Subordinate clauses such as the one in \ref{ex:spjaNkw} could in principle be analyzed as  relatives, in which case the translation would be ``I have heard a howling one (wolf) / I have heard (a wolf) that was howling". 

However, it is preferable to analyze them as complement clauses, an analysis which entails a different translation (``I have heard it howling"). The  main arguments in favour of the complement clause analysis is that all such examples occur with verbs of perception like ``hear", ``see", which allow both noun phrases or complement clauses as their P. There is no example of such a subordinate clause in a context non-ambiguously requiring an analysis as a relative. 
...
\textsc{indef.poss}-breast \textsc{3sg-nmlz:A}-drink child \textsc{gen} \textsc{3sg.poss-nmlz:S}-be.painful \textsc{const}-be \\
...
\gll  
 ...
 the.aforementioned axe \textsc{3sg-pfv-nmlz:A-auto}-throw people \textsc{top} \textsc{pl} axe \textsc{3sg-nmlz:A}-search \textsc{evd}-come-\textsc{pl} \\
...
However, when the nominalized verb has additional suffixes, such as TAM or negation markers, the possessive prefix coreferent with the P is only optionally, and is generally elided as in \ref{ex:cnat}.

\begin{exe}
   \ex  \label{ex:cnat}
\gll [\ipa{ɕnat}  	\ipa{tu-kɯ-rɤɕi}]  	\ipa{ndʑu}  	\ipa{nɯnɯ,}   	\ipa{ɕnat-ndʑu}  	\ipa{rmi,}  \\
weft \textsc{ipfv-nmlz:A}-pull stick \textsc{top}  weft-stick \textsc{n.pst}:be.called\\
...
\begin{exe}
   ...
   \gll \ipa{qartshaz}  	\ipa{mu}  	\ipa{nɯra,}  	[\ipa{pɯ-pɯ-kɯ-mtshɤm}]  	\ipa{nɯ}  	\ipa{ɯ-rkɯ}  	\ipa{nɯtɕu}  	\ipa{tu-owɯwum-nɯ}  	\ipa{ŋu}  \\
   deer female \textsc{dem:pl} \textsc{redp-pfv-nmlz:A}-hear \textsc{dem} \textsc{3sg.poss}-side there \textsc{ipfv}-gather-\textsc{pl} \textsc{n.pst}:be \\
...
Relativization of the P argument allows for a greater variety of constructions than that of A or S. Unlike A and S, P arguments can be relativized with both nominalized and non-nominalized constructions. Moreover, both internally-headed and prenominal relatives are found, so that no less than four main constructions are attested. 
...
\subsubsection{Relativization of P with nominalization}
The P argument can be relativized by nominalizing the verb with the prefix \ipa{kɤ}--. Such nominalized relatives are most commonly internally-headed, as illustrated by examples \ref{ex:ragdwt}, \ref{ex:nandzwt}, \ref{ex:sazgwr} and \ref{ex:qaR}. 


     \begin{exe}
   \ex \label{ex:ragdwt}
\gll 
[\ipa{nɯŋa}  	\textbf{\ipa{ɯ-ndʐi}}  	\ipa{thɯ-kɤ-rɤɣdɯt,}]  	\ipa{thɯ-kɤ-tʂɯβ}  	\ipa{nɯ}  	\ipa{ɯ-ŋgɯ}  	\ipa{nɯ}  	\ipa{tɕu}  	\ipa{ko-ɕe}  \\
...
person \textsc{neg-nmzl:O}-know \textsc{pfv}-come[II] \textsc{coord} \textsc{ipfv-appl}-bark\\
...
je \textsc{1sg-neg-nmlz:P}-know mushroom \textsc{dem} \textsc{inf}-eat \textsc{neg}-dare-\textsc{1sg} \\
...
I  \textsc{indef.poss}-language most \textsc{1sg-nmlz:P-appl}-like  \textsc{dem} Tibetan-language \textsc{n.pst}:be\\
\ex \label{ex:akanwrga2}
\gll [\ipa{aʑo}  	\ipa{stu}  	\ipa{a-kɤ-nɯ-rga}]  	\textbf{\ipa{tɯ-skɤt} } 	\ipa{nɯ}  	\ipa{kɯrɯ-skɤt}  	\ipa{ŋu}  \\
I most \textsc{1sg-nmlz:P-appl}-like \textsc{indef.poss}-language \textsc{dem} Tibetan-language \textsc{n.pst}:be \\
...
Unlike in Tshobdun (\citealt[10]{jacksonlin07}), in Japhug nominalized relatives with possessive prefixes are not restricted to generic state of affairs, but can refer to particular situations as in \ref{ex:khu}.
...
However, these relatives cannot be used for perfective relativization. To express a meaning such as ``the thing that I have  seen", the only possibility in Japhug is to use a non-nominalized relative.


Since many adjuncts are not overtly marked by a locative marker, in some cases it is not entirely obvious whether we have a case of P-relativization  or another type of relative. Thus, in sentence \ref{ex:thWkAsAtsa}, either \ipa{chɤmdɤru} ``drinking straw" or the possessor \ipa{nɯ-mkɤqhu} ``their necks" could be analysed as the relativized element.

  
     \begin{exe}
   \ex \label{ex:thWkAsAtsa}
 \gll
[\ipa{nɯ-mkɤqhu}   	\textbf{\ipa{chɤmdɤru}}   	\ipa{thɯ-kɤ-sɯ-ɤtsa}]   	\ipa{ʁɟa}   	\ipa{ʑo}   	\ipa{pɯ-ŋu}   	\ipa{ɲɯ-ŋu}    \\
\textsc{3pl.poss}-neck drinking.straw \textsc{pfv-nmlz:P-caus}-be.planted completely \textsc{emph} \textsc{pst.ipfv}-be \textsc{const}-be\\
...
\subsubsection{Relativization of P without nominalization} \label{sec:p.non.nmlz}

The P argument, unlike A or S, can be relativized with a non-nominalized verb, as in example \ref{ex:tutianw}.\footnote{The P of \ipa{ti} ``to say" is never the addressee, it always refers to the words that are said.}
...
\gll [\ipa{tɯrju}  	\ipa{nɤ-sɤ-ti}]  	\ipa{tɯrme}  	\ipa{nɯ}  	\ipa{ɕu}  	\ipa{pɯ-ŋu} ?\\
 word \textsc{2sg-nmlz:oblique}-say person \textsc{top}   \textsc{pst.ipfv}-be\\  
...
\gll \ipa{a-sɤz-rɤ-thu}  	\ipa{χpɯn}  	\ipa{nɯ}  	\ipa{kɯ-mkhɤz}  	\ipa{ci}  	\ipa{ɲɯ-ŋu}    \\
\textsc{1sg-nmlz:oblique-antipass}-ask monk \textsc{top}  \textsc{nmlz:}S/A-expert \textsc{indef} \textsc{const}-be \\
...
\textsc{1sg-nmlz:oblique}-ask monk \textsc{top}   \\
...
\begin{exe}
   \ex \label{ex:WsAmWmi}
 \gll 
\ipa{tɕe}   	[\ipa{ɯʑo}   	\ipa{ɯ-sɤ-ɤmɯmi}]   	\ipa{nɯ}   	\ipa{dɤn}   	\ipa{ma}   	\ipa{ca}   	\ipa{kɯ-fse}   	\ipa{qaʑo}   	\ipa{kɯ-fse,}   	\ipa{tshɤt}   	\ipa{kɯ-fse,}   	 \ipa{ɯʑo}   	\ipa{cho}   	\ipa{kɯ-naχtɕɯɣ}   	\ipa{sɯjno,}   	\ipa{xɕɤj}   	\ipa{ma}   	\ipa{mɤ-kɯ-ndza}   	\ipa{nɯ} \ipa{ra}   	\ipa{cho}   	\ipa{nɯ}   	\ipa{amɯmi-nɯ}   	\ipa{tɕe,}   \\
...
\begin{exe}
   \ex \label{ex:thajtCu}
 \gll [\ipa{tɤjmɤɣ}   	\ipa{ɯ-sɤɣ-ɬoʁ}]   	\ipa{nɯ}   	\ipa{thɤjtɕu}   	\ipa{ŋu}   \\
 mushroom \textsc{3sg-nmlz:oblique}-come.out \textsc{top} when \textsc{n.pst}:be \\
...
\begin{exe}
 ...
 \textsc{n.pst}:cold a.lot \textsc{neg-n.pst}:warm \textsc{3sg.poss}-time \textsc{coord} sunny.side \textsc{3sg.poss}-side \textsc{const}:exist \\
...
%but \textsc{dem} redp-pfv-go[II] \textsc{top} \textsc{3sg.poss}-row \textsc{nmlz:S}-be.like \textsc{indef.poss}-snot \textsc{nmlz:S}-be.like \textsc{ipfv}-smear
%\\
%\glt  (The slugs, 136)
%\end{exe}
...
where \textsc{pfv}-walk \textsc{top} \textsc{const}-obvious \\
\glt The places where it has moved are very obvious. (The slugs, 137)
\end{exe}

We also find  correlatives nominalized with  \ipa{kɯ}-- including the pronoun  \ipa{ŋotɕu} ``where".

\begin{exe}
   \ex \label{ex:NotCunWkAtCaR}
 \gll [\ipa{ɯ-se}   	\ipa{nɯ}   	\ipa{ŋotɕu}   	\ipa{nɯ-kɯ-ɤtɕaʁ}]   	\ipa{nɯ}   	\ipa{tɕe}   	\ipa{li}   	\ipa{ɲɯ-ɬoʁ}   	\ipa{ŋu}   \\
 3sg.poss-blood \textsc{top} where \textsc{pfv-nmlz:S}-be.stained \textsc{top} \textsc{coord} again \textsc{ipfv}-come.out \textsc{n.pst}:be \\
...
\begin{exe}
 ...
 \textsc{1sg.poss}-tea \textsc{pfv-nmlz:P}-put.in \textsc{3sg.poss}-place \textsc{top} \textsc{loc}  \textsc{1sg.poss}-vegetables \textsc{imp}-put.in \\
...
the.aforementioned \textsc{pst.ipfv}-walk.around \textsc{3sg.poss}-place \textsc{top} \textsc{pl} \textsc{indef.poss}-snot \textsc{pfv:down-nmlz:P}-throw.away \textsc{emph} \textsc{n.pst}:be.like \\
...
\gll
 ...
 sun \textsc{3sg-nmlz:oblique}-come.out \textsc{3sg.poss}-place about \textsc{ipfv:up}-come.out \textsc{n.pst}:be \\
...
birch \textsc{nmlz:S}-be.many \textsc{3sg.poss}-inside completely \textsc{emph} mushroom.sp \textsc{top} \textsc{ipfv}-come.out \textsc{n.pst}:be \\
...
\glt There, one ties it with a leather rope. (Plough, 97)
   \end{exe} 
%add tɤpɤtso ɯ-ɕɣa ɲɯ-mɯnmu tɕe, tɯɕɣa kú-wɣ-βraʁ tɕepjɯ́-wɣ-nɤstɤr ʑo tɕe pjɯ́-wɣ-phɯt ɲɯ-ra. tɯ-ɕɣa ɯ-sɤβraʁ nɯ tɤ-ri ɕti ma tɯmbri maʁ

This argument is relativized by nominalizing the verb with the prefix \ipa{sɤ}-- and removing the   causative prefix \ipa{sɯ}-- as in \ref{ex:sAxtCAr}. Thus , the distinction between different types of adjuncts is neutralized in nominalized relative clauses; on the other hand, relativization is a useful syntactic test to discriminate between A and instrument adjunct, as the former is relativized by \ipa{--kɯ-}.
...
\subsection{Unmarked adjuncts} \label{sec:other}
...
bird \textsc{pl} \textsc{3pl-nmlz:P}-like \textsc{top} wheat always \textsc{n.pst}:be \\
\glt (The food) that birds like is always wheat. (pɣaɲaʁ 24)
   \end{exe} 

With the verb  \ipa{aro} ``to possess", the morphophonology makes the nominalized verb form identical for both S-relativization and adjunct relativization. Thus, the surface form [ɯkɤro] can be ambiguous between \ipa{ɯ-kɯ-ɤro} ``the one wo possesses it" and \ipa{ɯ-kɤ-ro} ``that which he possesses".
...
I sheep \textsc{n.pst}:possess-\textsc{1sg} \textsc{top} \textsc{pl} \textsc{dem.prox} \textsc{n.pst}:be \\
...
The unmarked adjunct of semi-transitive verbs thus presents some object-like properties in its relativization pattern.
...
he \textsc{comp} nmlz:S-be.small bird 	 \textsc{top} \textsc{pl}  also \textsc{ipfv}-catch[III] \textsc{coord} \textsc{ipfv}-eat[III] \\
...
\ipa{cha} ``can" can be used with two types of complement clause: infinitive complements (with the verb prefixed in \ipa{kɤ--} prefix) and  non-nominalized clauses with the verb in the imperfective.
...
owl \textsc{top} \textsc{erg} mole \textsc{inf}-kill very \textsc{emph} \textsc{n.pst}:can \textsc{hearsay} \\
\glt Owls are very good at killing moles, it is said. (mole 202)
   \end{exe} 

With non-nominalized complements in the imperfective, the referent   of the S of \ipa{cha} can correspond to any of S (example \ref{ex:CkurAZi.cha}), A (\ref{ex:tundze.cha}) or even P (\ref{ex:kuwGsphjaR}) in the complement clause.
...
muntjac \textsc{top} cliff \textsc{3sg.poss}-inside \textsc{cisloc-ipfv}-remain \textsc{n.pst}:can \textsc{neg-n.pst}:can \textsc{genr:}not.know \\
...
\gll
    ...
    animal \textsc{pl} \textsc{ipfv}-eat[III] \textsc{n.pst}:can \textsc{neg-n.pst}:can \textsc{genr:}not.know \\
...
\textsc{coord} \textsc{dem} \textsc{ipfv}-wear-\textsc{pl} \textsc{coord} \textsc{ipfv-inv}-soak \textsc{neg:const}-can \\
\glt They would wear it (woollen cloth), as it cannot be soaked (by water) (Sheep 17)
      \end{exe} 

In non-nominalized complement clauses of the verb \ipa{cha}, the is co-indexation of person and number on the dependent  verb   and on the auxiliary \ipa{cha}, as illustrated by \ref{ex:lumWrkia} and \ref{ex:mWjchatCi}.
    \begin{exe}
      \ex   \label{ex:lumWrkia}  
\gll   
      \ipa{aʑo}   	\ipa{chɯ-ɕe-a}   	\ipa{tɕe}   	\ipa{lu-mɯrki-a}   	\ipa{cha-a}   \\
      I \textsc{ipfv:downstream-go}-\textsc{1sg} \textsc{coord} \textsc{ipfv:upstream}-steal[III]-\textsc{1sg} \textsc{n.pst}:can-\textsc{1sg} \\
...
\gll   
\ipa{chɯ-mɤɕi-tɕi}   	\ipa{mɯ́j-cha-tɕi}   \\
\textsc{ipfv}-be.rich-\textsc{1du} \textsc{neg:const}-can-\textsc{1du} \\
\glt  We are not able to become rich. (The divination2, 6)
           \end{exe} 
     
Relatives with nominalized \ipa{cha} ``can" as their predicate allow the embedding exactly the same types of complement clauses.  Infinitival complement can be appear before nominalized \ipa{cha}, as in \ref{ex:karwcmi}.
      
 \begin{exe}
   \ex   \label{ex:karwcmi}
 \gll  [\textbf{\ipa{pɣa}}  	\ipa{kɤ-rɯɕmi}  	\ipa{kɯ-cha}]  	\ipa{ci}  	\ipa{ra,}   		\\
 bird \textsc{inf}-speak \textsc{nmlz:S}-can \textsc{indef} \textsc{n.pst}:need \\
 \glt   (I) need a bird who is able to speak. (Slopdpon, 19)
   \end{exe} 
  
  
Non-nominalized complements are also possible, and the referent of the S of \ipa{cha} can have any syntactic role in the complement clause, even P  as in \ref{ex:CpjWZGAGAlanW}.

\begin{exe}
   \ex  \label{ex:CpjWZGAGAlanW}
\gll
[[\ipa{smɤnba} 	\ipa{kɯ} 	\ipa{tu-nɯsmɤn}] 	\ipa{mɤ-kɯ-cha}] 	\ipa{nɯ,} 	\ipa{nɯ} 	\ipa{tɕu} 	\ipa{ju-ɕe-nɯ} 	\ipa{tɕe} 	\ipa{ɕ-pjɯ-ʑɣɤ-ɣɤla-nɯ} 	\\
doctor \textsc{erg} \textsc{ipfv}-heal \textsc{neg-nmlz:S}-can \textsc{top} \textsc{dem} \textsc{loc} \textsc{ipfv}-go-\textsc{pl} \textsc{coord} \textsc{transloc-ipfv-refl}-soak-\textsc{pl} \\
\glt Those who cannot be healed by the doctors go there and bathe in it. (ldɯɣi 54)
   \end{exe}

When nominalized, \ipa{cha} loses all person and number marking, but those of the complement clause are not neutralized, as in \ref{ex:tundzurndZi} where the  dual marking is preserved in the complement clause but applies to the whole nominalized clause.

\begin{exe}
   \ex  \label{ex:tundzurndZi}
\gll
[\ipa{tu-ndzur-ndʑi}   	\ipa{mɤ-kɯ-cha}]   	\ipa{nɯ} \ipa{ra}   	\ipa{ɲɯ-naχtɕɯɣ}   \\
\textsc{ipfv}-stand-\textsc{du} \textsc{neg-nmlz:S}-can \textsc{top} \textsc{pl} \textsc{const}-identical \\
...
\gll
[[\ipa{ɕu}   	\ipa{kɯ}   	[\ipa{kɯ-mɯrkɯ}   	\ipa{kɯ-ŋu}]   	\ipa{lu-kɤ-tɕɤt}]   	\ipa{pɯ-kɯ-cha}]   	\ipa{nɯ}   	\ipa{a-sci}   	\ipa{rɟɤlpu}   	\ipa{chɯ-ta-sɯ-ndo}   	\ipa{ŋu}   \\
who \textsc{erg} \textsc{nmlz:S}-steal \textsc{nmlz:S}-be \textsc{ipfv-inf}-take.out \textsc{pfv}-\textsc{nmlz:S}-can \textsc{dem} \textsc{1sg.poss}-instead king \textsc{ipfv-1$\rightarrow$2-caus}-take \textsc{n.pst}:be \\
...
\gll   
\ipa{kɤ-nɯrɤɣo}  	\ipa{ɯ-skɤt}  	\ipa{ɲɯ-sna}  \\
\textsc{inf}-sing \textsc{3sg.poss}-voix \textsc{const}-nice \\
...
\begin{exe}
   \ex  \label{ex:jWm}
\gll
[[\ipa{jɯm}  	\ipa{kɤ-ɕar}]  	\ipa{ɣɯ}  \ipa{ftɕɤka}]  	\ipa{ɣɯ}  	\ipa{tɯ-rɟaʁ}  	\ipa{sɯ-βzu-j}  \\
wife:\textsc{hon} \textsc{inf}-search \textsc{gen} method \textsc{gen} \textsc{nmlz:action}-dance \textsc{n.pst:caus}-do-\textsc{1sg} \\ 
...
gourd and eggplant \textsc{du} what \textsc{emph} \textsc{neg:const}-similar \textsc{gen} \textsc{3sg.poss}-information \textsc{irr-pfv}-2-bring \textsc{n.pst}:need \\
...
While Japhug has indefinite pronouns such as \ipa{thɯci} ``something" or \ipa{cɯschɯz} ``somewhere", it does not have negative indefinite pronouns  such as ``nothing" and ``nowhere". It is not possible to the Japhug indefinite pronouns with the negative of the verb, so that to express the meanings corresponding to negative indefinite pronouns in European languages, one uses a different strategy, involving a nominalized relative and the existential verb \ipa{me} ``not exist".
...
he \textsc{erg} \textsc{pfv}:3$\rightarrow$3'-say[II] at.all \textsc{nmlz}:S-exist \textsc{n.pst}:not.exist \\
...
phone \textsc{3sg-nmlz}:A-throw exist:\textsc{sens} \\
