...
gunpowder \textsc{ipfv-nmlz:oblique}-throw \topic{} gun \textsc{3sg.poss}-ear \textsc{ipfv}-say-\textsc{pl} \textsc{n.pst}:be \\
...
most \textsc{3sg-nmlz:oblique}-numerous \topic{} grassland \topic{} \textsc{pl} \textsc{n.pst}:be-\textsc{pl} \\
...
\gll
	...
	\textsc{1sg.poss}-present \textsc{ipfv}-1$\rightarrow$2-give \textsc{n.pst}:be \\
...
[\ipa{a-pɤro}  	\ipa{nɯ-mbi-t-a}]  	\ipa{nɯ}  	\ipa{a-rɟit}  	\ipa{ŋu}  \\
	\textsc{1sg.poss}-present \textsc{pfv}-give-\textsc{pst:tr-1sg} 	  \topic{} \textsc{1sg.poss}-child \textsc{n.pst}:be \\
...
\gll
	...
	\textsc{indef.poss}-present \textsc{pfv}-give-\textsc{pst:tr-1sg} 	\textsc{indef.poss}-child \topic{} \textsc{1sg.poss}-son \textsc{n.pst}:be \\
...
\textsc{lnk}  competition who \textsc{pfv-nmlz:}S-prevail \textsc{gen} \textsc{dem} \textsc{3sg.poss}-hand \textsc{n.pst}:give[III]-\textsc{1sg} \textsc{n.pst}:be \\
...
\textsc{3sg}-\textsc{dat} \textsc{cisloc-genr:S/P}-marry \textsc{genr:S/P-n.pst}:need \textsc{pst.ipfv}-be:\textsc{assert} \textsc{lnk} \\
...
where \textsc{pfv-nmlz:S}-go[II] \textsc{3sg.poss}-place \topic{} \textsc{loc} \textsc{nmlz:S}-marry \textsc{genr:S/P}-go \textsc{n.pst}:need \textsc{ipfv}-say-\textsc{pl} \textsc{n.pst}:be.usually.the.case \\
...
russula very \textsc{emph} \textsc{n.pst}:be.like but \textsc{3sg.poss}-middle \textsc{ipfv-nmlz}:S-sink \topic{} \textsc{n.pst}:deep a.little \\
...
The demonstrative is however not obligatory, even with non-nominalized relative clauses, as in \ref{ex:tanwndota}.
...
\textsc{lnk} I \textsc{1sg-nmlz:P}-know onion \topic{} \textsc{dem} \textsc{pl} \textsc{n.pst}:be \\
...
\textsc{lnk} \textsc{3sg-nmlz:A}-spare  \textsc{3sg.poss}-material \textsc{n.pst}-be\\
...
\textsc{dem} again medicine not.only \textsc{nmlz:S}-good \textsc{testim}-be \\
 ...
 musk \textsc{lnk} very \textsc{emph}  medicine \textsc{nmlz:S}-good \textsc{n.pst}:be  \\
...
weft \textsc{ipfv-nmlz:A}-pull stick \topic{}  weft-stick \textsc{n.pst}:be.called\\
...
I  \textsc{indef.poss}-language most \textsc{1sg-nmlz:P-appl}-like  \textsc{dem} Rgyalrong-language \textsc{n.pst}:be\\
\ex \label{ex:akanwrga2}
\gll [\ipa{aʑo}  	\ipa{stu}  	\ipa{a-kɤ-nɯ-rga}]  	\textbf{\ipa{tɯ-skɤt} } 	\ipa{nɯ}  	\ipa{kɯrɯ-skɤt}  	\ipa{ŋu}  \\
I most \textsc{1sg-nmlz:P-appl}-like \textsc{indef.poss}-language \textsc{dem} Rgyalrong-language \textsc{n.pst}:be \\
...
The P argument, unlike A or S, can be relativized with a non-nominalized verb, as in example \ref{ex:tutianw} with a head internal relative whose main verb \ipa{tu-ti-a} I say' is in the imperfective.\footnote{The P of \ipa{ti} ``to say" is never the addressee, it always refers to the words that are said.}
...
\textsc{2sg.poss}-mother \textsc{2sg.poss}-father \textsc{nmlz:S}-complete 2-\textsc{n.pst:}be I \textsc{1sg.poss}-mother \textsc{nmlz:S}-not.exist \textsc{n.pst:}be-\textsc{1sg} \textsc{lnk} \\
...
\textsc{lnk} it \textsc{3sg-nmlz:oblique}-be.in.good.terms \topic{} \textsc{n.pst:}be.many because water.deer \textsc{nmlz:S}-be.like sheep \textsc{nmlz:S}-be.like goat  \textsc{nmlz:S}-be.like it with  \textsc{nmlz:S}-be.identical herbs grass apart.from \textsc{neg-nmlz:A}-eat \textsc{dem} \textsc{pl} with \textsc{dem} \textsc{n.pst}:be.in.good.term-\textsc{pl} \textsc{lnk} \\
...
\begin{exe}
 ...
 mushroom \textsc{3sg-nmlz:oblique}-come.out \topic{} when \textsc{n.pst}:be \\
...
\begin{exe}
 ...
 \textsc{n.pst}:cold a.lot \textsc{neg-n.pst}:warm \textsc{3sg.poss}-time \textsc{lnk} sunny.side \textsc{3sg.poss}-side exist:\textsc{sensory}  \\
...
\begin{exe}
 ...
 \textsc{2sg.poss}-tooth \textsc{n.pst}:small \textsc{3sg.poss}-time \textsc{loc} \topic{} 2-\textsc{inv}-accompany \textsc{n.pst}:be.with but \\
...
frog \textsc{gen}  \textsc{3sg.poss}-companion \textsc{pl} \textsc{indef.poss}-water \textsc{ipfv-inv}-cross \textsc{nmlz:S}-have.to \topic{} \textsc{loc} \textsc{pst.ipfv}-remain-\textsc{pl} \textsc{n.pst}:be:\textsc{assert} \\
...
\begin{exe}
 ...
 3sg.poss-blood \topic{} where \textsc{pfv-nmlz:S}-be.stained \topic{} \textsc{lnk} again \textsc{ipfv}-come.out \textsc{n.pst}:be \\
...
the.aforementioned \textsc{pst.ipfv}-walk.around \textsc{3sg.poss}-place \topic{} \textsc{pl} \textsc{indef.poss}-snot \textsc{pfv:down-nmlz:P}-throw.away \textsc{emph} \textsc{n.pst}:be.like \\
...
birch \textsc{nmlz:S}-be.many \textsc{3sg.poss}-inside completely \textsc{emph} mushroom.sp \topic{} \textsc{ipfv}-come.out \textsc{n.pst}:be \\
...
bird \textsc{pl} \textsc{3pl-nmlz:P}-like \topic{} wheat always \textsc{n.pst}:be \\
...
I sheep \textsc{n.pst}:possess-\textsc{1sg} \topic{} \textsc{pl} \textsc{dem.prox} \textsc{n.pst}:be \\
...
he \textsc{comp} nmlz:S-be.small bird 	 \topic{} \textsc{pl}  also \textsc{ipfv}-catch[III] \textsc{lnk} \textsc{ipfv}-eat[III] \\
...
owl \topic{} \textsc{erg} mole \textsc{inf}-kill very \textsc{emph} \textsc{n.pst}:can \textsc{hearsay} \\
...
muntjac \topic{} cliff \textsc{3sg.poss}-inside \textsc{cisloc-ipfv}-remain \textsc{n.pst}:can \textsc{neg-n.pst}:can \textsc{genr:}not.know \\
...
\gll   
      ...
      I \textsc{ipfv:downstream-go}-\textsc{1sg} \textsc{lnk} \textsc{ipfv:upstream}-steal[III]-\textsc{1sg} \textsc{n.pst}:can-\textsc{1sg} \\
...
\textsc{inf}-sing \textsc{3sg.poss}-voix \textsc{testim}-nice \\
...
gourd and eggplant \textsc{du} what \textsc{emph} \textsc{neg:testim}-similar \textsc{gen} \textsc{3sg.poss}-information \textsc{irr-pfv}-2-bring \textsc{n.pst}:need \\
...
the.aforementioned vegetables \textsc{3sg-nmlz:}S/A-eat aphid \topic{} \textsc{ipfv}-eat[III] \textsc{n.pst}:be \\
