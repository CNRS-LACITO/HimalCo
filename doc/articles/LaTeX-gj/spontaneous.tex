...
\textsc{1sg} retire \textsc{pfv-auto}-do-\textsc{pst-1sg} \textsc{lnk} everyday here \textsc{pres-auto}-stay-\textsc{1sg} \\
...
\textsc{1sg} \textsc{neg-inf:stat}-reach retire \textsc{pfv}-do-\textsc{pst-1sg} \textsc{lnk} \textsc{pfv}-rest-\textsc{1sg} \\
...
\glt Before (the flower) fall down, it dries up, and its seed is still wrapped in it. (\ipa{tɤtɕɯβraʁ}, 59)
\end{exe} 
%还是在里面裹着
