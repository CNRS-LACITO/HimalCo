...
The generic human person morpheme \ipa{ŋa--} found in Situ should be reconstructed to proto-Rgyalrong, since as argued by  \citet[244]{sun14generic}, it is indirectly reflected in Tshobdun with the generic human morpheme \ipa{kɐ--} $\leftarrow$ *\ipa{kə-ŋa--}. Yet, it is likely that this prefix is grammaticalized from the homophonous agentless passive \ipa{ŋa--} prefix attested in all Rgyalrong languages (for instance, Japhug \ipa{a--}, see \citealt{jacques12demotion}); whether this grammaticalization had already taken place in proto-Rgyalrong or whether it occurred independently in Tshobdun and Situ is still unclear.


The grammaticalization of the generic person marking system from the nominalizer *\ipa{kə--} is one of the many common morphological innovations between Tshobdun and Japhug (and probably Zbu, though the data is not yet available) not shared by Situ. It suggests that a \textsc{Northern Rgyalrong} clade comprising Tshobdun, Japhug and Zbu should be established within the Rgyalrong group.


In the scenario proposed here, Japhug innovated a generic person marking system with ergative alignment while Tshobdun innovated a system with accusative alignment, while proto-Northern Rgyalrong had a system
