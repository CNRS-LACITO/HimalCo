...
\setmainfont[Mapping=tex-text,Numbers=OldStyle,Ligatures=Common]{Gentium} 
...
tɕe wuma ʑo ɲɯ-χɕu ma tɯʑo-sti a-mɤ-nɯ-kɯ-ɤtɯɣ ɲɯ-ra ma ɲɯ-sɤɣmu.
Bear, 98
...
\textsc{lnk} everywhere \textsc{emph} \textsc{ipfv}-land \textsc{lnk} \textsc{3sg.poss}-feces \textsc{ipfv}-throw \textsc{lnk} really \textsc{emph} \textsc{indef.poss}-house \textsc{indef.poss}-thing \textsc{pl} \textsc{fact:caus}-be.dirty \\
...
Possessed nouns obligatorily take either one of these possessive prefixes whenever their do not have a definite possessor (the distribution of these two prefixes is not predictable: it is lexically determined). 
...
tɯrme tɯ-fsu ɕoŋtaʁ tu-mbro mɤ-cha.
 ...
 difference between indefinite possessor and generic possessor \ipa{tɤ-rpɯ} vs \ipa{tɯ-rpɯ}
