...
\glt (The food) that birds like is always wheat. (23 pGAYaR, 29)
   \end{exe} 
...
\textsc{1sg} place pfv-go[II]-\textsc{1sg} \textsc{dem} \textsc{dem} \textsc{nmlz}:S/A-be.far \textsc{indef} be:\textsc{fact} \\
\glt The place to which I have gone is far away. (elicited)
\end{exe}
