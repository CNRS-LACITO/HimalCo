...
Acknowledgements will be added after editorial decision. %Wu Tong, Hilary Chappell, Aimée Lahaussois
} }
...
possessor & PN&&&&& \\
\hline
P & & HI, PN \grise{}&& HI, PN\grise{} &\\
semi-object & & HI, PN \grise{}&& HI, PN\grise{} &\\
T & & HI, PN\grise{} && HI, PN \grise{}&\\
R (secundative) & & HI, PN\grise{} && HI, PN \grise{}&\\
\hline
R (indirective) & &&HI, PN\\
...
Another area where this neutralization is observed is the optional possessive prefix on \ipa{kɤ--} participles.   For transitive and ditransitive verbs  the prefix always refer to the A (example \ref{ex:kill3} above), while in the case of semi-transitive verbs, it refers to the S, as in \ref{ex:nWkArga}, thus displaying S/A restrictive neutralization.\footnote{The \ipa{kɤ--} participle does not exist for plain intransitive verbs, so that semi-transitive verbs are the only ones where one can test the behaviour of S a possessive prefix to an object participle.}
...
However, this diversity should not come as a surprise. It has been shown that radically  different types of syntactic pivots can co-exist in the same language (\citealt[282]{vanvalin97syntax}), and Japhug is not  unusual is this particular aspect. 
