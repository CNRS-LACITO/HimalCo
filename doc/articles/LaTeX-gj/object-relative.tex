...
Acknowledgements will be added after editorial decision. %Wu Tong, Hilary Chappell, Aimée Lahaussois, Anton Antonov
} }
...
Semi-objects can also be relativized with the same construction, as in  \ref{ex:aroa}. Such examples, however, are not found in our corpus and can only be elicited.
 \begin{exe}
   \ex   \label{ex:aroa}  
\gll
...
The goal of motion verbs and manipulation verbs like \ipa{ɕe} `go' and \ipa{tsɯm} `take away' can be relativized with finite relatives, as in examples \ref{ex:jowGtsWmnW} and \ref{ex:jaria.nW}. Although the goal is not indexed in verb morphology, it is nevertheless included in the verb argument structure.

     \begin{exe}
   \ex \label{ex:jowGtsWmnW}
 \gll
[\ipa{\textbf{kʰa}}\tete{}  	\ipa{jó-wɣ-tsɯm-nɯ}]_{\textsc{rc}}  	\ipa{nɯnɯ,}  	\ipa{lonba}  	[\ipa{ɕom}  	\ipa{kɯ}  	\ipa{nɯ-kɤ-sɯ-βzu}]_{\textsc{rc}}  	\ipa{\textbf{kʰa}}  	\ipa{pjɤ-ŋu}  \\
...
In addition, time and place adjuncts can be relativized with prenominal finite relatives with  relator head nouns such as \ipa{ɯ-raŋ} `time', \ipa{ɯ-sŋi} `the day' or \ipa{ɯ-sta} `the place', as in examples  \ref{ex:WraN2} and \ref{ex:Wsta2}.
...
Second, the main verbs of finite relatives can undergo totalitative reduplication. Totalitative reduplication is the  reduplication of the first syllable of a verb form, expressing the meaning `all', and is normally only possible on nominalized verbs as in \ref{ex:kakwnandza}.
