...
Although still in current use in some circles, the term `pronominalized'  is inadequate to refer to refer to Trans-Himalayan languages with person indexation for three reasons.
...
When analyzing complex polypersonal systems, t is important not to focus on individual affixes, whose distribution may in some cases not even be describable in functional terms, but rather to study the whole set of affixes and stem alternations as a complete system. In Japhug, we find at least three pieces of evidence that person indexation affixes  do not mark `SAP involvement'.

First, there are several affixes or morphological processes in Japhug that precisely occur only in specific configurations of A and P. Here is a list of the most important ones:
