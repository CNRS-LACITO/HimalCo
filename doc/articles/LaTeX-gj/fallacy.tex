...
& A & S & P & alignement\\
\hline
\textsc{1sg}& \ipa{-ŋ} ($\rightarrow$3)& \multicolumn{2}{|c|}{\ipa{-ŋa} \grise{}(\textsc{npst})}  &ergative\\
 & \ipa{-na} ($\rightarrow$2)& \multicolumn{2}{|c|}{\ipa{-oŋ} \grise{}(\textsc{pst})} &\\
\hline
 \textsc{2sg} & \multicolumn{3}{c|}{\ipa{-tʌ}}& neutral\\
 \cline{4-4}
 &\multicolumn{2}{c|}{}&\ipa{--na}&\\
 \hline
