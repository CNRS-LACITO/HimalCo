...
In present contexts where a contrast between the three categories is possible, the Factual is used to express generally accepted knowledge, the Sensory for a discovery made through sensory channels, and the Egophoric for knowledge obtained through `personal involvement in a state of affairs'.\footnote{Using Floyd's \citeyearpar{floyd16egophoricity} definition.} 
