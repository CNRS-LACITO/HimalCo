...
\textbf{Abstract}: This paper presents a detailed description of each of the evidential categories of the Japhug verb and their interaction with person marking in declarative clauses, interrogative clauses and reported speech. 

\textbf{Keywords}: Evidentiality; Japhug; Tibetan; Person indexation; Egophoricity; Reported Speech
