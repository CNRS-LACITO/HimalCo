...
\begin{exe}
\ex 
\gll \ipa{Wakíŋyaŋ} \ipa{ni-kté-pi} \\
...
\begin{exe}
\ex 
\gll    \ipa{mitĥ-óyate}  \ipa{kiŋ}  \ipa{oyás'iŋ} \ipa{wičhá-ya-kte-pi} \ipa{čha}\\
\textsc{1sg.poss}-peuple \textsc{def} tout \textsc{coll:anim}:S/P-2:A-tuer-\textsc{pl} \\
\glt Tu as tué tout mon peuple.
\end{exe}
...
\textsc{1pl }  &	\grise{} &	\grise{} &	\ipa{uŋ-ní-kte-pi}  &	\ipa{uŋ-ní-kte-pi} &	\ipa{uŋ-kté-pi} &	\ipa{wičhá-uŋ-kte-pi} &	\\
