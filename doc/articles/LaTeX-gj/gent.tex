...
\toprule
&\zhc{唐}{-aŋ}& \zhc{庚}{-æŋ} & \zhc{陽}{-jaŋ} &\zhc{青}{-eŋ} \\
\midrule
...
\begin{tabular}{l|llllll}
\toprule
&\zhc{豪}{-aw}& \zhc{肴}{-æw} & \zhc{宵}{-jew} &\zhc{萧}{-ew} \\
\midrule
...
\item \zhc{群}{gj-}, \zhc{邪}{zj-}, \zhc{云}{hj-}, \zhc{以}{j-} only in third division.
\end{itemize}
...
\zhd{室}{ɕit}\zhd{罗}{la}\zhd{摩}{ma}\zhd{拏}{ɳæ}\zhd{洛}{lak}\zhd{迦}{kæ}
