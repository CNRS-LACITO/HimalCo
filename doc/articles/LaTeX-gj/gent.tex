...
According to \zhc{李荣}{Lǐ Róng}, third division rhymes are classified into three groups:

\begin{itemize}
\item \zhc{子}{zǐ}: Only found with grave initials (labial, velar or guttural)
\item \zhc{丑}{chǒu}: Compatible with all places of articulation except dental stops, no \zhc{重紐}{chóngniǔ}.
\item \zhc{寅}{yín}: Compatible with all places of articulation except dental stops, with no \zhc{重紐}{chóngniǔ}. 
\end{itemize} 
...
\begin{table}[H]
\caption{\zhc{咸}{xián} and \zhc{深}{shēn} (\ipa{-m} coda)} \centering \label{tab:xiao}
\begin{tabular}{llllll}
\toprule
Rhyme & Division & & Transcription \\
\midrule
...
\begin{table}[H]
\caption{\zhc{山}{shān} and \zhc{臻}{zhēn} (\ipa{-n} coda)} \centering \label{tab:xiao}
\begin{tabular}{llllll}
\toprule
Rhyme & Division & & Transcription \\
\midrule
