...
\section{Conclusion} 
The contribution of this paper is threefold. First, it provides the first detailed description of comitative adverbs in any Gyalrong language. Second, it shows that language contact between Gyalrong languages is not restricted to the lexicon, but actually also involves clear cases of borrowing of grammatical morphemes. Third, provides a example of evolution with clear directionality from \textsc{proprietive} to \textsc{comitative}.
