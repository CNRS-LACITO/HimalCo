...
\includegraphics{mapKamnyu2.pdf}
\end{figure}
...
An obvious possibility is that comitative adverb originate from the reanalysis of participial forms of reduplicated \ipa{aɣɯ--} denominal verbs. Ambiguous sentences like (\ref{ex:kAGWrtWrtaR}) actually constitute the pivot constructions which allow reanalysis in contexts where both proprietive (`having X') and a comitative (`with X') interpretations were possible.
