...
There are in Japhug a few complex predicates comprising two verbs roots which must appear together in a fixed order. The most common such complex predicate, \ipa{-stu -mbat} `try hard, do one's best'
