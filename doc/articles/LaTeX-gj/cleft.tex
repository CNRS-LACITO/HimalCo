...
\end{itemize}
 ...
 Examples (\ref{ex:mANidpon}), (\ref{ex:WkWnWmbrApW}), (\ref{ex:nWkAmbi}) illustrate head-internal participial relatives with  S, A and P relativization respectively (with subject \ipa{kɯ-} vs object \ipa{kɤ-} participles).
...
Examples (\ref{ex:pWpaGWt}),  (\ref{ex:tutianW}) and (\ref{ex:nWwGmbi}) illustrate head-internal finite clauses with finite verb forms for object and theme relativization. 
