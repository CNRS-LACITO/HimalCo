...
François refuses the concept of basic vocabulary, and 
...
\subsubsection{Lexically-specific sound changes}
Out of 474 innovations, François includes 116 \textit{lexically-specific sound changes}, which according to him are ``strongly indicative of genealogy, because they are unlikely to diffuse across separate languages: these arbitrary alterations of word forms normally diffuse only across individuals who self-identify as speakers of the same language at the time of the change.'' (\citealt[178]{francois15tree}). 

I do not dispute the potential value of irregular sound changes (in particular metatheses, changes due to analogical leveling etc), but sporadic sound correspondences are more often explainable are intra-dialectal borrowing. 
