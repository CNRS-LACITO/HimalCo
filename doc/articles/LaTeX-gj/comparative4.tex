...
\textsc{indef.poss}-boy \textsc{indef} \textsc{erg} bicycle \textsc{3sg-nmlz:A}-ride \textsc{indef} \textsc{pfv}-come[II] \\
...
modal  & \ipa{ŋu} ``be"  $\Rightarrow$ \begin{tabular}{l}\ipa{ɯ-mɤ-\textbf{kɯ}-ŋu-ci}  \\ \textsc{qu-neg-modal}-be-\textsc{modal}  \\ ``maybe it is" \end{tabular} \\
\bottomrule
\end{tabular}
\end{table}
