...
The description is based on the author’s fieldwork, and the word list and the short story in the appendix have been provided by Tshendzin (Chenzhen \zh{陈珍}, female, born 1950), a retired schoolteacher (a native speaker of Japhug, bilingual in Sichuan Mandarin since childhood).
 ...
 \section{Consonants}
   \begin{table}[h]
 \label{tab:consonants}  \centering
...
\ipa{u} &	\ipa{tɤ\textbf{lu}} &milk\\
     ...
     When followed by a syllable containing a rounded vowel (\ipa{u} or \ipa{o}), the back unrounded vowels \ipa{ɯ} and \ipa{ɤ} optionally undergo rounding harmony to \ipa{u} and \ipa{o} respectively (for instance \ipa{ɣɤʑu} `exist (sensory)' can be pronounced as  \phonet{ɣoʑu}).
