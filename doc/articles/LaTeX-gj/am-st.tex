...
The terms `direction' has been used in the literature to refer to quite distinct phenomena, including AM, but also static orientation and even person configuration (\citealt[20]{zuniga06}). Given the fact that  
...
The term `AM' has rarely been used to describe the grammar of ST languages other than Gyalrongic and Kiranti  -- to our knowledge, only the recent grammars of Karbi (\citet{konnerth14karbi}) and Hakhun Tangsa (\citet{boro17hakhun}) make use of this term.
