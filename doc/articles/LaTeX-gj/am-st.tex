...
\section{Conclusion}
AM systems are by no means rare in the ST family; in particular, the presence of AM in Mandarin and Burmese, the two languages with the largest number of speakers, suggests that it is possibly a very widespread if under-reported phenomenon.
