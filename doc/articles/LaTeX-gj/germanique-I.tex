...
La forme germanique est toutefois candidate à une comparaison avec des formes indo-iraniennes qui sont elles-mêmes restées sans explication: le sanskrit \ipa{gandha-} m. `odeur', l'avestique \ipa{gaiṇti-} f. `puanteur' et le vieux perse \ipa{gasta-} `répugnant' (données des autres cognats iraniens dans \citealt[103-104]{cheung07dictionary}). 
...
%\citet[542]{abaev58vol1} \ipa{iǧændun} `\forme{пачкать, осквернять}'
