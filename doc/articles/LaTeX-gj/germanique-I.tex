...
Mis à part le vieux perse où \ipa{gasta-} a développé un sens abstrait (voir \ref{ex:gasta}), les formes des autres langues indo-iraniennes désignent une perception olfactive. 
...
Certaines formes iraniennes dont le vieux perse \ipa{gasta-} `répugnant' impliquent une racine verbale \ipa{*gant} provenant virtuellement d'un \ipa{*g(ʰʷ)ent-} `avoir une mauvaise odeur'. Néanmoins, Une racine verbale \ipa{*g(ʷ)ʰent-} contreviendrait à la règle de co-occurrence des voisées aspirées et des sourdes (voir par exemple \citealt{kuemmel12pie}) et ne peut pas être indo-européen, et doit être secondaire. Pour rendre compte des formes attestée, un nom \ipa{*g(ʷ)ʰont-, *g(ʷ)ʰṇt-} `puanteur'.
