...
Dans ce travail, je propose une étymologie alternative pour un exemple proposé de \ipa{*gʷʰ-} à \ipa{w-} non traité par Seebold, le proto-germanique *\ipa{wambō-}  f. `ventre', et un nouvel exemple du traitement \ipa{*gʷʰ} $\rightarrow$ \ipa{*g-} devant \ipa{*u}, \ipa{*gunda-} `gangrène'. 
