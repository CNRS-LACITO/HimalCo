...
The cognates of these three words are primarily nouns, never as verbs. The only exception known to me is the verbal use of \zh{枕} \ipa{zhěn} `to use as a pillow' in Mandarin Chinese (example \ref{ex:zhenzhe}).


\begin{exe}
\ex \label{ex:zhenzhe}
\glt \zh{枕着胳膊睡觉}
\gll \ipa{zhěn-zhe} \ipa{gēbo} \ipa{shuìjiao}\\
