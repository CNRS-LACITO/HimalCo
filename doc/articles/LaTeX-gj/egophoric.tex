...
The interaction between Evidentiality and Person is a well-establish phenomenon (\citealt[217-238]{aikhenvald06}, \citealt{aikhenvald15evd}, \citealt{sun18evidentials}), and Egophoric marking, a phenomenon documented in the Himalayas, South America, the Caucasus and Highland New Guinea (see \citealt{tournadre08conjunct}, \citealt{hill17evidential}, \citealt{creissels08akhvakh}, \citealt{curnow02conjunct}, \citealt{sanroque12evidentiality}, \citealt{sanroque17interrogativity})  is one of the most person-sensitive evidential categories. 
...
By focusing on such a narrow topic, we isolate the evidential contrast, and study minimal pairs which have exactly the same tense, aspect and modality parameters, to avoid any possible interference which could make the analysis of the semantic contrasts more difficult.
