...
The \ipa{j} glide, unlike other consonants, does not devoices and fricativizes when occurring as first element of a cluster whose second element is an obstruent.
