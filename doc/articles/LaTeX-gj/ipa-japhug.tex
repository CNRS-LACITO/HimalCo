...
Clusters whose last consonant is not a non-nasal sonorant have a limited number of possible consonants in first position: /w/, /s/, /z/, /ɕ/, /ʑ/, /l/, /r/, /ʂ/, /j/, /ɣ/, /x/, /ʁ/, /χ/, /n/, /m/ and the homorganic nasal, except for a few clusters in stop+/ɕ/.
 ...
 \begin{table}
 \caption{List of consonant clusters with \ipa{w}, \ipa{s} or \ipa{z} as a first element (38+8)} \label{prein.w.s}
   \resizebox{\columnwidth}{!}{
...
\end{table}
 ...
 There are some phonotactic constraints on the distribution of these consonants: /l/ is not compatible with coronal fricatives, /r/ and /ʂ/ never appear before retroflex fricatives and affricates.  
  ...
  \begin{table}
 \caption{List of consonant clusters with \ipa{l}, \ipa{r} or \ipa{ʂ}  as a first element (51+1)} \label{prein.l.r}
   \resizebox{\columnwidth}{!}{
...
\end{table}
  ...
  The velar fricatives /x/ and /ɣ/ are compatible with all places of articulation except velars and uvulars; the cluster \ipa{ɣʁ} is attested for some speakers between morpheme boundaries in the case of the causative of intransitive verbs with the onset \ipa{ʁ}. For instance, the verb \ipa{ʁaʁ} `hatch' has a causative \ipa{sɯ-ʁaʁ} or \ipa{sɯɣ-ʁaʁ} depending on the speaker. This cluster, being  stranded between two syllables, is not included in the conservative count provided in this paper.
   ...
   \begin{table}
 \caption{List of consonant clusters with \ipa{j} or \ipa{ɕ/ʑ}  as a first element (29+1)} \label{prein.j.Z}
   \resizebox{\columnwidth}{!}{
...
\end{table}
 ...
 \begin{table}
 \caption{List of consonant clusters with  \ipa{x/ɣ} or \ipa{χ/ʁ} as a first element (47)} \label{prein.G.R}
   \resizebox{\columnwidth}{!}{
\begin{tabular}{l|lll|lll|lll|l}
\toprule
...
Clusters with nasal segments as first element (not counting voiced prenasalized stops and affricates) are listed in Table \ref{prein.nasal}. We find homorganic nasal clusters, compatible with all places of articulation, and non-homorganic ones, which can be either clusters in \ipa{n}+labial or velar or \ipa{m}+non-labial. There are no clusters with a nasal directly followed by a fricative or any non-nasal sonorant. After \ipa{n} and \ipa{m}, the contrast between voiced preinitial and vocied consonants is neutralized; the existence of the cluster \ipa{mɢ} while only the prenasalized phoneme \ipa{ɴɢ}, not simple voiced \ipa{ɢ} exists, shows that it should be analyzed as /\ipa{mɴɢ}/ phonologically.
 ...
 \begin{table}
 \caption{List of consonant clusters with a nasal as   first element (38+1)} \label{prein.nasal}
   \resizebox{\columnwidth}{!}{
\begin{tabular}{l|lll|lll|lll|l}
\toprule
...
Finally, we fins a few clusters comprising a stop followed by the fricative \ipa{ɕ} :  \ipa{pɕ}  (as in \ipa{ɯ-pɕi}  `outside'),  \ipa{kɕ}  (as in \ipa{kikɤkɕi}  `marten'), \ipa{lpɕ} and \ipa{mpɕ} (see Tables \ref{prein.l.r} and  \ref{prein.nasal}). These clusters historically originate from aspirated stops followed by \ipa{j} (\ipa{pʰj}, \ipa{kʰj}), but their pattern in reduplication indicates that this is not true any more synchronically. For instance, \ipa{mpɕɤr} `it is beautiful' is reduplicated as \ipa{mpɕɯ-mpɕɤr}).
 ...
 \begin{table}
 \caption{List of consonant clusters ending in \ipa{j} or \ipa{w} (27+18)} \label{med.w.j}
...
\end{table}
   ...
   \begin{table}
 \caption{List of consonant clusters ending in \ipa{l} or \ipa{r} (43+46)} \label{med.l.r}
...
&	&	&	&	\ipa{zbr}  & 	\ipa{zbrilu}  \tib{} & year of the snake	 	\\
&	&	&	&	\ipa{zmbr}  & 	\ipa{sɤzmbri}  & 	he makes him angry	\\
&	\ipa{scl}  & 	\ipa{sclaŋsclaŋ}  & 	&	\ipa{scr}  & 	\ipa{scraʁscraʁ}  & 	&	\\
&	&	&	&	\ipa{zɟr}  & 	\ipa{zɟraŋzɟraŋ}  & 		\\
&	&	&	&	\ipa{skʰr}  & 	\ipa{tɯ-skhrɯ}  & 	 	\\
&	&	&	&	\ipa{skr}  & 	\ipa{skraskra}  & 	 	\\
&	\ipa{sql}  & 	\ipa{sqlɯm}  & 	&	\ipa{zgr} \tib{} & 	\ipa{zgrawa}    	&	\\
&	\ipa{sqʰl}  & 	\ipa{asqʰlu}  & 	&	\ipa{sqr}  & 	\ipa{sɤsqra}   	&	\\
\midrule
&	&	&	&	\ipa{ɕpr}  & 	\ipa{aɕprɯm}  & it is badly sewed	\\
&	&	&	&	\ipa{ʑmbr}  & 	\ipa{ʑmbri}  & willow	\\
&	&	&	&	\ipa{ɕtr}  & 	\ipa{ɕtraŋɕtraŋ}  & long and soft	\\
&	&	&	&	\ipa{ʑdr}  & 	\ipa{ʑdraŋʑdraŋ}  & 	 long and soft	\\
&	&	&	&	\ipa{ɕkr}  & 	\ipa{ɕkrɤz}  &oak 	\\
&	&	&	&	\ipa{ʑgr}  & 	\ipa{ʑgrɯ}  &certainly 	\\
&	\ipa{ɕql}  & 	\ipa{ɕqlɯwnɤɕqlɯw}  &  walking in the water 	(sound)&	\ipa{ʑŋgr}  & 	\ipa{ʑŋgri}  &star 	\\
&	\ipa{ɕqʰl}  & 	\ipa{ɕqʰlɤt}  &it disappears 	&	\ipa{ɕqr}  & 	\ipa{ɕqraʁ}  & 	he is intelligent \\
\midrule						
&	&	&	&	\ipa{jkr}  & 	\ipa{jkrɯt}  & \\
&	&	&	&\ipa{jtsr}  & 	\ipa{jtsraβ}  & \\
	\midrule	
&	&	&	&	\ipa{rɴɢl}  & 	\ipa{arɴɢlɯm}  & \\
&	&	&	& \ipa{xpr}  & 	\ipa{ɣɤxpra}  & \\
	\midrule	
&		\ipa{χpl} &	\ipa{χploʁχploʁ}  &	&	\ipa{χpr}  & 	\ipa{tɕʰɯχpri}  & 		\\
&	&	&	&	\ipa{ʁmbr}  & 	\ipa{taʁmbra}  & 		\\
&	&	&	&	\ipa{χcr}  & 	\ipa{χcɯχcri}  & 		\\
&	\ipa{ʁɲɟl}  & 	\ipa{ʁɲɟliʁɲɟli}  & 	&	\ipa{ʁɟr}  & 	\ipa{ʁɟɯʁɟri}  & 		\\
&	&	&	&	\ipa{ʁgr}  & 	\ipa{ʁgra}  & 		\\
\midrule
&	&	&	&	\ipa{ɲcr}  & 	\ipa{ɲcɯɲcri}  & 	\\	
&	&	&	&	\ipa{ŋkʰr}  & 	\ipa{ŋkʰrɯli}  & 	\\	
&	&	&	&	\ipa{ɴqr}  & 	\ipa{ɴqra}  & 	\\	
\midrule
&	&	&	&	\ipa{mtsr}  & 	\ipa{mɯmtsrɯɣ}  & 	\\	
&	&	&	&	\ipa{mpʰr}  & 	\ipa{mpʰrɯmɯ}  & 	\\	
&	\ipa{mql}  & 	\ipa{mqlaʁ}  & 	&	\ipa{mkʰr}  & 	\ipa{mkʰroŋ}  & 	\\	
&	\ipa{mɢl}  & 	\ipa{tɯ-mɢla}  & 	&	\ipa{mgr}  & 	\ipa{mgrɯn}  & 	\\	
\midrule
&	&	&	&	\ipa{nbr}  & 	\ipa{nbraʁ}  & 	\\	
\end{tabular}}
\end{table}	
	   ...
	   \begin{table}
 \caption{List of consonant clusters ending in \ipa{ɣ} or \ipa{ʁ} (31+16)} \label{med.G.R}
...
\ipa{b}  &  	  &  	  &  	&	&	& \\
\ipa{mb}  &  	\ipa{mbɣ}  &  	\ipa{mbɣaʁ}  &  	&	&	& \\
\ipa{m}  &  	  &  	  &  	&	&	& \\
\ipa{w}  &  	\ipa{wɣ}  &  	\ipa{wɣa}  & \ipa{wʁ}  &  	\ipa{wʁa} & \\
\ipa{t}  &  	\ipa{tɣ}  &  	\ipa{tɯ-tɣa}  &  	&	&	& \\
\ipa{tʰ}  &  	\ipa{tʰɣ}  &  	\ipa{thɣe}  &  	&	&	& \\
\ipa{d}  &  	\ipa{dɣ}  &  	\ipa{dɣɤrdɣɤr}  &  	&	&	& \\
\ipa{nd}  &  	\ipa{ndɣ}  &  	\ipa{ɣɤndɣɤndɣɤt}  &  	&	&	& \\
\ipa{n}  &  	  &  	  &  	&	&	& \\
\ipa{ts}  &  	\ipa{tsɣ}  &  	\ipa{tsɣi}  &  it rots	&	\ipa{tsʁ}  &  	\ipa{tsʁot}	& feasant& \\
\ipa{tsʰ}  &  	  &  	  &  	&	&	& \\
\ipa{dz}  &  	  &  	  &  	&	&	& \\
\ipa{ndz}  &  	\ipa{ndzɣ}  &  	\ipa{tɯ-ndzɣi}  &  &	\ipa{ndzʁ}  &  	\ipa{tɯ-ndzʁi} &collar bone	& \\
\ipa{s}  &  	\ipa{sɣ}  &  	\ipa{sɣa}  &  	&	&	& \\
\ipa{z}  &  	\ipa{zɣ}  &  	\ipa{zɣa}  &  	 	\ipa{zʁ}  &  	\ipa{zʁɤɲcɯ} &\\
\ipa{l}  &  	\ipa{lɣ}  &  	\ipa{lɣe}  &  	&	\ipa{lʁ} &\ipa{lʁa} 	& \\
\ipa{ɬ}  &  	  &  	  &  	&	&	& \\
\ipa{tɕ}  &  	\ipa{tɕɣ}  &  	\ipa{tɕɣaʁ}  &  &	\ipa{tɕʁ}  &  	\ipa{tɕʁɯznɤtɕʁɯz}&crunchy  	& \\
\ipa{tɕʰ}  &  	\ipa{tɕʰɣ}  &  	\ipa{tɕʰɣaʁtɕʰɣaʁ}  &  	&	&	&	& \\
\ipa{dʑ}  &  	  &  	  &  	&	&	& \\
\ipa{ndʑ}  &  	\ipa{ndʑɣ}  &  	\ipa{ndʑɣaʁ}  &  	&	&	& \\
\ipa{ɕ}  &  	\ipa{ɕɣ}  &  	\ipa{tɯ-ɕɣa}  &  	&	&	& \\
\ipa{ʑ}  &  	\ipa{ʑɣ}  &  	\ipa{ʑɣɤ-}  &  	&	&	& \\
\ipa{tʂ}  &  	  &  	  &  	&	&	& \\
\ipa{tʂʰ}  &  	  &  	  &  	&	&	& \\
\ipa{dʐ}  &  	  &  	  &  	&	&	& \\
\ipa{ndʐ}  &  	  &  	  &  	&	&	& \\
\ipa{r}  &  	\ipa{rɣ}  &  	\ipa{tɯ-rɣi}  &  	&\ipa{rʁ}	&\ipa{rʁe}& \\
\ipa{ʂ}  &  	\ipa{ʂɣ}  &  	\ipa{ʂɣɤlʂɣɤl}  &  	&	&	& \\
\ipa{c}  &  	  &  	  &  	&	&	& \\
\ipa{cʰ}  &  	\ipa{cʰɣ}  &  	\ipa{qacʰɣa}  &  	&	&	& \\
\ipa{ɟ}  &  	  &  	  &  	&	&	& \\
\ipa{ɲɟ}  &  	\ipa{ɲɟɣ}  &  	\ipa{ɣɤɲɟɣɤɲɟɣɤr}  &  	&	&	& \\
\ipa{ɲ}  &  	  &  	  &  	&	&	& \\
\ipa{j}  &  	\ipa{jɣ}  &  	\ipa{jɣɤt}  &  	&\ipa{jʁ}	&\ipa{jʁu}	& \\
\ipa{k}  &  	  &  	  &  	&	&	& \\
\ipa{kʰ}  &  	  &  	  &  	&	&	& \\
\ipa{g}  &  	  &  	  &  	&	&	& \\
\ipa{ŋg}  &  	  &  	  &  	&	&	& \\
...
\midrule
&	\ipa{spɣ }  &	\ipa{spɣi}  &	&&&\\	
&	\ipa{zbɣ}  &	\ipa{tɤkɤzbɣaʁ}  &	&&&\\	
\midrule
&	\ipa{lcʰɣ}  &	\ipa{lcʰɣaʁlcʰɣaʁ }  &	&&&\\	
&	\ipa{ldzɣ}  &	\ipa{stoʁldzɣɤm}  &	&&&\\	
\midrule
&	\ipa{ɕpʰɣ}  &	\ipa{ɕphɣo}  &	&&&\\	
\midrule
&	\ipa{jmbɣ}  &	\ipa{nɤjmbɣom}  &	&&&\\	
&	\ipa{jpɣ}  &	\ipa{jpɣom}  &	&&&\\	
\midrule
 &	\ipa{rmbɣ}  &	\ipa{tɤ-rmbɣo}  &	&&&\\	
&	\ipa{rpɣ}  &	\ipa{rpɣo}  &	&&&\\	
\midrule
&	\ipa{ʁmbɣ}  &	\ipa{ʁmbɣi}  &	&&&\\	
\midrule
&	\ipa{ntɕʰɣ}  &	\ipa{ntɕʰɣaʁ}  &	&&&\\	
&	\ipa{ntʰɣ}  &	\ipa{antʰɣar}  &	&&&\\	
&	\ipa{ntsɣ}  &	\ipa{ntsɣe}  &	&&&\\	
&	\ipa{ntsʰɣ}  &	\ipa{nɤntsʰɣɤz}  &	&&&\\	
&	\ipa{ɲcɣ}  &	\ipa{ɲcɣɤɲcɣɤt}  &	&&&\\	
&	\ipa{ɲcʰɣ}  &	\ipa{ɲchɣaʁʑɤr}  &	&&&\\	
\end{tabular}}
\end{table}	
