...
\toprule 
 &	\ipa{w} &	\ipa{p} &	\ipa{t} &	\ipa{z} &	\ipa{l} &	\ipa{r} &	\ipa{j } &	\ipa{ɣ} &	\ipa{ʁ} \\
 \midrule
\ipa{a} &	\ipa{aw} &	\ipa{ap} &	\ipa{at} &	\ipa{az} &	\ipa{al} &	\ipa{ar} &	 &	 &	\ipa{aʁ} \\
\ipa{e} &	 &	 &	\ipa{et} &	 &	 &	 &	 &	 &	 \\
\ipa{i} &	 &	 &	\ipa{it} &	 &	\ipa{il} &	 &	 \ipa{ij}&	 &	 \\
\ipa{ɤ} &	\ipa{ɤw} &	 &	\ipa{ɤt} &	\ipa{ɤz} &	\ipa{ɤl} &	\ipa{ɤr} &	\ipa{ɤj} &	\ipa{ɤɣ} &	 \\
\ipa{ɯ} &	\ipa{ɯw} &	\ipa{ɯp} &	\ipa{ɯt} &	\ipa{ɯz} &	\ipa{ɯl} &	\ipa{ɯr} &	 &	\ipa{ɯɣ} &	 \\
\ipa{y} &	 &	 &	\ipa{yt} &	 &	 &	 &	 &	 &	 \\
\ipa{o} &	 &	 &	\ipa{ot} &	\ipa{oz} &	\ipa{ol} &	\ipa{or} &	\ipa{oj} &	 &	\ipa{oʁ} \\
