...
\glt  `He pretended having been duped (=He pretended to let himself be cheated).' (Elicitation)
    \end{exe}  
...
A handful of transitive verbs, namely \jpg{ʑa}{begin}, \jpg{sɤʑa}{begin} and \jpg{rɲo}{experience, have already} are compatible with bare infinitive complements. These verbs can be used with objects, and also allow \ipa{kɤ-} infinitives and/or finite complement clauses, though in the case of \jpg{ʑa}{begin} these are extremely rare.
