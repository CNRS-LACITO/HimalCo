...
\midrule
\jpg{ndza}{eat} (tr)&Up & \ipa{ta-ndza}& \ipa{to-ndza}&  \ipa{tu-ndza} \\
...
A minority of complement-taking verbs, including phasal verbs and causative verbs, systematically inherit the lexically selected orientation of the verb of the complement clause. The following examples show how the verb \jpg{ʑa}{start} takes the orientation of its complements verbs, respectively `up' (example \ref{ex:toZa}), `upstream' \refb{ex:loZa}, `downstream' \refb{ex:chAZa} and `towards west' \refb{ex:YAZa}. The Inferential forms of these verbs are provided in Table \ref{tab:orientation} above.
...
\ipa{tɤ-tɕɯpɯ} 	\ipa{nɯ} 	\ipa{kɯ} 	\ipa{li} \ipa{ɯ-χpi} 	\ipa{ɯ-fɕɤt} 	\ipa{pjɤ-ʑa} 
140517 buaishuohua, 69
...
\ipa{cʰa} 	\ipa{kɤ-tsʰi} 	\ipa{ko-ɣɤtɕʰom} 
