...
\subsubsection{Infinitives vs participles}
Infinitives formally differ from participles in several ways. First, they cannot take possessive prefixes. XXXX only really ambiguous cases: stative verbs, semi-transitive verbs
...
\end{exe}
 ...
 \subsection{Complementation strategies}  
  ...
  \subsubsection{Degree nominal}  
  
 \ipa{ɯ-tɯ-wxti} \ipa{ɲɯ-tɕʰom} %ɯ-tɯ-ɤla nɯ-rtaʁ 
...
Adjectives of degree, like \jpg{rtaʁ}{be enough} and \jpg{tɕʰom}{be too much}, generally use the degree nominal complementation strategy rather than a complement clause

as in example (\ref{ex:pjWnArte}).
...
\ipa{tɤŋe} 	\ipa{kɯ-fse} 	\ipa{kɯ-fsoʁ} 	\ipa{kɯ-tɕhom} 	\ipa{kɯ-fse} 	\ipa{nɯra} 	\ipa{ju-kɯ-ru} 	\ipa{rcanɯ} 
