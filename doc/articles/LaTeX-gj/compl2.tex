...
Not all clauses occurring in subject, object or adjunct function are complement clauses. Given the  XXX (\citealt{jacques16relatives}) 
...
\glt `May your wishes succeed.' (elicited)
\end{exe}  
...
\glt `I have to deal with him in the same way as I dealt with his father.' (Slob.dpon2, 159)
\end{exe}
