...
woman \textsc{inf:stative}-good \textsc{neg-inf:stative}-good \topic{} \textsc{gen} really \textsc{emph} \textsc{3sg.poss}-criterion \textsc{sens}-be \\
...
Complement-taking nouns can be used in noun-verb collocations such as \jpg{ftɕaka+βzu}{do ... by any means possible} (from  \jpg{ftɕaka}{method, manner} and  \jpg{βzu}{do, make}), as in \refb{ex:kongzhi}.
...
\end{exe} 
  ...
  The modal verb \jpg{ra}{have to, need} cannot take any person or number marker. Its S is either a noun phrase or a complement clause. The experiencer, when overt, is marked with the genitive case, as in (\ref{ex:aZWG.ra}); this is form is not attested with complement clauses.
...
\end{exe}
 ...
 The verb \jpg{ra}{have to, need}  is compatible with either finite (see \ref{ex:amApWwGnWClWG} or \ref{ex:tunAmea} above) or infinitive (\ref{ex:ra.inf}) complements. Other types of complements or complementation strategies are not attested.
