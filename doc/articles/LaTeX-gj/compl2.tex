...
In Tshobdun, \citet[481]{sun12complementation} analyzes these demonstratives as complementizers, an analysis which would imply a grammaticalization pathway identical to that of English `that'. It will not attempt  at solving this complex question in the present paper. However, it can noticed that with complement clauses, demonstratives can only be post-clausal, whereas in the case of relatives (or any noun phrase) they can be pre-clausal or circum-clausal (see section \ref{sec:relative}).
