...
systematic survey of the distribution of complement clauses among complement-taking verbs
...
Like all Gyalrong languages, Japhug is very strongly head-marking and lacks an elaborate system of case marking. Core arguments without case marking include intransitive subjects, objects and semi objects.\footnote{For the notion of semi-object and semi-transitive verbs in Japhug, see \citealt[4-5]{jacques16relatives}.} In addition, locative adjuncts and goals of motion verbs can either taken locative markers or be left unmarked.
...
\subsection{Complement-taking nouns} \label{sec:comp.noun}
 ...
 In examples \refb{ex:kAnWrAGo} and \refb{ex:jWm}, the head nouns \jpg{ɯ-skɤt}{his voice} and \jpg{ftɕaka}{method, manner} are neither a core argument nor an adjunct. It is not possible to transform the subordinate clause into an independent clause that would include these nouns. Such sentences are thus complement clauses, rather than relatives, despite having a noun rather than a verb as their head.
...
The verbs \jpg{nɤz}{dare} and \jpg{pʰot}{dare} (the second is barely used in the Kamnyu dialect) can be used with both infinitival and finite complements.
...
In this construction, the causative auxiliary verb takes the participial clause  as its object. When the participial clause clause has a first or second person object, as in \refb{ex:tutWsABze}, the auxiliary remains in third person object form (a form such as $\dagger$\ipa{tu-kɯ-sɤβzu-j} \textsc{ipfv}-2$\rightarrow$1-cause.to.become-\textsc{1pl}  `you caused us to become X' would not be possible).
...
%nɯnɯ rcanɯ qale mɤ-kɯ-ɕri kɯ-pɯ-pe tu-nɯ-βze ɲɯ-ŋu. (26-ndzWrnaR, 51)
  %ɯ-βdaʁmu nɯnɯ li kɤ-kɤ-znɯkhrɯm nɯ z-ɲɤ-tɕɤt tɕe tɕendɤre, (140514 huishuohua de niao, 263)
  %tɯ-ndzɤtshi ra tɯ-ʁjiz mɤ-kɯ-ɣi ɲɯ-sɤpe ɲɯ-ŋu (27-kharwut, 68)
  %a-tɯ-ci ɲɯ-tɯ-sqarndɯm tɕe aʑo
%tɯ-ci kɯ-ɤmgri kɤ-tshi mɤ-kɯ-khɯ ɲɯ-tɯ-sɤpe ɲɯ-ŋu (aesop_lang_he_yang)
%ɕa tu-ndze qhe ɲɯ-zɣɤdi.
%tɕe kɤ-ndza mɤ-kɯ-sna ɲɯ-sɤβze ŋu ma (25-akWzgumba 87)
...
The complement-taking causative verbs inherits the orientation prefix and person marking of the complement verb (see \ref{sec:raising}). 
 ...
 \section{Conclusion}
no ergative pivots, confirms \citet{jacques16relatives}, \citet{jackson03caodeng}
