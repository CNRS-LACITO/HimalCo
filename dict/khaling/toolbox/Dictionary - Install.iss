...
OutputBaseFilename=khaling - Lexique Pro Setup
OutputDir=C:\Users\celine\Travail\CNRS\workspace\HimalCo\dict\khaling\lexique_pro\obj\
...
Name: desktopicon_1; Description: khaling; GroupDescription: {cm:CreateDesktopIcon}; Components: Lexicons\Lexicon_0
...
; Lexicon Files
Source: C:\Users\celine\Travail\CNRS\workspace\HimalCo\dict\khaling\toolbox\Dictionary.lpEnc; DestDir: {code:GetDataDir}\khaling; Flags: ignoreversion; Components: Lexicons\Lexicon_0
Source: C:\Users\celine\Travail\CNRS\workspace\HimalCo\dict\khaling\toolbox\Dictionary.lpConfigEnc; DestName: Dictionary.lpConfigEnc; DestDir: {code:GetDataDir}\khaling; Flags: ignoreversion; Components: Lexicons\Lexicon_0
Source: C:\Users\celine\Travail\CNRS\workspace\HimalCo\dict\khaling\toolbox\Dictionary - English.idx; DestDir: {code:GetDataDir}\khaling; Flags: ignoreversion; Components: Lexicons\Lexicon_0

; About Language Pages

; Home Page
Source: C:\Program Files\SIL\Lexique Pro\Display\homebanner1.jpg; DestDir: {code:GetDataDir}\khaling\Display\; Flags: ignoreversion; Components: Lexicons\Lexicon_0
Source: C:\Program Files\SIL\Lexique Pro\Display\homebanner2.jpg; DestDir: {code:GetDataDir}\khaling\Display\; Flags: ignoreversion; Components: Lexicons\Lexicon_0
...
[Icons]
Name: {group}\Lexique Pro - khaling; Filename: {code:GetAppDir}\bin\LexiquePro.exe; Parameters: "/f ""{code:GetDataDir}\khaling\Dictionary.lpEnc"""; IconIndex: 0; Components: Lexicons\Lexicon_0
Name: {userdesktop}\Lexique Pro - khaling; Filename: {code:GetAppDir}\bin\LexiquePro.exe; Tasks: desktopicon_1; Parameters: "/f ""{code:GetDataDir}\khaling\Dictionary.lpEnc"""; IconIndex: 0; Components: Lexicons\Lexicon_0
...
[Run]
Filename: {code:GetAppDir}\bin\LexiquePro.exe; Description: {cm:LaunchLexiquePro} - khaling; Flags: nowait postinstall skipifsilent; Parameters: "/f ""{code:GetDataDir}\khaling\Dictionary.lpEnc"""; Components: Lexicons\Lexicon_0
...
Name: Lexicons\Lexicon_0; Description: khaling; Types: custom compact full
...
[UninstallDelete]
Type: files; Name: "{code:GetDataDir}\khaling\*.idx"
Type: files; Name: "{code:GetDataDir}\khaling\*.bak"
Type: files; Name: "{code:GetDataDir}\khaling\*.tmp"
Type: files; Name: "{code:GetDataDir}\khaling\*.iss"
Type: files; Name: "{code:GetDataDir}\khaling\*.cc"
Type: files; Name: "{code:GetDataDir}\khaling\*.lpLocked"
Type: files; Name: "{code:GetDataDir}\khaling\*.lck"
Type: files; Name: "{code:GetDataDir}\khaling\*.lpEnc"
Type: files; Name: "{code:GetDataDir}\khaling\*.lpLiftEnc"
Type: files; Name: "{code:GetDataDir}\khaling\*.lpConfigEnc"
Type: files; Name: "{code:GetDataDir}\khaling\*.lpIndex"
Type: files; Name: "{code:GetDataDir}\khaling\*.lpCache-UnusedLetters"
Type: files; Name: "{code:GetDataDir}\khaling\*.lpCache-InitialLetters"
