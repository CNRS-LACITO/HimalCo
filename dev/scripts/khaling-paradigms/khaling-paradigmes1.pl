...
if ($variable1 =~ /[ptkmnŋrl]t_1$/) {
	...
	if ($variable1 =~ /[ptkmnŋrl].r$/) {
		print FILE "\\index{\\racine{".$rime." }   }\n";
		print FILE "\\begin{table}[H]\n";
		print FILE "\\caption{Reflexive verb \\ipa{".$radical. "} ``".$variable2."\"  }\n";
		print FILE "\\begin{tabular}{l|l|l|l|l|l|l|l|l|l|l}  \\toprule\n";
		print FILE "&non-past & past & imperative \\\\ \n";
		print FILE "1s &".$theme_P."siŋʌ"." &".$theme_P."tʌsu \\\\ \n";
		print FILE "1di &".$theme_G."siji"." &".$theme_G."sîːti   \\\\\n";
		print FILE "1de &".$theme_G."siju"." &".$theme_G."sîːtu   \\\\ \n";
		print FILE "1pi &".$theme_C2."siki"." &".$theme_C2."siktiki   \\\\ \n";
		print FILE "1pe &".$theme_C2."sikʌ"." &".$theme_C2."siktʌkʌ   \\\\ \n";
		print FILE "2s & ʔi".$theme_P."si & ʔi".$theme_P."tɛsi &".$theme_P."sije  \\\\ \n";
		print FILE "2d & ʔi".$theme_G."siji"." & ʔi".$theme_G."sîːti &".$theme_G."sîjje    \\\\\n";
		print FILE "2n & ʔi".$theme_P."sini  & ʔi".$theme_P."tɛnnu &".$theme_P."nuje  \\\\ \n";
		print FILE "3s & ".$theme_P."si & ".$theme_P."tɛsi   \\\\ \n";
		print FILE "3d & ".$theme_G."siji"." & ".$theme_G."sîːti   \\\\ \n";
		print FILE "3n & ".$theme_P."sinu  & ".$theme_P."tɛnnu \\\\ \n";
		print FILE "\\bottomrule\n";
		print FILE "\\end{tabular}\n";
		print FILE "\\end{table}\n";
	}
		...
		print FILE "\\begin{tabular}{l|l|l|l|l|l|l|l|l|l|l}  \\toprule\n";
		print FILE "&non-past & past & imperative \\\\ \n";
		print FILE "1s &".$theme_2A."̂nsiŋʌ"." &".$theme_2A."̂ntʌsu \\\\ \n";
		print FILE "1di &".$theme_2A."ssiji"." &".$theme_2A."ssîːti   \\\\\n";
		print FILE "1de &".$theme_2A."ssiju"." &".$theme_2A."ssîːtu   \\\\ \n";
		print FILE "1pi &".$theme_2A."ssiki"." &".$theme_2A."ssiktiki   \\\\ \n";
		print FILE "1pe &".$theme_2A."ssikʌ"." &".$theme_2A."siktʌkʌ   \\\\ \n";
		print FILE "2s & ʔi".$theme_2A."̂ssi & ʔi".$theme_2A."̂ntɛsi &".$theme_2A."̂nsije  \\\\ \n";
		print FILE "2d & ʔi".$theme_2A."ssiji"." & ʔi".$theme_2A."ssîːti &".$theme_2A."ssîjje    \\\\\n";
		print FILE "2n & ʔi".$theme_2A."̂nsini  & ʔi".$theme_2A."̂ntɛnnu &".$theme_2A."̂nnuje  \\\\ \n";
		print FILE "3s & ".$theme_2A."̂nsi & ".$theme_2A."̂ntɛsi   \\\\ \n";
		print FILE "3d & ".$theme_2A."ssiji"." & ".$theme_2A."ssîːti   \\\\ \n";
		print FILE "3n & ".$theme_2A."̂nsinu  & ".$theme_2A."̂ntɛnnu \\\\ \n";
		print FILE "\\bottomrule\n";
		print FILE "\\end{tabular}\n";
		print FILE "\\end{table}\n";
	}
