...
from pylmflib.config.mdf import ps_partOfSpeech
from pylmflib.utils.attr import check_attr_type, check_attr_range
from pylmflib.core.sense import Sense
from pylmflib.morphology.list_of_components import ListOfComponents
