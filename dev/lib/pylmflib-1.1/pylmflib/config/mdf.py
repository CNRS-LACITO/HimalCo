...
mdf_lmf = dict({
    ...
    "gv" : lambda gv, lexical_entry: lexical_entry.set_gloss(gv, language=pylmflib.config.xml.vernacular),
    "dv" : lambda dv, lexical_entry: lexical_entry.set_definition(dv, language=pylmflib.config.xml.vernacular),
    "ge" : lambda ge, lexical_entry: lexical_entry.set_gloss(ge, language=pylmflib.config.xml.English),
    "re" : lambda re, lexical_entry: lexical_entry.set_translation(re, language=pylmflib.config.xml.English),
    "we" : lambda we, lexical_entry: None,
    "de" : lambda de, lexical_entry: lexical_entry.set_definition(de, language=pylmflib.config.xml.English),
    "gn" : lambda gn, lexical_entry: lexical_entry.set_gloss(gn, language=pylmflib.config.xml.national),
    "rn" : lambda rn, lexical_entry: lexical_entry.set_translation(rn, language=pylmflib.config.xml.national),
    "wn" : lambda wn, lexical_entry: None,
    "dn" : lambda dn, lexical_entry: lexical_entry.set_definition(dn, language=pylmflib.config.xml.national),
    "gr" : lambda gr, lexical_entry: lexical_entry.set_gloss(gr, language=pylmflib.config.xml.regional),
    "rr" : lambda rr, lexical_entry: lexical_entry.set_translation(rr, language=pylmflib.config.xml.regional),
    "wr" : lambda wr, lexical_entry: None,
    "dr" : lambda dr, lexical_entry: lexical_entry.set_definition(dr, language=pylmflib.config.xml.regional),
    ...
    "xv" : lambda xv, lexical_entry: lexical_entry.create_and_add_example(xv, language=pylmflib.config.xml.vernacular),
    "xe" : lambda xe, lexical_entry: lexical_entry.add_example(xe, language=pylmflib.config.xml.English),
    "xn" : lambda xn, lexical_entry: lexical_entry.add_example(xn, language=pylmflib.config.xml.national),
    "xr" : lambda xr, lexical_entry: lexical_entry.add_example(xr, language=pylmflib.config.xml.regional),
    "xg" : lambda xg, lexical_entry: None,
    "uv" : lambda uv, lexical_entry: lexical_entry.set_usage_note(uv, language=pylmflib.config.xml.vernacular),
    "ue" : lambda ue, lexical_entry: lexical_entry.set_usage_note(ue, language=pylmflib.config.xml.English),
    "un" : lambda un, lexical_entry: lexical_entry.set_usage_note(un, language=pylmflib.config.xml.national),
    "ur" : lambda ur, lexical_entry: lexical_entry.set_usage_note(ur, language=pylmflib.config.xml.regional),
    "ev" : lambda ev, lexical_entry: lexical_entry.set_encyclopedic_information(ev, language=pylmflib.config.xml.vernacular),
    "ee" : lambda ee, lexical_entry: lexical_entry.set_encyclopedic_information(ee, language=pylmflib.config.xml.English),
    "en" : lambda en, lexical_entry: lexical_entry.set_encyclopedic_information(en, language=pylmflib.config.xml.national),
    "er" : lambda er, lexical_entry: lexical_entry.set_encyclopedic_information(er, language=pylmflib.config.xml.regional),
    "ov" : lambda ov, lexical_entry: lexical_entry.set_restriction(ov, language=pylmflib.config.xml.vernacular),
    "oe" : lambda oe, lexical_entry: lexical_entry.set_restriction(oe, language=pylmflib.config.xml.English),
    "on" : lambda on, lexical_entry: lexical_entry.set_restriction(on, language=pylmflib.config.xml.national),
    "or" : lambda OR, lexical_entry: lexical_entry.set_restriction(OR, language=pylmflib.config.xml.regional), # 'or' is a keyword in Python
    ...
    "ve" : lambda ve, lexical_entry: lexical_entry.set_variant_comment(ve, language=pylmflib.config.xml.English), # or lexical_entry.set_dialect(ve)
    "vn" : lambda vn, lexical_entry: lexical_entry.set_variant_comment(vn, language=pylmflib.config.xml.national),
    "vr" : lambda vr, lexical_entry: lexical_entry.set_variant_comment(vr, language=pylmflib.config.xml.regional),
    ...
    "pdv": lambda pdv, lexical_entry: lexical_entry.set_paradigm_form(pdv, language=pylmflib.config.xml.vernacular),
    "pde": lambda pde, lexical_entry: lexical_entry.set_paradigm_form(pde, language=pylmflib.config.xml.English),
    "pdn": lambda pdn, lexical_entry: lexical_entry.set_paradigm_form(pdn, language=pylmflib.config.xml.national),
    "pdr": lambda pdr, lexical_entry: lexical_entry.set_paradigm_form(pdr, language=pylmflib.config.xml.regional),
...
lmf_mdf = dict({
    ...
    "gv" : lambda sense: sense.find_glosses(pylmflib.config.xml.vernacular),
    "dv" : lambda sense: sense.find_definitions(pylmflib.config.xml.vernacular),
    "ge" : lambda sense: sense.find_glosses(pylmflib.config.xml.English),
    "re" : lambda sense: sense.get_translations(pylmflib.config.xml.English),
    "we" : lambda sense: None,
    "de" : lambda sense: sense.find_definitions(pylmflib.config.xml.English),
    "gn" : lambda sense: sense.find_glosses(pylmflib.config.xml.national),
    "rn" : lambda sense: sense.get_translations(pylmflib.config.xml.national),
    "wn" : lambda sense: None,
    "dn" : lambda sense: sense.find_definitions(pylmflib.config.xml.national),
    "gr" : lambda sense: sense.find_glosses(pylmflib.config.xml.regional),
    "rr" : lambda sense: sense.get_translations(pylmflib.config.xml.regional),
    "wr" : lambda sense: None,
    "dr" : lambda sense: sense.find_definitions(pylmflib.config.xml.regional),
    ...
    "xv" : lambda context: context.find_written_forms(pylmflib.config.xml.vernacular),
    "xe" : lambda context: context.find_written_forms(pylmflib.config.xml.English),
    "xn" : lambda context: context.find_written_forms(pylmflib.config.xml.national),
    "xr" : lambda context: context.find_written_forms(pylmflib.config.xml.regional),
    "xg" : lambda sense: None,
    "uv" : lambda sense: sense.find_usage_notes(language=pylmflib.config.xml.vernacular),
    "ue" : lambda sense: sense.find_usage_notes(language=pylmflib.config.xml.English),
    "un" : lambda sense: sense.find_usage_notes(language=pylmflib.config.xml.national),
    "ur" : lambda sense: sense.find_usage_notes(language=pylmflib.config.xml.regional),
    "ev" : lambda sense: sense.find_encyclopedic_informations(language=pylmflib.config.xml.vernacular),
    "ee" : lambda sense: sense.find_encyclopedic_informations(language=pylmflib.config.xml.English),
    "en" : lambda sense: sense.find_encyclopedic_informations(language=pylmflib.config.xml.national),
    "er" : lambda sense: sense.find_encyclopedic_informations(language=pylmflib.config.xml.regional),
    "ov" : lambda sense: sense.find_restrictions(language=pylmflib.config.xml.vernacular),
    "oe" : lambda sense: sense.find_restrictions(language=pylmflib.config.xml.English),
    "on" : lambda sense: sense.find_restrictions(language=pylmflib.config.xml.national),
    "or" : lambda sense: sense.find_restrictions(language=pylmflib.config.xml.regional),
    ...
    "ve" : lambda form_representation: form_representation.get_comment(pylmflib.config.xml.English), # or form_representation.get_dialect()
    "vn" : lambda form_representation: form_representation.get_comment(pylmflib.config.xml.national),
    "vr" : lambda form_representation: form_representation.get_comment(pylmflib.config.xml.regional),
    ...
    "pdv": lambda paradigm: paradigm.get_paradigm(language=pylmflib.config.xml.vernacular),
    "pde": lambda paradigm: paradigm.get_paradigm(language=pylmflib.config.xml.English),
    "pdn": lambda paradigm: paradigm.get_paradigm(language=pylmflib.config.xml.national),
    "pdr": lambda paradigm: paradigm.get_paradigm(language=pylmflib.config.xml.regional),
