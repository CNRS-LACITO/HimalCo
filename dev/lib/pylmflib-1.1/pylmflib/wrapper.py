...
from pylmflib.input.mdf import mdf_read
from pylmflib.input.xml_lmf import xml_lmf_read as lmf_read
from pylmflib.config.xml import sort_order_read as order_read
from pylmflib.config.xml import config_read

## Functions to write into a file: MDF, XML LMF, LaTeX, doc
from pylmflib.output.mdf import mdf_write
from pylmflib.output.xml_lmf import xml_lmf_write as lmf_write
from pylmflib.output.tex import tex_write
...
def write_doc(*args, **kwds):
    ...
    from pylmflib.output.doc import doc_write
