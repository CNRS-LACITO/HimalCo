...
\end{flushright}
\begin{bottompar}
Jacques, Guillaume 2015-2016. \textit{Dictionnaire Japhug-Chinois-Français, version 1.11} \zh{嘉绒-汉-法词典}, Paris: Projet HimalCo. \url{http://himalco.huma-num.fr/}
\end{bottompar}
...
\newblock \zh{嘉戎語動詞的派生形態} {J}iāróngy\v{ǔ} dòngcí de
...
\newblock \zh{草登嘉戎語的狀貌詞} {C}\v{a}odēng {J}iāróngy\v{u} de
  zhuàngmàocí ({T}he ideophones in {T}shobdun {R}gyalrong).
\newblock \emph{Minzu yuwen \zh{民族語文}} 5. 1--11.
