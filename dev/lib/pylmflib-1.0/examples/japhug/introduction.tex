...
\end{flushright}
\begin{bottompar}
Jacques, Guillaume 2015. \textit{Dictionnaire Japhug-Chinois-Français, version 1.0} \zh{嘉绒-汉-法词典}, Paris: Projet HimalCo. \url{http://himalco.huma-num.fr/}
\end{bottompar}
...
本词典得到了许多同行业者的修改意见和建议，笔者特别感谢龚勋、韩哲夫、彭国珍、米可、沙加尔、帅彦辰和章舒娅对初稿的仔细审阅。
\newpage
\normalfont
...
\newpage
 \section*{Ordre alphabétique \zh{字母顺序}}
 
		
 \ipa{a}  \ipa{b}  \ipa{β}  \ipa{c}  \ipa{ɕ}  \ipa{d}  \ipa{e}  \ipa{ɤ}  \ipa{f}  \ipa{g}  \ipa{ɣ}  \ipa{ɢ}  \ipa{h}  \ipa{i}  \ipa{j}  \ipa{ɟ}  \ipa{k}  \ipa{l}  \ipa{ɬ}  \ipa{m}  \ipa{n}  \ipa{ɲ}  \ipa{ŋ}  \ipa{ɴ}  \ipa{o}  \ipa{p}  \ipa{q}  \ipa{r}  \ipa{ʁ}  \ipa{s}  \ipa{ʂ}  \ipa{t}  \ipa{u}  \ipa{ɯ}  \ipa{w}  \ipa{x}  \ipa{χ}  \ipa{y}  \ipa{z}  \ipa{ʐ}  \ipa{ʑ} 		
...
\newblock {\em Folia Linguistica Historica\/} 36:165–198.
