...
REM #python user/guillaume/test_khaling.py

REM # LaTeX file is generated without sound records and with cross references
REM #python user/guillaume/test_khaling.py -a

REM # LaTeX file is generated with sound records and without cross references
REM #python user/guillaume/test_khaling.py -c

REM # LaTeX file is generated without sound records and without cross references
python user/guillaume/test_khaling.py -a -c

REM # Generate PDF
C:/texlive/2013/bin/win32/xelatex.exe -output-directory=user/guillaume/ user/guillaume/test.tex
C:/texlive/2013/bin/win32/xelatex.exe -output-directory=user/guillaume/ user/guillaume/test.tex
