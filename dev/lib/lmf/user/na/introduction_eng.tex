...
A review of the literature about Na and the other languages of the Naish  group is provided (in Chinese) by Li Zihe \citet{Li2015}. For an English-language introduction, see \citet{Michaud2015b}.
...
\section{ \zh{其它}} \label{sec:other}
 ...
 \zh{拉他咪•达石拉么、拉他咪•达石、}Céline Buret\zh{、}Séverine Guillaume\zh{、、向柏霖}（Guillaume Jacques）\zh{、阿慧、杜玫瑰\zh}（Roselle Dobbs）\zh{：感谢你们的大力支持。}
