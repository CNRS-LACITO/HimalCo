...
lexical_resource.set_lastUpdate("2015-02-05")
...
# Write LaTeX file
lmf.write_tex(lexical_resource, user_path + "dict_khaling/Dictionary.tex", preamble=user_path + "config/khaling.tex", lmf2tex=lmf2tex, font=my_font, sort_order=xml_order)
lmf.write_tex(lexical_resource, user_path + "dict_khaling/Dictionary-dev.tex", preamble=user_path + "config/khaling.tex", lmf2tex=lmf2tex, font=my_font, items=items, sort_order=dev_order)
