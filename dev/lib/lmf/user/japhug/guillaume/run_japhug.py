...
lexical_resource = lmf.read_config(user_path + "japhug/guillaume/config.xml")
...
# Write LaTeX file
lmf.write_tex(lexical_resource, user_path + "japhug/result/dictionary.tex", preamble=user_path + "japhug/guillaume/japhug.tex", lmf2tex=lmf2tex, sort_order=xml_order)
