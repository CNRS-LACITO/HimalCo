...
# Run Perl script
os.system("perl " + user_path + "../src/utils/ipa2devanagari/ipa2devanagari.pl " + user_path + "../../../../dict/khaling/toolbox/Dictionary.txt " + user_path + "guillaume/Dictionary.txt")

# Read MDF file and set lexicon identifier
lexical_resource = lmf.read_mdf(user_path + "guillaume/Dictionary.txt", mdf2lmf, id="khaling")
