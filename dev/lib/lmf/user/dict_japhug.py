...
from japhug import mdf2lmf, lmf2mdf, order, lmf2tex, unicode_ranks
...
# Write LaTeX file
lmf.write_tex(lexical_resource, user_path + "dict_japhug/Dictionary.tex", preamble=user_path + "config/japhug.tex", lmf2tex=lmf2tex, sort_order=unicode_ranks)
