...
# Write LaTeX file
lmf.write_tex(lexical_resource, user_path + "guillaume/test.tex", preamble=user_path + "guillaume/preamble.tex", lmf2tex=lmf2tex, font=my_font, items=items, sort_order=sort_order)
