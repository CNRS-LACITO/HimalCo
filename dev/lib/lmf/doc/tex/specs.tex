...
\begin{figure}[h]
\centerline{\fbox{\includegraphics[width=13.5cm]{../uml/export/ClassDiagramCorePackage.png}}}
...
\begin{figure}[h]
\centerline{\fbox{\includegraphics[width=12cm]{../uml/export/ClassDiagramResources.png}}}
\caption{Resources}
\end{figure}
\nopagebreak
\begin{figure}[h]
\centerline{\fbox{\includegraphics[width=10cm]{../uml/export/ClassDiagramAnnotations.png}}}
\caption{Annotations}
\end{figure}
...
Un petit exemple afin de visualiser : prenons la classe Borrowed Word de la figure pr\'ec\'edente (en bas \`a gauche). Cette classe comporte 2 attributs :
\begin{itemize}
...
& & romanization & ``readable characters'' & \href{http://www.isocat.org/datcat/DC-1873}{1873} open & ph & \\ \cmidrule{3-7}
& & script name & ``Latin'' & \href{http://www.isocat.org/datcat/DC-3809}{3809} open & - & script used for romanization \\ \cmidrule{3-7}
& & pinyin & ``...'' & \href{http://www.isocat.org/datcat/DC-1852}{1852} open & ph & \\ \cmidrule{3-7}
...
% MRD
% Context
\multirow{9}{2cm}{MRD} & \multirow{3}{2cm}{Context} & language & ``fra'', ``eng'' & \href{http://www.isocat.org/datcat/DC-2482}{2482} constrained & - & ISO 639 \\ \hline
& & resource & Audio & N/A & N/A & \\ \cmidrule{3-7}
...
% Speaker
& \multirow{1}{2cm}{Speaker} & speaker id & ``SpID-1'' & \href{http://www.isocat.org/datcat/DC-3597}{3597} open & & \\ \cmidrule{1-7}
% ANNOTATIONS
% Borrowed Word
\multirow{8}{2cm}{\textit{Annotations}} & \multirow{3}{2cm}{Borrowed Word} & borrowed word (English) & ``Chinese'' & \href{http://www.isocat.org/datcat/DC-3688}{3688} open & bw & source language \\ \cmidrule{3-7}
& & written form & ``...'' & \href{http://www.isocat.org/datcat/DC-1836}{1836} open & bw & loan word \\ \cmidrule{3-7}
& & text representation & Text Re\-pre\-sen\-ta\-tion & & N/A & \\ \cmidrule{2-7}
% Etymology
& \multirow{5}{2cm}{Etymology} & etymology & ``aspirin: from acetyl + spiraeic acid (old name for salicylic acid)'' & \href{http://www.isocat.org/datcat/DC-221}{221} open & et & \\ \cmidrule{3-7}
...
& & etymology source & & \href{http://www.isocat.org/datcat/DC-3701}{3701} & es & \\ \hline\hline
\end{longtable}
\end{center}
